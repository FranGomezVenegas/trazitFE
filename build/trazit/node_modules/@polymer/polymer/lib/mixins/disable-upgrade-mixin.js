...
if(this.__isUpgradeDisabled&&null==value){super._initializeProperties();this.__isUpgradeDisabled=!1;if(wrap(this).isConnected){super.connectedCallback()}}}else{super.attributeChangedCallback(name,old,value,/** @type {null|string} */namespace)}}// Prevent element from connecting when it's upgrade disabled.
