 ...
 * @package
 */export class IronOverlayManagerClass{constructor(){/**
...
while((overlay=/** @type {?} */this._overlays[i])&&this._overlayInPath(path)!==overlay){overlay._onCaptureClick(event);if(overlay.allowClickThrough){i--}else{break}}}/**
   ...
   * @suppress {missingProperties}
   * @private
   */_shouldBeBehindOverlay(overlay1,overlay2){return!overlay1.alwaysOnTop&&overlay2.alwaysOnTop}};export const IronOverlayManager=new IronOverlayManagerClass;