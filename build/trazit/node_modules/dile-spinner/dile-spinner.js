import{LitElement,html,css}from"../lit-element/lit-element.js";import{DileSpinnerMixin}from"./dile-spinner-mixin.js";export class DileSpinner extends DileSpinnerMixin(LitElement){static get styles(){return css`
      :host {
    ...
    `}render(){return html`
    ${this.active?html`<i><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></i>`:""}
