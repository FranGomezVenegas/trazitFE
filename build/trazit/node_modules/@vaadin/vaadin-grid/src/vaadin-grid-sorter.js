...
*/import"../../../@polymer/polymer/polymer-legacy.js";import"../../../@polymer/polymer/lib/elements/custom-style.js";import{ThemableMixin}from"../../vaadin-themable-mixin/vaadin-themable-mixin.js";import{DirMixin}from"../../vaadin-element-mixin/vaadin-dir-mixin.js";import{html}from"../../../@polymer/polymer/lib/utils/html-tag.js";import{PolymerElement}from"../../../@polymer/polymer/polymer-element.js";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<custom-style>
  <style>
    @font-face {
 ...
 */class GridSorterElement extends ThemableMixin(DirMixin(PolymerElement)){static get template(){return html`
    <style>
      :host {
        display: inline-flex;
        cursor: pointer;
