...
*/import{PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{FlattenedNodesObserver}from"../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js";import{DirMixin}from"../../vaadin-element-mixin/vaadin-dir-mixin.js";import{Templatizer}from"./vaadin-grid-templatizer.js";import{Debouncer}from"../../../@polymer/polymer/lib/utils/debounce.js";import{animationFrame}from"../../../@polymer/polymer/lib/utils/async.js";/**
 * @polymerMixin
 ...
 */class GridColumnElement extends ColumnBaseMixin(DirMixin(PolymerElement)){static get is(){return"vaadin-grid-column"}static get properties(){return{/**
       ...
       */autoWidth:{type:Boolean,value:!1},_bodyTemplate:{type:Object},_cells:Array}}}customElements.define(GridColumnElement.is,GridColumnElement);export{GridColumnElement};