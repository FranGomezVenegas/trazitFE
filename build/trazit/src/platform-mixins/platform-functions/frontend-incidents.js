import{backendUrl,frontEndIncidentsUrl}from"../../config/platform/logic/api-config.js";import{store}from"../../store.js";import{addNotification}from"../../elements/platformComponents/Redux/actions/notifications_actions.js";import{userOpenIncidents,selectedUserIncidentDetail}from"../../elements/platformComponents/Redux/actions/incidents_actions.js";import{tokenMixin}from"../store/token-mixin.js";import{ToastMethods}from"../functions/toast-methods.js";import{ApiSettings}from"../apis/api-settings.js";/**
 * @mixinFunction
 * @polymer
 */export const FrontendIncidents=superClass=>class extends ApiSettings(ToastMethods(tokenMixin(superClass))){fieldButtonClickedForIncidents(e){//console.log('optionPressed', e.detail.buttonName, 'selectedObject', this.selectedObject);                
...
//     detail: msgErr}));             
return;}}frontEndIncidentsAPI(data){var apiUrl=backendUrl+frontEndIncidentsUrl+"?"+data.paramsUrl;if(!data.finalToken){return}//    console.log('frontEndIncidentsAPI', apiUrl, data.paramsUrl);
