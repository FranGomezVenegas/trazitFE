...
import {
  ...
  addTab,
  setCurrentTab,
} from "../../elements/platformComponents/Redux/actions/tabs_actions.js";
export const TabsMethods = (superClass) =>
  class extends tokenMixin(ApiPlatform(userSessionMixin(superClass))) {
    ...
    saveDefaultTabsOnLogin() {
      ...
      for (i = 0; i < tabsInfo.length; i++) {
        ...
        tabsString =
          tabsString + "tabEsignRequired:" + tabsInfo[i].tabEsignRequired + "*";
        tabsString =
          tabsString +
