...
import "../../elements/internalComponents/Dialogs/DialogConfirmUser/dialog-confirmuser.js";
import { ApiIncidents } from "../apis/api-incidents.js";
import { AuthenticationApi } from "../apis/api-authentication.js";
import "../../elements/internalComponents/Dialogs/DialogSimple/simple-modal-dialog.js";
...
import { FrontendIncidents } from "./frontend-incidents.js";
class FrontendIncidentsElements extends FrontendIncidents(
  ApiIncidents(AuthenticationApi(connect(store)(PolymerElement)))
) {
    ...
    return html`
      ...
      <paper-dialog id="incidentActionBrowser">
        <simple-modal-dialog
          style="width:410px;"
          dialog
          form-fields="{{incidentDialogFormFields}}"
          display-cancel-button
          display-confirm-button
          on-dialog-button-clicked="dialogClosedincidentActionBrowser"
