...
import"../../../internalComponents/Grids/vaadingrid-lit-singleselect.js";import"../01moduleFunctionality/em-demo-a-webcomponent-env-monit-samples.js";//import '../01moduleFunctionality/env-monit-elements-sample.js';
...
import{FunctionsEnvMonitSamples}from"../01moduleFunctionality/functions-env-monit-samples.js";import{FrontendEndpointsEnvMonitSamples,samplesStagesReduxVariables}from"../01moduleFunctionality/endpoints-frontend-env-monit-samples.js";import"../03config/em-demo-a-person-sampling-settings.js";import{personSampling}from"../03config/em-demo-a-person-sampling-settings.js";//'../03config/config-process.js';
//FrontendEnvMonitSample
class emDemoASampleSampling extends FieldsMethods(FrontendEndpointsEnvMonitSamples(FunctionsEnvMonitSamples(connect(store)(PolymerElement)))){static get properties(){return{tableDefinition:{type:Object,value:personSampling},samplesStagesReduxVariables:{type:String,value:samplesStagesReduxVariables},allPersonSamplesStageSampling:{type:Array,notify:!0},selectedObject:Object,callBackRefreshWindow:Object,selectedLanguage:{type:String}}}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(null!=state.emDemoA){this.allPersonSamplesStageSampling=state.emDemoA.allPersonSamplesStageSampling}}static get template(){return html`            
