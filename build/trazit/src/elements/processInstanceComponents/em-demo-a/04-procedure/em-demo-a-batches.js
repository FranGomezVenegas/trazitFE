...
this.selectedBatch=e.detail;store.dispatch(setSelectedBatch(e.detail));return}refreshWindow(){this.loadSamplingTable()}loadSamplingTable(){this.callBackRefreshWindow=this.refreshWindow.bind(this);this.getActiveBatches();this.getAllIncubators()}ready(){super.ready();this.loadSamplingTable()}}customElements.define("em-demo-a-batches",emDemoABatches);// import {PolymerElement, html} from '@polymer/polymer/polymer-element';
