...
class EmDemoAProgPoints extends FunctionsEnvMonitSamples(FrontendEndpointsEnvMonitForPrograms(connect(store)(PolymerElement))){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(state.emDemoA!=void 0&&state.emDemoA.selectedProgram.name!=void 0){//this.selectedProgram=state.emDemoA.selectedProgram; 
