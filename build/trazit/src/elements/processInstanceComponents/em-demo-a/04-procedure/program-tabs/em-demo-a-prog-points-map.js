import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import"./em-demo-a-prog-points.js";class EmDemoAProgPointsMap extends connect(store)(PolymerElement){static get properties(){return{selectedProgram:{type:Object},selectedSamplingPoint:{type:Object}}}static get template(){return html`
            <div class="mainDiv">
