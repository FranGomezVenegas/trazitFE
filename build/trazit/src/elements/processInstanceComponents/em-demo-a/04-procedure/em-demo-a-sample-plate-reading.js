...
import"../../../internalComponents/Grids/vaadingrid-lit-singleselect.js";import{FrontendEndpointsEnvMonitSamples,samplesStagesReduxVariables}from"../01moduleFunctionality/endpoints-frontend-env-monit-samples.js";import{FunctionsEnvMonitSamples}from"../01moduleFunctionality/functions-env-monit-samples.js";import"../01moduleFunctionality/em-demo-a-webcomponent-env-monit-samples.js";import"../03config/em-demo-a-sample-plate-reading-settings.js";import{samplePlateReading}from"../03config/em-demo-a-sample-plate-reading-settings.js";//'../03config/config-process.js';
class emDemoASamplePlateReading extends FieldsMethods(FunctionsEnvMonitSamples(FrontendEndpointsEnvMonitSamples(connect(store)(PolymerElement)))){static get properties(){return{tableDefinition:{type:Object,value:samplePlateReading},samplesStagesReduxVariables:{type:String,value:samplesStagesReduxVariables},allSamplesStagePlateReading:{type:Array,notify:!0},selectedObject:Object,callBackRefreshWindow:Object,iconFunction2:Object,selectedLanguage:{type:String}}}static get template(){return html`            
