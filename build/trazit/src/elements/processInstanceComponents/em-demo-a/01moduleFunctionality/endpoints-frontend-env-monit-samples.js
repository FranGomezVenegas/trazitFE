...
import {
  ...
  sampleTemplates as sampleTemplates_em_demo_a,
  unReceivedSamples as unReceivedSamples_em_demo_a,
  forResultsSamples as forResultsSamples_em_demo_a,
  givenCocSampleHistory as givenCocSampleHistory_em_demo_a,
  getGivenCocUsersList as getGivenCocUsersList_em_demo_a,
  forResultsSamplesCustodian as forResultsSamplesCustodian_em_demo_a,
  forResultsSamplesCandidate as forResultsSamplesCandidate_em_demo_a,
  forRevisionSamples as forRevisionSamples_em_demo_a,
  analysisAllList as analysisAllList_em_demo_a,
  givenSampleAnalysisList as givenSampleAnalysisList_em_demo_a,
          ...
          if (200 == response.status) {
            ...
            switch (reduxVariable.name) {
              case "samples_sampling":
                store.dispatch(
                  getAllSamplesStageSampling_em_demo_a(response.data)
                );
                break;
              case "samples_plate_reading":
                store.dispatch(
                  getAllSamplesStagePlateReading_em_demo_a(response.data)
                );
                break;
              case "samples_microorg_identif":
                store.dispatch(
                  getAllSamplesStageMicroorganism_em_demo_a(response.data)
                );
                break;
              case "person_sampling":
                store.dispatch(
                  getAllPersonSamplesStageSampling_em_demo_a(response.data)
                );
                break;
              case "person_plate_reading":
                store.dispatch(
                  getAllPersonSamplesStagePlateReading_em_demo_a(response.data)
                );
                break;
              case "person_microorg_identif":
                store.dispatch(
                  getAllPersonSamplesStageMicroorganism_em_demo_a(response.data)
                );
                break;
              case "pending_incubation1":
                store.dispatch(
                  getAllSamplesStageIncubation1_em_demo_a(response.data)
                );
                break;
              case "pending_incubation2":
                store.dispatch(
                  getAllSamplesStageIncubation2_em_demo_a(response.data)
                );
                break;
              default:
      ...
      axios
        ...
        .then((response) => {
          if (200 == response.status) {
            //console.log(response.data);
            store.dispatch(
              getGivenSampleAnalysisResultEntry_em_demo_a(response.data)
            );
      ...
      axios
        ...
        .then((response) => {
          if (200 == response.status) {
            //console.log(response.data);
            store.dispatch(
              getSampleStatsCounterByStage_em_demo_a(response.data)
            );
            if (data && data.callBackFunction) {
              data.callBackFunction();
            }
