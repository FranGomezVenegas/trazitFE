...
import { FunctionsEnvMonit } from "./functions-env-monit.js"; //import '../../../internalComponents/Dialogs/DialogSimple/simple-modal-dialog.js'
 ...
 */ import {
  ...
  dialogIncubatorsListTableHeader,
  dialogInvestigationsListTableHeader,
  dialogInvestDecision,
} from "../03config/Dialogs/em-demo-a-dialogmodal-settings.js";
class EmDemoAWebcomponentEnvMonit extends FunctionsEnvMonit(
  ...
  static get properties() {
    return {
      ...
      dialogProductionLotNew: {
        ...
        notify: !0,
        bubble: !0,
        value: dialogProductionLotNew,
      },
      dialogProductionLotActivate: {
        type: Array,
        notify: !0,
        bubble: !0,
        value: dialogProductionLotActivate,
      },
      dialogincubBatchNew: {
        type: Array,
        notify: !0,
        bubble: !0,
        value: dialogincubBatchNew,
      },
      dialogincubAddTmpReading: {
        type: Array,
        notify: !0,
        bubble: !0,
        value: dialogincubAddTmpReading,
      },
      activeIncubatorsListHeader: {
        type: Array,
        value: dialogIncubatorsListTableHeader,
      },
      activeIncubatorsListRows: { type: Array },
      openInvestigationsListHeader: {
        type: Array,
        value: dialogInvestigationsListTableHeader,
      },
  ...
  static get template() {
    return html`
      ...
      <paper-dialog
        ...
        id="productionLotNew"
        on-opened-changed="productionLotNewOpenedChangedListener"
      >
        <em-demo-a-simple-modal-dialog
          id="productionLotNewDialog"
          action-name=""
      ...
      <paper-dialog
        ...
        no-cancel-on-outside-click
        class="roundbox boxshadow"
        id="productionLotActivate"
        on-opened-changed="productionLotActivateOpenedChangedListener"
      >
        <em-demo-a-simple-modal-dialog
          id="productionLotActivateDialog"
          action-name=""
          display-confirm-button
          display-cancel-button
          form-elements="{{dialogProductionLotActivate}}"
          on-dialog-button-clicked="dialogClosedProductionLotActivate"
        ></em-demo-a-simple-modal-dialog>
      </paper-dialog>
      ...
      <paper-dialog
        ...
        class="roundbox boxshadow"
        id="incubBatchNew"
        on-opened-changed="incubBatchNewOpenedChangedListener"
      >
        <em-demo-a-simple-modal-dialog
          id="incubBatchNewDialog"
          action-name=""
          display-confirm-button
          display-cancel-button
          form-elements="{{dialogincubBatchNew}}"
          on-dialog-button-clicked="dialogClosedincubBatchNew"
        ></em-demo-a-simple-modal-dialog>
      </paper-dialog>
      ...
      <paper-dialog
        ...
        no-cancel-on-outside-click
        class="roundbox boxshadow"
        id="incubBatchAssignIncubator"
        on-opened-changed="incubBatchAssignIncubatorOpenedChangedListener"
      >
        <em-demo-a-simple-modal-dialog
          id="incubBatchAssignIncubatorDialog"
          action-name=""
          display-confirm-button
          display-cancel-button
          list-header="[[activeIncubatorsListHeader]]"
          list-rows="{{activeIncubatorsListRows}}"
          on-dialog-button-clicked="dialogClosedincubBatchAssignIncubator"
        ></em-demo-a-simple-modal-dialog>
      </paper-dialog>
      ...
      <paper-dialog
        ...
        no-cancel-on-outside-click
        class="roundbox boxshadow"
        id="incubatorAddTempReading"
        on-opened-changed="incubatorAddTempReadingOpenedChangedListener"
      >
        <em-demo-a-simple-modal-dialog
          id="incubatorAddTempReadingDialog"
          action-name=""
          display-confirm-button
          display-cancel-button
          form-elements="{{dialogincubAddTmpReading}}"
          on-dialog-button-clicked="dialogClosedIncubatorAddTempReading"
        ></em-demo-a-simple-modal-dialog>
      </paper-dialog>
      ...
      <paper-dialog
        ...
        no-cancel-on-outside-click
        class="roundbox boxshadow"
        id="investigationAddObject"
        on-opened-changed="incubBatchAssignIncubatorOpenedChangedListener"
      >
        <em-demo-a-simple-modal-dialog
          id="investigationAddObjectDialog"
          action-name=""
          display-confirm-button
          display-cancel-button
          list-header="[[openInvestigationsListHeader]]"
          list-rows="{{openInvestigationsListRows}}"
          on-dialog-button-clicked="dialogClosedInvestigationAddObject"
        ></em-demo-a-simple-modal-dialog>
      </paper-dialog>
      ...
      <paper-dialog
        ...
        no-cancel-on-outside-click
        class="roundbox boxshadow"
        id="investigationDecision"
      >
        <em-demo-a-simple-modal-dialog
          id="investigationDecisionDialog"
          action-name=""
          display-confirm-button
          display-cancel-button
          form-elements="{{dialogInvestDecision}}"
          on-dialog-button-clicked="dialogClosedInvestigationDecision"
        ></em-demo-a-simple-modal-dialog>
      </paper-dialog>
    `;
  ...
  openDialog(dialogName, actionName) {
    if ("investigationNew" == dialogName) {
