...
import {
  ...
  setDataMiningQueryOutput as setDataMiningQueryOutput_em_demo_a,
 ...
 */ export const FrontendEndpointsEnvMonitBrowser = (superClass) =>
  class extends ApiSettings(ToastMethods(tokenMixin(superClass))) {
    ...
    getDataMiningQueryOutput(data, url) {
      var apiUrl = backendUrl + ApiEnvMonitStatsUrl + "?" + url; //console.log('getGivenSampleAnalysisResultEntry', apiUrl, data);
      if (!this.getFinalToken()) {
        return;
      }
      if (!schema_name) {
