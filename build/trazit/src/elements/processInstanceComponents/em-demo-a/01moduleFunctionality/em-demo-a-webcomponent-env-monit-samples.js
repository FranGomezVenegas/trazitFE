...
import { FunctionsEnvMonitSamples } from "./functions-env-monit-samples.js"; //import {mixinBehaviors} from '@polymer/polymer/lib/legacy/class.js';
...
import "../04procedure/dialogs/em-demo-a-simple-modal-dialog.js";
import "../04procedure/dialogs/em-demo-a-list-modal-sample-audit.js";
import "../04procedure/dialogs/em-demo-a-list-modal-enterresults.js";
...
} from "../03config/Dialogs/em-demo-a-dialogmodal-settings.js"; //mixinBehaviors([NeonAnimationRunnerBehavior],
class EmDemoAWebcomponentEnvMonitSamples extends FunctionsEnvMonitSamples(
  ...
  static get template() {
    return html`
      ...
      <!-- on-opened-changed="AddCommentOpenedChangedListener">-->
      ...
      >
        <em-demo-a-simple-modal-dialog
          ...
          form-elements="{{fieldsDialogAddComment}}"
          on-dialog-button-clicked="dialogClosedAddComment"
        >
        </em-demo-a-simple-modal-dialog>
      </paper-dialog>
      ...
      >
        <em-demo-a-list-modal-sample-audit
          id="sampleAuditDialog"
          sample-id="{{selectedObject.sample_id}}"
        ></em-demo-a-list-modal-sample-audit>
      </paper-dialog>
      ...
      >
        <em-demo-a-list-modal-enterresults
          id="enterResultsDialog"
          sample-id="{{selectedObject.sample_id}}"
        ></em-demo-a-list-modal-enterresults>
      </paper-dialog>
      <!--on-opened-changed="addSampleMicroorgOpenedChangedListener"-->

      <paper-dialog
        always-on-top
        no-cancel-on-outside-click
        class="roundbox boxshadow"
        id="addSampleMicroorg"
      >
        <em-demo-a-simple-modal-dialog
          id="addSampleMicroorgDialog"
          display-close-button
          allow-multi-select
          list-header="[[microorgListHeader]]"
          list-rows="{{microorgListRows}}"
          form-elements="{{dialogMicroorgListAdhocMicroorg}}"
          callBack-function="[[callBackFunction]]"
          callBack-function-error="[[callBackFunctionError]]"
          call-back-refresh-window="{{refreshWindow}}"
          selected-object="{{selectedObject}}"
          selected-items="{{selectedItems}}"
          sample-id="{{selectedObject.sample_id}}"
          on-dialog-button-clicked="dialogClosedaddSampleMicroorg"
        ></em-demo-a-simple-modal-dialog>
      </paper-dialog>
    `;
  }
...
customElements.define(
  ...
  EmDemoAWebcomponentEnvMonitSamples
);
