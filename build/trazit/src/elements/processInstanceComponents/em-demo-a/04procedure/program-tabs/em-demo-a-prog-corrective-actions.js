...
import { progTabCorrectiveActions } from "../../03config/Programs/em-demo-a-progtab-correctiveactions-settings.js";
import "../../03config/Programs/em-demo-a-progtab-correctiveactions-settings.js";
import {
  FrontendEndpointsEnvMonitForPrograms,
  FrontendEndpointsEnvMonitForInvestigation,
...
import { FunctionsEnvMonit } from "../../01moduleFunctionality/functions-env-monit.js"; //FieldsMethods EmDemoAapiEnvMonit FrontendEnvMonit
class EmDemoAProgCorrectiveActions extends FunctionsEnvMonit(
  FrontendEndpointsEnvMonitForInvestigation(
  ...
  stateChanged(state) {
    ...
    if (
      ...
      this.selectedProgramCorrectiveActions =
        state.emDemoA.selectedProgramCorrectiveActions;
    }
  }
