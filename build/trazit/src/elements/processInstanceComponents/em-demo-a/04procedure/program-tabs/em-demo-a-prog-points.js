import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import"../../../../internalComponents/Grids/vaadingrid-lit-singleselect.js";import{progTabPoints,shifts}from"../../03config/Programs/em-demo-a-progtab-points-settings.js";import"../../03config/Programs/em-demo-a-progtab-points-settings.js";import{FrontendEndpointsEnvMonitForPrograms}from"../../01moduleFunctionality/endpoints-frontend-env-monit.js";import"../../01moduleFunctionality/em-demo-a-webcomponent-env-monit.js";import{FunctionsEnvMonitSamples}from"../../01moduleFunctionality/functions-env-monit-samples.js";import"../dialogs/em-demo-a-simple-modal-dialog.js";import{FieldsMethods}from"../../../../../platform-mixins/functions/fields-methods.js";// EmDemoAapiEnvMonit FrontendEnvMonit
class EmDemoAProgPoints extends FieldsMethods(FunctionsEnvMonitSamples(FrontendEndpointsEnvMonitForPrograms(connect(store)(PolymerElement)))){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(state.emDemoA!=void 0&&state.emDemoA.selectedProgram.name!=void 0){//this.selectedProgram=state.emDemoA.selectedProgram; 
