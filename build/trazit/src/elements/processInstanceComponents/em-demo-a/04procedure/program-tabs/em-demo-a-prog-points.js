...
import {
  progTabPoints,
  shifts,
} from "../../03config/Programs/em-demo-a-progtab-points-settings.js";
import "../../03config/Programs/em-demo-a-progtab-points-settings.js";
...
import "../dialogs/em-demo-a-simple-modal-dialog.js";
import { FieldsMethods } from "../../../../../platform-mixins/functions/fields-methods.js"; // EmDemoAapiEnvMonit FrontendEnvMonit
class EmDemoAProgPoints extends FieldsMethods(
  ...
  pointClicked(e) {
    ...
    this.createProductionLotsList(); //console.log(this.selectedSamplingPoint, 'init');
...
customElements.define("em-demo-a-prog-points", EmDemoAProgPoints); // import '../../../../internalComponents/cards/card-form.js';
