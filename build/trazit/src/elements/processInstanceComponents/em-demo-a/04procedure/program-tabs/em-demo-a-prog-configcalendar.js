...
import "../../03config/Programs/em-demo-a-progtab-calendar-settings.js";
import { programProgConfigCalendar_progConfigCalendarTableHeaderFields } from "../../03config/Programs/em-demo-a-progtab-calendar-settings.js";
class EmDemoAProgConfigcalendar extends FieldsMethods(
  connect(store)(PolymerElement)
) {
  stateChanged(state) {
    this.selectedLanguage = state.app.user.appLanguage;
    if (null != state.emDemoA.selectedProgram) {
