...
import { programLimitsTab_sectionsTitle } from "../../03config/Programs/em-demo-a-progtab-limits-settings.js";
class EmDemoAProgLimits extends FieldsMethods(connect(store)(PolymerElement)) {
  stateChanged(state) {
