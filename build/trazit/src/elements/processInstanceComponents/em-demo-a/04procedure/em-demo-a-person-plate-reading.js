...
import "../03config/em-demo-a-person-plate-reading-settings.js";
import { personPlateReading } from "../03config/em-demo-a-person-plate-reading-settings.js"; //'../03config/config-process.js';
class emDemoAPersonPlateReading extends FieldsMethods(
    ...
    return html`
      ...
      <div class="main">
        ...
        <vaadingrid-lit-singleselect
          ...
          rowcontainer="{{allPersonSamplesStagePlateReading}}"
