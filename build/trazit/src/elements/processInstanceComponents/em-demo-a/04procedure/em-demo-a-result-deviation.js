...
import "../03config/ResultDeviation/em-demo-a-resultdeviationmainview-settings.js";
import {
...
import {
  ...
  tabsDefinition,
} from "../03config/ResultDeviation/em-demo-a-resultdeviationmainview-settings.js";
import { setSelectedProgram } from "../02Redux/em-demo-a_actions.js";
import "./deviation-tabs/em-demo-a-pending-decision.js";
import "./deviation-tabs/em-demo-a-investigation.js";
class emDemoAResultDeviation extends FieldsMethods(
  TabsMethods(
    FrontendEndpointsEnvMonitForProductionLot(
    ...
    return html`
      ...
      <div id="program_definition" class="programTabs">
        ...
        <iron-pages selected="[[currentSubTab]]" attr-for-selected="id">
          {{id}}
          <em-demo-a-pending-decision id="em-demo-a-pending-decision">
          </em-demo-a-pending-decision>
          <em-demo-a-investigation
            display-calendar="{{tabsDefinition.configCalendar.displayCalendar}}"
            display-table="{{tabsDefinition.configCalendar.displayTable}}"
            id="em-demo-a-investigation"
...
customElements.define("em-demo-a-result-deviation", emDemoAResultDeviation);
