...
import { FrontendEndpointsEnvMonitForProductionLot } from "../01moduleFunctionality/endpoints-frontend-env-monit.js";
...
import "../03config/em-demo-a-production-lot-settings.js";
import { productionLot } from "../03config/em-demo-a-production-lot-settings.js"; //'../03config/config-process.js';
class emDemoAProductionLot extends FieldsMethods(
  FunctionsEnvMonit(
    FrontendEndpointsEnvMonitForProductionLot(connect(store)(PolymerElement))
  )
) {
  static get properties() {
    return {
      tableDefinition: { type: Object, value: productionLot },
      activeProductionLots: { type: Array, notify: !0 },
    ...
    return html`
      ...
      <div class="main">
          ...
          <template is="dom-if" if="[[tableDefinition.displayButtons]]">
            ...
            >
              <field-controller
                ...
                field="{{currentfield}}"
                on-field-button-clicked="fieldButtonClickedForProductionLots"
        ...
        <vaadingrid-lit-singleselect
          ...
          rowcontainer="{{activeProductionLots}}"
...
customElements.define("em-demo-a-production-lot", emDemoAProductionLot); // import {PolymerElement, html} from '@polymer/polymer/polymer-element';
