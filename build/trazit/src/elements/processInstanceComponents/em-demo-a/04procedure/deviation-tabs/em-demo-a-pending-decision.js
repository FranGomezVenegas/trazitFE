...
import"../../../../internalComponents/Grids/vaadingrid-lit-singleselect.js";import{FrontendEndpointsEnvMonitForInvestigation}from"../../01moduleFunctionality/endpoints-frontend-env-monit.js";import{FunctionsEnvMonit}from"../../01moduleFunctionality/functions-env-monit.js";import"../../01moduleFunctionality/em-demo-a-webcomponent-env-monit-samples.js";import"../../03config/ResultDeviation/em-demo-a-pending-decision-settings.js";import{pendingDecisionWindowDefinition}from"../../03config/ResultDeviation/em-demo-a-pending-decision-settings.js";//'../03config/config-process.js';
class emDemoAPendingDecision extends FieldsMethods(FunctionsEnvMonit(FrontendEndpointsEnvMonitForInvestigation(connect(store)(PolymerElement)))){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(state.emDemoA!=void 0){this.investigationResultsPendingDecision=state.emDemoA.investigationResultsPendingDecision}}static get properties(){return{tableDefinition:{type:Object,value:pendingDecisionWindowDefinition},selectedObject:{type:Object,notify:!0},investigationResultsPendingDecision:{type:Object}}}static get template(){return html`
