...
import "../../03config/ResultDeviation/em-demo-a-investigation-settings.js";
import { windowDefinition } from "../../03config/ResultDeviation/em-demo-a-investigation-settings.js"; //'../03config/config-process.js';
class emDemoAInvestigation extends FieldsMethods(
  FunctionsEnvMonit(
    ...
    return html`
      ...
      <div class="main">
        ...
        <vaadingrid-lit-singleselect
          id="emdemoa-investigation"
          headerfields="{{tableDefinition.fieldsToDisplay}}"
          rowcontainer="{{openInvestigations}}"
        ...
        <template is="dom-if" if="[[tableDefinition.tableTitle2.display]]">
          <p class="tableTitle">
            {{labelValue(selectedLanguage, tableDefinition.tableTitle2.label)}}
          </p>
        </template>
        <vaadingrid-lit-singleselect
          id="emdemoa-investobjects"
          headerfields="{{tableDefinition.fieldsToDisplayTable2}}"
          rowcontainer="{{selectedObject.invest_objects}}"
          selected-object="{{selectedObject2}}"
        >
        </vaadingrid-lit-singleselect>
      </div>
    `;
