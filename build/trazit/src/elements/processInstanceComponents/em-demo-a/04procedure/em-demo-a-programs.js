...
import "../03config/Programs/em-demo-a-programmainview-settings.js";
import {
...
import {
  ...
  tabsDefinition,
} from "../03config/Programs/em-demo-a-programmainview-settings.js";
import { setSelectedProgram } from "../02Redux/em-demo-a_actions.js";
import "./program-tabs/em-demo-a-prog-home.js"; // import './program-tabs/em-demo-a-prog-configcalendar.js'; -> aqui esta el fallo del polymer-legacy
...
class emDemoAPrograms extends FieldsMethods(
  TabsMethods(
    FrontendEndpointsEnvMonitForProductionLot(
  ...
  programSelected(e) {
    if ("programsList" == e.detail.name) {
      ...
      var elem = this.shadowRoot.getElementById("em-demo-a-corrective-actions"); // if (elem){elem.getSelectedProgramCorrectiveActions();}
    }
  }
  tabSelected(e) {
    var curTab = [];
    ...
    return html`
      ...
      <div id="program_definition" class="programTabs">
        ...
        <iron-pages selected="[[currentSubTab]]" attr-for-selected="id">
          ...
          <em-demo-a-prog-configcalendar
            display-calendar="{{tabsDefinition.configCalendar.displayCalendar}}"
            display-table="{{tabsDefinition.configCalendar.displayTable}}"
            id="em-demo-a-config-calendar"
            selected-program="{{selectedProgram}}"
          >
          </em-demo-a-prog-configcalendar>
          <em-demo-a-prog-limits
            id="em-demo-a-limits"
            selected-program="{{selectedProgram}}"
          >
          </em-demo-a-prog-limits>
          <em-demo-a-prog-points-map
            id="em-demo-a-sampling-points-map"
            selected-program="{{selectedProgram}}"
          >
          </em-demo-a-prog-points-map>
          <em-demo-a-prog-points
            id="em-demo-a-sampling-points"
            selected-program="{{selectedProgram}}"
          >
          </em-demo-a-prog-points>
          <em-demo-a-prog-corrective-actions
            id="em-demo-a-corrective-actions"
            selected-program="{{selectedProgram}}"
          >
          </em-demo-a-prog-corrective-actions>
        </iron-pages>
