...
import "../03config/em-demo-a-person-microorganism-settings.js";
import { personMicroorganism } from "../03config/em-demo-a-person-microorganism-settings.js"; //'../03config/config-process.js';
class emDemoAPersonMicroorganism extends FieldsMethods(
  ...
  static get properties() {
    return {
      ...
      allPersonSamplesStageMicroorganism: { type: Array, notify: !0 },
    ...
    return html`
      ...
      <div class="main">
        ...
        <vaadingrid-lit-singleselect
          id="emdemoa-samplemicroorganism"
          headerfields="{{tableDefinition.sampleFieldToDisplay}}"
          rowcontainer="{{allPersonSamplesStageMicroorganism}}"
  ...
  loadSamplingTable() {
    ...
    this.getAllSamplesStageSampling(
      ...
      this.samplesStagesReduxVariables.PERSON_MICROORG_IDENTIF
    );
    this.getMicroorganismList(); //this.getAllPersonSamplesStageMicroorganism(this.tableDefinition);
    //     {
  ...
  stateChanged(state) {
    ...
    if (null != state.emDemoA) {
      this.allPersonSamplesStageMicroorganism =
        state.emDemoA.allPersonSamplesStageMicroorganism;
    }
  }
  ready() {
    super.ready();
...
customElements.define(
  "em-demo-a-person-microorganism",
  emDemoAPersonMicroorganism
);
