...
import "../03config/em-demo-a-sample-microorganism-settings.js";
import { sampleMicroorganism } from "../03config/em-demo-a-sample-microorganism-settings.js"; //'../03config/config-process.js';
class emDemoASampleMicroorganism extends FieldsMethods(
    ...
    return html`
      ...
      <div class="main">
        ...
        <vaadingrid-lit-singleselect
          ...
          rowcontainer="{{allSamplesStageMicroorganism}}"
