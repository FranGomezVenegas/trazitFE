...
import"../../../internalComponents/Grids/vaadingrid-lit-singleselect.js";import{FrontendEndpointsEnvMonitSamples,samplesStagesReduxVariables}from"../01moduleFunctionality/endpoints-frontend-env-monit-samples.js";import{FunctionsEnvMonitSamples}from"../01moduleFunctionality/functions-env-monit-samples.js";import"../01moduleFunctionality/em-demo-a-webcomponent-env-monit-samples.js";import"../03config/em-demo-a-sample-microorganism-settings.js";import{sampleMicroorganism}from"../03config/em-demo-a-sample-microorganism-settings.js";//'../03config/config-process.js';
class emDemoASampleMicroorganism extends FieldsMethods(FunctionsEnvMonitSamples(FrontendEndpointsEnvMonitSamples(connect(store)(PolymerElement)))){static get properties(){return{tableDefinition:{type:Object,value:sampleMicroorganism},samplesStagesReduxVariables:{type:String,value:samplesStagesReduxVariables},allSamplesStageMicroorganism:{type:Array,notify:!0},selectedObject:Object,callBackRefreshWindow:Object,selectedLanguage:{type:String}}}static get template(){return html`            
