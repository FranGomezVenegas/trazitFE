...
import "../03config/em-demo-a-sample-sampling-settings.js";
import { sampleSampling } from "../03config/em-demo-a-sample-sampling-settings.js"; //'../03config/config-process.js';
import { setCurrentTabSelObject } from "../../../platformComponents/Redux/actions/tabs_actions.js";
import {
...
class emDemoASampleSampling extends FieldsMethods(
  ...
  static get properties() {
    return {
      ...
      allSamplesStageSampling: { type: Array, notify: !0 },
  ...
  selTableItemIfSo(e) {
    ...
    var state = store.getState(),
      selObject = state.tabs.currentTabSelObject; //alert(selObject);
    if (selObject != void 0 && 0 < selObject.length) {
      var elem = this.shadowRoot.getElementById("emdemoa-samplesampling"); //var elem2=elem.shadowRoot.getElementById("gridLevel1");
      if (elem) {
        elem.selectItem(selObject); //alert(selObject+' selObject set');
      } else {
