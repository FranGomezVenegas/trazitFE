import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import{FieldsMethods}from"../../../../../platform-mixins/functions/fields-methods.js";import{UtilityMethods}from"../../../../../platform-mixins/functions/utility-methods.js";import"../../../../internalComponents/Grids/vaadingrid-lit-singleselect.js";import"../../../../internalComponents/Charts/chart-controller.js";import{FrontendEndpointsEnvMonitBrowser}from"../../01moduleFunctionality/endpoints-frontend-env-monit-browser.js";import"../../03config/em-demo-a-datamining-settings.js";import{FunctionsEnvMonit}from"../../01moduleFunctionality/functions-env-monit.js";import{FrontendEndpointsEnvMonitSavedQueries}from"../../01moduleFunctionality/endpoints-frontend-env-monit-saved-queries.js";import"../../01moduleFunctionality/em-demo-a-webcomponent-env-monit.js";//import {setSelectedBatch} from '../../02Redux/em-demo-a_actions';
import{defaultChartType,myQueries,queries,datamining_querySelectionForm,datamining_queryButtonForm,queryOutputDefinition}from"../../03config/em-demo-a-datamining-settings.js";//'../03config/config-process.js';
class emDemoADatamining extends FrontendEndpointsEnvMonitSavedQueries(UtilityMethods(FieldsMethods(FunctionsEnvMonit(FrontendEndpointsEnvMonitBrowser(connect(store)(PolymerElement)))))){static get properties(){return{queryOutputDefinition:{type:Object,value:queryOutputDefinition},queries:{type:Object,value:queries},myQueries:{type:Object},defaultChartType:{type:String,value:defaultChartType},queriesList:{type:Array,notify:!0,bubble:!0,value:datamining_querySelectionForm},buttonForm:{type:Array,notify:!0,bubble:!0,value:datamining_queryButtonForm},selectedQuery:{type:Object,notify:!0},dataminingQueryOutput:{type:Array,notify:!0},selectedObject:Object,callBackRefreshWindow:Object,selectedLanguage:{type:String},kpiCharts:{type:Array,notify:!0,value:[{display_chart:!0,chart_type:"pie",chart_name:"counter_range_eval",chart_title:{label_en:"Evaluation Counter",label_es:"Por tipo de evaluaci\xF3n"},counter_field_name:"count",counterLimits:{//min_allowed: 3,
...
this.myQueries=state.emDemoA.allSavedQueries}this.selectedLanguage=state.app.user.appLanguage}static get template(){return html`            
