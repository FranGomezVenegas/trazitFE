...
import "./program-elements/em-demo-a-program-selector.js";
import "./program-tabs/em-demo-a-prog-configcalendar.js";
import "../03config/em-demo-a-sample-login-settings.js";
import { tabsDefinition } from "../03config/em-demo-a-sample-login-settings.js";
...
class emDemoASampleLogin extends FieldsMethods(connect(store)(PolymerElement)) {
  ...
  static get template() {
    return html`
      ...
      <vaadin-button on-click="loadData"
        ><iron-icon icon="refresh"></iron-icon
      ></vaadin-button>
      <em-demo-a-program-selector
        id="program_selector"
        programs="{{programs}}"
