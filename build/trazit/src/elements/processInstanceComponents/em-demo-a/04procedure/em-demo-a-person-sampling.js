...
import "../01moduleFunctionality/em-demo-a-webcomponent-env-monit-samples.js"; //import '../01moduleFunctionality/env-monit-elements-sample.js';
...
import "../03config/em-demo-a-person-sampling-settings.js";
import { personSampling } from "../03config/em-demo-a-person-sampling-settings.js"; //'../03config/config-process.js';
//FrontendEnvMonitSample
class emDemoASampleSampling extends FieldsMethods(
  FrontendEndpointsEnvMonitSamples(
    FunctionsEnvMonitSamples(connect(store)(PolymerElement))
  )
) {
