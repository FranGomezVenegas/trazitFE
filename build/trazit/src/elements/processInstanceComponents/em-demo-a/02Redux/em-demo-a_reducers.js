...
return{...state,selectedBatch:action.DATA};case SELECTED_PROGRAM_CORRECTIVE_ACTION_LIST://console.log('em-demo-a_reducers.SELECTED_PROGRAM_CORRECTIVE_ACTION_LIST', action);
return{...state,selectedProgramCorrectiveActions:action.DATA};case ACTIVE_PRODUCTION_LOTS:return{...state,activeProductionLots:action.DATA};case ALL_PROGRAMS_UNRECEIVED_SAMPLES://console.log('em-demo-a_reducers.programs', action);
