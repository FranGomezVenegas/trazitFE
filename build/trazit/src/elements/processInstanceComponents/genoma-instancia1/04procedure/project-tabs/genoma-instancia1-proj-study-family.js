...
import { windowDefinition } from "../../03config/Project/genoma-instancia1-projtab-study-family-settings.js";
import "../../03config/Project/genoma-instancia1-projtab-study-family-settings.js";
 ...
 * @demo
 *
 */ class GenomaInstancia1ProjStudyFamily extends EndpointsActionsGenomaModule(
    ...
    return html`
      ...
      <div class="main">
        <table-with-buttons
          ...
          @selected-object-changed=${this.familyWasSelected}
          .selectedObject="${this.selected_family}"
