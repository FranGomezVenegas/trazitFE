...
import { windowDefinition } from "../../03config/Project/genoma-instancia1-projtab-home-settings.js";
import "../../../../../../node_modules/@alenaksu/json-viewer/build/index.js";
import "../../03config/Project/genoma-instancia1-projtab-home-settings.js";
import { FieldsMethods } from "../../../../../platform-mixins/functions/fields-methods.js"; //import '../../../../internalComponents/Elements/table-with-buttons';
import { ModuleFunctionsGenoma } from "../../01moduleFunctionality/0module-functions-genoma.js";
class GenomaInstancia1ProjHome extends FieldsMethods(
      ...
      <div class="main">
        <div name="elementDefinitionButtons" class="buttonGroup">
          ...
          <template is="dom-if" if="[[windowDefinition.displayButtons]]">
            <template
              is="dom-repeat"
              items="{{windowDefinition.buttons}}"
              as="currentfield"
            >
              <field-controller
                modulearea="STUDIES"
                ...
                on-field-button-clicked="fieldButtonClickedForProjects"
