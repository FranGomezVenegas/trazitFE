...
import { windowDefinition } from "../../03config/Project/genoma-instancia1-projtab-study-samples-settings.js";
import "../../03config/Project/genoma-instancia1-projtab-study-samples-settings.js";
 ...
 * @demo
 *
 */ class GenomaInstancia1ProjStudySamples extends EndpointsActionsGenomaModule(
  ...
  stateChanged(state) {
    ...
    console.log(
      "GenomaInstancia1ProjStudySamples",
      "stateChanged",
    ...
    return html`
      ...
      <div class="main">
        <table-with-buttons
          ...
          .table_data=${this.selected_study.study_individual_sample}
  ...
  sampleWasSelected(e) {
    console.log("proj-study-samples >> sampleWasSelected", e);
