...
import "../03config/Project/genoma-instancia1-projectmainview-settings.js";
import { FrontendEndpointsModuleGenoma } from "../01moduleFunctionality/endpoints-frontend-genoma.js";
import {
  window_tabs,
  projectMain_projectSelectionForm,
  home_defaultTab,
  tabsDefinition,
} from "../03config/Project/genoma-instancia1-projectmainview-settings.js";
import {
  setSelectedProject as setSelectedProject_genoma_instancia1,
  setSelectedStudy as setSelectedStudy_genoma_instancia1, //    as activeProjects_genoma_instancia1
...
import "./project-tabs/genoma-instancia1-proj-home.js"; // import './project-tabs/genoma-instancia1-proj-summary-cards';
import "./project-tabs/genoma-instancia1-proj-samples-set.js";
import "./project-tabs/genoma-instancia1-proj-study-variablevalues.js";
import "./project-tabs/genoma-instancia1-proj-study-samples.js";
import "./project-tabs/genoma-instancia1-proj-study-family.js";
import "./project-tabs/genoma-instancia1-proj-study-individuals.js";
import "./project-tabs/genoma-instancia1-proj-study-files.js"; // FrontendEndpointsEnvMonitForProductionLot FrontendEndpointsEnvMonitForPrograms
class GenomaInstancia1Project extends FieldsMethods(
  TabsMethods(FrontendEndpointsModuleGenoma(connect(store)(PolymerElement)))
) {
  stateChanged(state) {
  ...
  static get properties() {
    return {
      ...
      filtersList: {
        ...
        notify: !0,
        bubble: !0,
        value: projectMain_projectSelectionForm,
      },
    ...
    return html`
      ...
      <div class="wrapper">
        ...
        <div id="projects" class="filtersList">
          ...
          >
            <field-controller
              on-field-list-value-changed="filterListValueChanged"
      ...
      <div id="project_definition" class="projectTabs">
        ...
        <iron-pages selected="[[currentSubTab]]" attr-for-selected="id">
          ...
          <genoma-instancia1-proj-samples-set
            ...
            selected_study="{{selectedStudy}}"
            id="samples-set"
            selected-project="{{selectedProject}}"
          >
          </genoma-instancia1-proj-samples-set>
          <genoma-instancia1-proj-study-variablevalues
            id="study-variablevalues"
            selected-project="{{selectedProject}}"
          >
          </genoma-instancia1-proj-study-variablevalues>
          <genoma-instancia1-proj-study-samples
            id="study-samples"
            selected-project="{{selectedProject}}"
          >
          </genoma-instancia1-proj-study-samples>
