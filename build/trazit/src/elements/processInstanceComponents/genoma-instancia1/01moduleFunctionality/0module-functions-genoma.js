...
import { EndpointsActionsGenomaModule } from "./0module-endpoints-actions-genoma.js";
...
export const ModuleFunctionsGenoma = (superClass) =>
  class extends GenomaModuleDefinition(
    EndpointsActionsGenomaModule(ToastMethods(superClass))
  ) {
    ...
    dialogClosedProjectNew(e) {
      var buttonDefName = this.buttonDefinition.name,
        actionDefinition = this.genomaModuleStudyActions().find(function (tab) {
