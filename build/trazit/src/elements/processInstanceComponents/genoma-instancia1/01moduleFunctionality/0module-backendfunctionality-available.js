    ...
    genomaModuleProjectActions() {
      return [
        ...
        },
        {
          ...
          apiParams: [
            { paramName: "projectName", dataArrName: "name", isMandatory: !0 },
            {
              paramName: "fieldsNames",
              dataArrName: "newProjectFieldsNames",
              isMandatory: !1,
      ...
      return [
        ...
        },
        {
          ...
          apiParams: [
            ...
            { paramName: "ownerId", dataArrName: "owner_id", isMandatory: !0 },
            { paramName: "variableName", dataArrName: "name", isMandatory: !0 },
            { paramName: "newValue", dataArrName: "newValue", isMandatory: !0 },
          ],
        },
      ];
    }
