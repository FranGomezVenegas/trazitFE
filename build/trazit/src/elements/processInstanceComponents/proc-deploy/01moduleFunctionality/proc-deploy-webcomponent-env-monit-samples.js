import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import{FunctionsEnvMonitSamples}from"./functions-env-monit-samples.js";//import {mixinBehaviors} from '@polymer/polymer/lib/legacy/class.js';
...
import"../04procedure/dialogs/proc-deploy-simple-modal-dialog.js";import"../04procedure/dialogs/proc-deploy-list-modal-sample-audit.js";import"../04procedure/dialogs/proc-deploy-list-modal-enterresults.js";/* `proc-deploy-webcomponent-env-monit-samples` Description
 *
 * @customElement
 * @polymer
 * @demo
 * 
 */import{dialogAddComment,dialogMicroorgListTableHeader,dialogMicroorgListAdhocMicroorg}from"../03config/Dialogs/proc-deploy-dialogmodal-settings.js";//mixinBehaviors([NeonAnimationRunnerBehavior],
class procDeployWebcomponentEnvMonitSamples extends FunctionsEnvMonitSamples(connect(store)(PolymerElement)){static get properties(){return{selectedObject:{type:Object},selectedItems:{type:Array},callBackFunction:{type:Object},callBackFunctionError:{type:Object},buttonDefinition:{type:Object},fieldsDialogAddComment:{type:Array,notify:!0,bubble:!0,value:dialogAddComment},microorgListHeader:{type:Array,value:dialogMicroorgListTableHeader},microorgListRows:{type:Array},dialogMicroorgListAdhocMicroorg:{type:Array,value:dialogMicroorgListAdhocMicroorg},testingGroup:String}}stateChanged(state){if(null!=state.procDeploy){this.microorgListRows=state.procDeploy.microorganismList}}static get template(){return html`
        <style>
            paper-dialog{
