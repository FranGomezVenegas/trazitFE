 ...
 * @mixinFunction
 * @polymer
 */ export const EndpointsActionsEnvMonitModule = (superClass) =>
  class extends userConfirmationMixin(
    EnvMonitModuleDefinition(ApiSettings(ToastMethods(tokenMixin(superClass))))
  ) {
    ...
    sampleAPIEndpointCall(
      ...
      apiUrl =
        ...
        this.getFinalToken() +
        "&schemaPrefix=" +
        schema_name; //console.log('process-us>api-sample>sampleAPIEndpointCall', data.schemaPrefix, data.actionName, apiUrl, data.paramsUrl);
      ...
      axios
        ...
        .then((response) => {
          console.log(
            "proc-deploy > api-env-monit.js > sampleAPIEndpointCall",
            "response.data",
            response.data
          );
    ...
    REDUX_GET_INCUBBATCH(
      ...
      var state = store.getState(),
        selectedBatch = state.procDeploy.selectedBatch;
