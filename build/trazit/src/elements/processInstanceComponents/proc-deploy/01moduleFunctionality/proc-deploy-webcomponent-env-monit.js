 ...
 * @demo
 * 
 */import{dialogProductionLotNew,dialogProductionLotActivate,dialogincubBatchNew,dialogincubAddTmpReading,dialogIncubatorsListTableHeader}from"../03config/Dialogs/proc-deploy-dialogmodal-settings.js";class procDeployWebcomponentEnvMonit extends FunctionsEnvMonit(connect(store)(PolymerElement)){static get properties(){return{selectedObject:{type:Object},callBackFunction:{type:Object},callBackFunctionError:{type:Object},buttonDefinition:{type:Object},//fieldsDialogAddComment:{type: Array, notify: true, bubble: true, value: dialogAddComment},
dialogProductionLotNew:{type:Array,notify:!0,bubble:!0,value:dialogProductionLotNew},dialogProductionLotActivate:{type:Array,notify:!0,bubble:!0,value:dialogProductionLotActivate},dialogincubBatchNew:{type:Array,notify:!0,bubble:!0,value:dialogincubBatchNew},dialogincubAddTmpReading:{type:Array,notify:!0,bubble:!0,value:dialogincubAddTmpReading},activeIncubatorsListHeader:{type:Array,value:dialogIncubatorsListTableHeader},activeIncubatorsListRows:{type:Array}}}stateChanged(state){if(null!=state.procDeploy){this.activeIncubatorsListRows=state.procDeploy.allIncubators}}static get template(){return html`
        <!-- <style>
        //     paper-dialog{
