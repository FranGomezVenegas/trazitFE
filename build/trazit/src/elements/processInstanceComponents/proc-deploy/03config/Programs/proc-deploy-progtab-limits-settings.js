export const programLimitsTab_sectionsTitle={analysis:{label_en:"Analysis",label_es:"An\xE1lisis"},variations:{label_en:"Variations",label_es:"Variaciones"},limits:{label_en:"Limits",label_es:"L\xEDmites"}};// export const windowDefinition={
...
//     ]    
//   };
const documentContainerprocDeployProgtabLimitsStyle=document.createElement("proc-deploy-progtab-limits-style");documentContainerprocDeployProgtabLimitsStyle.setAttribute("style","display: none;");documentContainerprocDeployProgtabLimitsStyle.innerHTML=`
