...
return!0}export{isTabOpn};export const schema_name="proc-deploy";export const personal_smp_template="prog_pers_template";export const prodLotActiveOnCreate="true";export const shifts=[{keyName:"M1",keyValue_en:"M1",keyValue_es:"M1"},{keyName:"M2",keyValue_en:"M2",keyValue_es:"M2"}];// export const incubationMode='SAMPLE_AND_INCUBATOR';
