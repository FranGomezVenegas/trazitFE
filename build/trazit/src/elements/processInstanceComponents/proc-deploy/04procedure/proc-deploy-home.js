import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import"../../../internalComponents/Charts/chart-controller.js";import{windowDefinition}from"../03config/proc-deploy-home-settings.js";import"../03config/proc-deploy-home-settings.js";import{FieldsMethods}from"../../../../platform-mixins/functions/fields-methods.js";import{FrontendEndpointsEnvMonitSamples}from"../01moduleFunctionality/endpoints-frontend-env-monit-samples.js";//import './proc-deploy-kpi';
class procDeployHome extends FieldsMethods(FrontendEndpointsEnvMonitSamples(connect(store)(PolymerElement))){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(null!=state.procDeploy){var kpis=[];if(state.procDeploy.kpis){kpis=state.procDeploy.kpis}kpis.sampleStatCounterByStage=state.procDeploy.sampleStatsCounterByStage;kpis.sampleStatsLastNresults=state.procDeploy.sampleStatsLastNresults;console.log("kpis",kpis);this.kpiData=kpis}}static get properties(){return{windowDefinition:{type:Object,value:windowDefinition},selectedLanguage:{type:String},kpiData:{type:Object}}}static get template(){return html`
