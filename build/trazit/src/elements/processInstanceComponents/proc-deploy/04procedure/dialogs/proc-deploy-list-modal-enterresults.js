import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import"../../../../../../node_modules/@polymer/iron-collapse/iron-collapse.js";import"./proc-deploy-dialogmodal-buttons.js";import"../../03config/Dialogs/proc-deploy-list-modal-enterresults-settings.js";import{enterResult,resultCheckerMessages}from"../../03config/Dialogs/proc-deploy-list-modal-enterresults-settings.js";import{FrontendEndpointsEnvMonitSamples}from"../../01moduleFunctionality/endpoints-frontend-env-monit-samples.js";import{FunctionsEnvMonitSamples}from"../../01moduleFunctionality/functions-env-monit-samples.js";import{FieldsMethods}from"../../../../../platform-mixins/functions/fields-methods.js";import"../../../../internalComponents/form-fields/field-icon-button.js";import{iconsMethods}from"../../01moduleFunctionality/functions-icons.js";import{SampleIcons}from"../../03config/config-icons.js";/**
 ...
 * @demo
 * 
 */class ProcDeployListModalEnterResults extends SampleIcons(iconsMethods(FieldsMethods(FunctionsEnvMonitSamples(FrontendEndpointsEnvMonitSamples(connect(store)(PolymerElement)))))){static get properties(){return{opened:{type:Boolean,value:!0,reflectToAttribute:!0},horizontal:{type:Boolean},displayCancelButton:{type:Boolean,notify:!0},displayConfirmButton:{type:Boolean,notify:!0},displayCloseButton:{type:Boolean,notify:!0},tableDefinition:{type:Object,value:enterResult},resultCheckerMessages:{type:Object,value:resultCheckerMessages},listRows:Array,listHeader:Array,sampleId:Number,testingGroup:String,selectedObject:{type:Object,notify:!0},selectedLanguage:{type:String},detailOpenStatus:{type:Boolean,value:!1}}}toggle(){this.$.collapse.toggle()}getSpecRule(item){return item.spec_eval_detail}getItemValue(flddetail,item){if("locking_reason"==flddetail.name){if("en"==this.selectedLanguage){return item.locking_reason.message_en}if("es"==this.selectedLanguage){return item.locking_reason.message_es}}if("spec_rule"==flddetail.name){return this.getSpecRule(item)}return item[flddetail.name]}static get template(){return html`        
