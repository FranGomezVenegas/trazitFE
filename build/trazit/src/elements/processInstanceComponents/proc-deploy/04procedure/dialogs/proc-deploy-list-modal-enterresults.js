...
import "../../03config/Dialogs/proc-deploy-list-modal-enterresults-settings.js";
import {
  enterResult,
  resultCheckerMessages,
} from "../../03config/Dialogs/proc-deploy-list-modal-enterresults-settings.js";
 ...
 * @demo
 *
 */ class ProcDeployListModalEnterResults extends SampleIcons(
  iconsMethods(
    FieldsMethods(
