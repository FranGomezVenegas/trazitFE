import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import"../../../../../node_modules/@polymer/paper-tabs/paper-tabs.js";import"../../../../../node_modules/@polymer/paper-tabs/paper-tab.js";import"../../../../../node_modules/@polymer/iron-pages/iron-pages.js";import{FieldsMethods}from"../../../../platform-mixins/functions/fields-methods.js";import{TabsMethods}from"../../../../platform-mixins/platform-functions/tabs-functions.js";import"../03config/Programs/proc-deploy-programmainview-settings.js";import{FrontendEndpointsEnvMonitForPrograms,FrontendEndpointsEnvMonitForProductionLot}from"../01moduleFunctionality/endpoints-frontend-env-monit.js";import{em_programs_tabs,programMain_programSelectionForm,programHome_defaultTab,tabsDefinition}from"../03config/Programs/proc-deploy-programmainview-settings.js";import{setSelectedProgram}from"../02Redux/proc-deploy_actions.js";//import './program-tabs/proc-deploy-prog-home.js';
// import './program-tabs/proc-deploy-prog-configcalendar.js'; -> aqui esta el fallo del polymer-legacy
import"./program-tabs/proc-deploy-prog-limits.js";import"./program-tabs/proc-deploy-prog-points.js";import"./program-tabs/proc-deploy-prog-points-map.js";// import './program-tabs/proc-deploy-prog-corrective-actions.js';
class procDeployPrograms extends FieldsMethods(TabsMethods(FrontendEndpointsEnvMonitForProductionLot(FrontendEndpointsEnvMonitForPrograms(connect(store)(PolymerElement))))){stateChanged(state){if(null!=state.procDeploy){this.programs=state.procDeploy.programs.programsList;if(null!=this.programs){this.fillProgramsList()}}// if (state.app.user.appProcedureList.procedures!=null){  
