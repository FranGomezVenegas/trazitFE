import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import{FieldsMethods}from"../../../../../platform-mixins/functions/fields-methods.js";import{programLimitsTab_sectionsTitle}from"../../03config/Programs/proc-deploy-progtab-limits-settings.js";class procDeployProgLimits extends FieldsMethods(connect(store)(PolymerElement)){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(null!=state.procDeploy){//this.selectedProgram=state.procDeploy.selectedProgram;
...
programLimitsTab_sectionsTitle:{type:Object,value:programLimitsTab_sectionsTitle},tableTitle:{type:Object,value:{name:"tableTitle",label_en:"Program limits list",label_es:"Lista de rangos l\xEDmite para el programa"}}}}static get template(){return html`
        <style>
