...
import {
  progTabPoints,
  shifts,
} from "../../03config/Programs/proc-deploy-progtab-points-settings.js";
import "../../03config/Programs/proc-deploy-progtab-points-settings.js";
...
import "../dialogs/proc-deploy-simple-modal-dialog.js"; //FieldsMethods procDeployapiEnvMonit FrontendEnvMonit
class procDeployProgSchedule extends FunctionsEnvMonitSamples(
      ...
      <div class="main">
        ...
        <paper-dialog id="pointCard">
          <proc-deploy-simple-modal-dialog
            ...
            form-elements="{{selectedSamplingPoint}}"
...
customElements.define("proc-deploy-prog-schedule", procDeployProgSchedule); // import '../../../../internalComponents/cards/card-form.js';
