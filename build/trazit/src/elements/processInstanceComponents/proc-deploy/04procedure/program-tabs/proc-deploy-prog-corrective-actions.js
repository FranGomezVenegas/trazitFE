...
import { progTabCorrectiveActions } from "../../03config/Programs/proc-deploy-progtab-correctiveactions-settings.js";
import "../../03config/Programs/proc-deploy-progtab-correctiveactions-settings.js";
import { FrontendEndpointsEnvMonitForPrograms } from "../../01moduleFunctionality/endpoints-frontend-env-monit.js";
import "../../01moduleFunctionality/proc-deploy-webcomponent-env-monit.js";
import { FunctionsEnvMonit } from "../../01moduleFunctionality/functions-env-monit.js"; //FieldsMethods procDeployapiEnvMonit FrontendEnvMonit
class procDeployProgCorrectiveActions extends FunctionsEnvMonit(
  FrontendEndpointsEnvMonitForPrograms(connect(store)(PolymerElement))
) {
  stateChanged(state) {
    this.selectedLanguage = state.app.user.appLanguage;
    if (
      state.procDeploy != void 0 &&
      state.procDeploy.selectedProgram.name != void 0
    ) {
      this.selectedProgram = state.procDeploy.selectedProgram;
      this.selectedProgramCorrectiveActions =
        state.procDeploy.selectedProgramCorrectiveActions;
    }
  }
    ...
    return html`
      ...
      <div class="main">
          ...
          <template is="dom-if" if="[[tableDefinition.displayButtons]]">
            ...
            >
              <field-controller
                ...
                field="{{currentfield}}"
                on-field-button-clicked="fieldButtonClickedForPrograms"
        ...
        <vaadingrid-lit-singleselect
          ...
          rowcontainer="{{selectedProgramCorrectiveActions}}"
...
customElements.define(
  ...
  procDeployProgCorrectiveActions
