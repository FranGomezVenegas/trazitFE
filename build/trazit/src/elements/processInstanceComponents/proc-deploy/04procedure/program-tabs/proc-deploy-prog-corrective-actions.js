import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import"../../../../internalComponents/Grids/vaadingrid-lit-singleselect.js";import{progTabCorrectiveActions}from"../../03config/Programs/proc-deploy-progtab-correctiveactions-settings.js";import"../../03config/Programs/proc-deploy-progtab-correctiveactions-settings.js";import{FrontendEndpointsEnvMonitForPrograms}from"../../01moduleFunctionality/endpoints-frontend-env-monit.js";import"../../01moduleFunctionality/proc-deploy-webcomponent-env-monit.js";import{FunctionsEnvMonit}from"../../01moduleFunctionality/functions-env-monit.js";//FieldsMethods procDeployapiEnvMonit FrontendEnvMonit
class procDeployProgCorrectiveActions extends FunctionsEnvMonit(FrontendEndpointsEnvMonitForPrograms(connect(store)(PolymerElement))){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(state.procDeploy!=void 0&&state.procDeploy.selectedProgram.name!=void 0){this.selectedProgram=state.procDeploy.selectedProgram;this.selectedProgramCorrectiveActions=state.procDeploy.selectedProgramCorrectiveActions}}static get properties(){return{tableDefinition:{type:Object,value:progTabCorrectiveActions},selectedObject:{type:Object,notify:!0},selectedProgram:{type:Object},selectedProgramCorrectiveActions:{type:Object}}}static get template(){return html`
