...
import"../../../../internalComponents/Charts/chart-controller.js";import{windowDefinition,em_home_tab_subTabs,programHome_defaultTab,hometab_area}from"../../03config/Programs/proc-deploy-progtab-home-settings.js";import"../../03config/Programs/proc-deploy-progtab-home-settings.js";import{FieldsMethods}from"../../../../../platform-mixins/functions/fields-methods.js";class procDeployProgHome extends FieldsMethods(connect(store)(PolymerElement)){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(null!=state.procDeploy){this.selectedProgram=state.procDeploy.selectedProgram}}static get properties(){return{windowDefinition:{type:Object,value:windowDefinition},selectedLanguage:{type:String},selectedProgram:{type:Object},homeTabSubTabs:{type:Object,value:em_home_tab_subTabs},currentSubTab:{type:String,value:programHome_defaultTab},hometab_area:{type:Object,value:hometab_area}}}static get template(){return html`
