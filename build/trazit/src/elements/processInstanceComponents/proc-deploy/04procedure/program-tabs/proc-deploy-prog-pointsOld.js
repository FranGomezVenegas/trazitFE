import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import"../../../../../../node_modules/@polymer/paper-dialog/paper-dialog.js";//import '../../../../internalComponents/grid-components/vaadingrid-singleselect.js';
import"../../../../internalComponents/Grids/vaadingrid-lit-singleselect.js";import"../../../../internalComponents/cards/card-form.js";import{procDeployapiEnvMonit}from"../../01moduleFunctionality/api-env-monit.js";import"../../01moduleFunctionality/env-monit-elements.js";import{FrontendEnvMonit}from"../../01moduleFunctionality/frontend-env-monit.js";import{FrontendEnvMonitSample}from"../../01moduleFunctionality/frontend-env-monit-sample.js";import{progProintsFormButtons,progProintsCardFormButtons,programProgPoints_samplePointsTableHeaderFields,shifts}from"../../03config/config-process.js";import{setSelectedSamplingPoint}from"../../02Redux/proc-deploy_actions.js";import{FieldsMethods}from"../../../../../platform-mixins/functions/fields-methods.js";class procDeployProgPoints extends FieldsMethods(FrontendEnvMonitSample(procDeployapiEnvMonit(FrontendEnvMonit(connect(store)(PolymerElement))))){static get properties(){return{selectedLanguage:{type:String},selectedPointCardForm:{type:Object},//, value:appLogin_formFields},
