...
import "../03config/proc-deploy-sample-reviewtestingmb-settings.js";
import { windowSettings } from "../03config/proc-deploy-sample-reviewtestingmb-settings.js"; //'../03config/config-process.js';
import {
...
class procDeploySampleReviewtestingmb extends FieldsMethods(
    ...
    return html`
      ...
      <div class="main">
        ...
        <vaadingrid-lit-singleselect
          ...
          rowcontainer="{{samplesAnalysisPendingRevisionMB}}"
