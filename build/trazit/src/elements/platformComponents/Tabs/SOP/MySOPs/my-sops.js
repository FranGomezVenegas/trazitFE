import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import{ApiAndFrontendSopUser}from"../../../../../platform-mixins/apis/api-and-frontend-sopuser.js";import{sopMySops_buttons,sopStatusLabel,sopMySops_cardContent}from"../../../../../config/platform/logic/sop-config.js";import{FieldsMethods}from"../../../../../platform-mixins/functions/fields-methods.js";import{tableFieldLabel}from"../../../../../config/platform/tablefield_labels.js";import"../../../../internalComponents/form-fields/field-controller.js";import"../pdf-link.js";import"./my-sops-style.js";class MySops extends tableFieldLabel(FieldsMethods(ApiAndFrontendSopUser(connect(store)(PolymerElement)))){static get properties(){return{//            finalToken: {type: String, observer:'onFinalTokenFilled'},
allMySops:Array,dialogButtons:{type:Array,value:sopMySops_buttons},sopStatusLabel:{type:Object,value:sopStatusLabel},selectedLanguage:String,tableFieldLabelSchemaName:{type:String,value:"config"},tableFieldLabelTableName:{type:String,value:"usersop"},sopMySops_cardContent:{type:Object,value:sopMySops_cardContent}}}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;this.allMySops=state.SOPS.userAllSop}static get template(){return html`
