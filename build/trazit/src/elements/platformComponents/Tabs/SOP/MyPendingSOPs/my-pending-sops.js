import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import{ApiAndFrontendSopUser}from"../../../../../platform-mixins/apis/api-and-frontend-sopuser.js";import{tableFieldLabel}from"../../../../../config/platform/tablefield_labels.js";import{FieldsMethods}from"../../../../../platform-mixins/functions/fields-methods.js";import{sopUserPendingSop_fieldToRetrieve,sopMyPendingSops_buttons,sopStatusLabel,sopMyPendingSops_cardContent}from"../../../../../config/platform/logic/sop-config.js";import"../pdf-link.js";import"./my-pending-sops-style.js";class MyPendingSops extends tableFieldLabel(FieldsMethods(ApiAndFrontendSopUser(connect(store)(PolymerElement)))){static get properties(){return{allMyPendingSops:Object,dialogButtons:{type:Array,value:sopMyPendingSops_buttons},sopStatusLabel:{type:Object,value:sopStatusLabel},sopMyPendingSops_cardContent:{type:Object,value:sopMyPendingSops_cardContent}}}stateChanged(state){this.allMyPendingSops=state.SOPS.userPendingSop}onFinalTokenFilled(){var paramsUrl="sopFieldsToRetrieve="+sopUserPendingSop_fieldToRetrieve,datas=[];datas.paramsUrl=paramsUrl;this.frontEndSopUserAPI(datas)}static get template(){return html`
