...
import { diagnosticToNotification } from "../../../app/app-functions/notification-obj"; //import {incubationMode} from '../03config/config-process';
/**
 * @mixinFunction
 * @polymer
 */ export const ApiProcedures = (superClass) =>
        ...
        case "EM_BATCH_INCUB_REMOVE_SMP": //console.log('EM_BATCH_INCUB_REMOVE_SMP ', 'selectedRow.selectedBatch', selectedRow.selectedBatch);
          if (
            ...
            var errorMessageBatchNotSelected = {
              ...
              notifObj = diagnosticToNotification(
