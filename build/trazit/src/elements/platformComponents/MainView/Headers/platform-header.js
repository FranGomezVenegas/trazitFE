import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import{platformHeaderFields,platformHeader_personFieldsName}from"./platform-header-settings.js";import{appLogOut_logOutMessage}from"../../../../config/platform/main-layout/plaftorm-config.js";import{doLogout,setAppLanguage}from"../../Redux/actions/app_actions.js";import{doLogoutNotification}from"../../Redux/actions/notifications_actions.js";import{addSystemTab,setCurrentTab,doLogoutTab}from"../../Redux/actions/tabs_actions.js";import"./platform-header-style.js";class PlatformHeader extends connect(store)(PolymerElement){static get properties(){return{//selectedLanguage: String,
platformHeaderFields:{type:Object,value:platformHeaderFields},platformHeader_personFieldsName:{type:Object,value:platformHeader_personFieldsName},appLogOut_logOutMessage:{type:Object,value:appLogOut_logOutMessage}}}static get template(){return html`
        ...
        `}platformHeaderRightClicked(e){if(e.detail.avatarDefinition.tab){store.dispatch(addSystemTab(e.detail.avatarDefinition.tab));store.dispatch(setCurrentTab(e.detail.avatarDefinition.tab))}else{this.doLogout()}return}doLogout(){var message="";switch(this.selectedLanguage){case"es":message=this.appLogOut_logOutMessage.closedSession.message_es;break;//message=response.data.message_es; break;            
