import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import{sopPaneIconAndBadge_icons}from"./sop-icon-and-badge-settings.js";import{SOP_pendingSOPTab,SOP_userMySOPTab}from"../../../Tabs/tabs-settings.js";import"./sop-icon-and-badge-style.js";import"../../../../../../node_modules/@polymer/paper-badge/paper-badge.js";import{addSystemTab,setCurrentTab}from"../../../Redux/actions/tabs_actions.js";/**
 ...
 * @demo
 * 
 */class SopIconAndBadge extends connect(store)(PolymerElement){static get properties(){return{iconName:{type:String,value:sopPaneIconAndBadge_icons.iconGreen},showPendingSOP:Boolean,sopPaneIconAndBadge_icons:{type:Object,value:sopPaneIconAndBadge_icons}}}static get template(){return html`      
...
this.showPendingSOP=!0;this.iconName=this.sopPaneIconAndBadge_icons.iconRed}}pendingSOPClicked(){store.dispatch(addSystemTab(SOP_pendingSOPTab));store.dispatch(setCurrentTab(SOP_pendingSOPTab))}AllUserSOPClicked(){store.dispatch(addSystemTab(SOP_userMySOPTab));store.dispatch(setCurrentTab(SOP_userMySOPTab))}}customElements.define("sop-icon-and-badge",SopIconAndBadge);