...
import {
  appLogin_formFields,
  appLogin_ribbon,
  appLogin_authenticationMessage,
  appLogin_logoOnTop, //, userProfileHome
} from "../../../config/platform/platform-login/platform-login-settings.js";
import "../../../config/platform/platform-login/platform-login-style.js";
import { AuthenticationApi } from "../../../platform-mixins/apis/api-authentication.js";
import { startLoading, setAppLanguage } from "../Redux/actions/app_actions.js"; //import './../../internalComponents/others/language-selectortwoflags.js';
import "../../internalComponents/others/language-selector.js";
import("../../../../node_modules/@polymer/paper-dialog/paper-dialog.js"); //import '@thuoe/mp4-video-player';
 ...
 * @demo
 *
 */ class PlatformLogin extends AuthenticationApi(
    ...
    return html`
      ...
      <div class="login">
        <div class="appLoginForm">
          ...
          <paper-spinner-lite
            alt="Authenticating user and password"
            width="6px"
            active="[[loading]]"
          ></paper-spinner-lite>
          <form id="form">
        ...
        <paper-dialog
          ...
          top="4px"
          id="videowindowdialog"
        >
          <dialog-videoplayer
            index-content="{{videoToc}}"
