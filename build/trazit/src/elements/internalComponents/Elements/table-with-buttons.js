import{PolymerElement,html}from"../../../../node_modules/@polymer/polymer/polymer-element.js";import{FieldsMethods}from"../../../platform-mixins/functions/fields-methods.js";import{ModuleFunctionsGenoma}from"../../processInstanceComponents/genoma-instancia1/01moduleFunctionality/0module-functions-genoma.js";import"../../processInstanceComponents/genoma-instancia1/01moduleFunctionality/genoma-instancia1-webcomponent-project.js";import"../../processInstanceComponents/genoma-instancia1/03config/Project/genoma-instancia1-projtab-study-samples-settings.js";import{FrontendEndpointsModuleGenoma}from"../../processInstanceComponents/genoma-instancia1/01moduleFunctionality/endpoints-frontend-genoma.js";/**
 ...
 * @demo
 * 
 */class TableWithButtons extends FrontendEndpointsModuleGenoma(FieldsMethods(ModuleFunctionsGenoma(PolymerElement))){static get properties(){return{elementDefinition:{type:Object},modulearea:{type:String},tableData:{type:Array},selectedProject:{type:Object,notify:!0},selectedStudy:{type:Object,notify:!0}}}static get template(){return html`
