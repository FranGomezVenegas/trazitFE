import{PolymerElement,html}from"../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../store.js";// import { 
//     addTab,
//     closeTab,
//     setCurrentTab
//   } from '../../app/Redux/actions/tabs_actions';
class FieldButtonGroup extends connect(store)(PolymerElement){static get properties(){return{_page:String,currentProcedure:{type:Object,notify:!0},currentProcedureEvent:{type:Object,notify:!0},value:{type:String,notify:!0},fieldClass:String}}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage}labelValue(){//console.log('field-button-group', 'labelValue', this.selectedLanguage, this.field);
if("en"==this.selectedLanguage)return this.procedure.label_en+"-"+this.field.label_en;if("es"==this.selectedLanguage)return this.procedure.label_es+"-"+this.field.label_es;return this.field.label_en}static get template(){return html`
            <style>
                paper-button.blue {
                    min-width: 3em;
                    padding: 0em;
