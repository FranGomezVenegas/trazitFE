...
}}));this.value=newVal;this.value_no_index=newValStr}static get properties(){return{field:{type:Object,notify:!0},value:{type:String,notify:!0},value_no_index:{type:String,notify:!0},index:Number,fieldIndex:Number}}changeList(newList){this.set("field.items",newList)}static get template(){return html`      
    <style>
