...
import { CloseOnEscPressed } from "../close-dialog-on-esc-pressed-mixin.js";
import {
  closeEsignDialog,
  resetAndCloseEsignDialog,
  esignSuccess,
  esignFailure,
} from "../../../platformComponents/Redux/actions/esign-actions.js";
import "./dialog-esign-style.js";
import { dialog_buttons } from "../dialogmodal-buttons-settings.js";
import {
  platformEsign_windowTitle,
  platformEsign_notCorrectMessage,
} from "./dialog-esign-settings.js";
...
class EsignDialog extends FieldsMethods(
  CloseOnEscPressed(AuthenticationApi(connect(store)(PolymerElement)))
) {
  static get properties() {
    return {
      dialogButtons: { type: Array, value: dialog_buttons }, //finalToken: String,
      opened: { type: Boolean },
      ...
      validationNotCorrectMessage: {
        type: Object,
        value: platformEsign_notCorrectMessage,
      },
      selectedLanguage: { type: String },
      platformEsign_windowTitle: {
        type: Object,
        value: platformEsign_windowTitle,
      },
    };
  }
