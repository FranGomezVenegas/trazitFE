import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import"../../../../../node_modules/@polymer/paper-button/paper-button.js";import"../../../../../node_modules/@polymer/polymer/lib/elements/dom-if.js";import{store}from"../../../../store.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{AuthenticationApi}from"../../../../platform-mixins/apis/api-authentication.js";import{CloseOnEscPressed}from"../close-dialog-on-esc-pressed-mixin.js";import{closeEsignDialog,resetAndCloseEsignDialog,esignSuccess,esignFailure}from"../../../platformComponents/Redux/actions/esign-actions.js";import"./dialog-esign-style.js";import{dialog_buttons}from"../dialogmodal-buttons-settings.js";import{platformEsign_windowTitle,platformEsign_notCorrectMessage}from"./dialog-esign-settings.js";import{FieldsMethods}from"../../../../platform-mixins/functions/fields-methods.js";import"../dialogmodal-buttons.js";let acceptedHandler=null,canceledHandler=null;class EsignDialog extends FieldsMethods(CloseOnEscPressed(AuthenticationApi(connect(store)(PolymerElement)))){static get properties(){return{dialogButtons:{type:Array,value:dialog_buttons},//finalToken: String,
...
validationNotCorrectMessage:{type:Object,value:platformEsign_notCorrectMessage},selectedLanguage:{type:String},platformEsign_windowTitle:{type:Object,value:platformEsign_windowTitle}}}changeAttemptsPhrase(){if("en"==this.selectedLanguage){this.attemptsPhrase="*** Attempts:"+this.numAttempts+" of "+this.maximumFailures}if("es"==this.selectedLanguage){this.attemptsPhrase="*** Intentos:"+this.numAttempts+" de "+this.maximumFailures}return}changeClass(opened){if(opened){return""}return"closed"}static get template(){return html`
