define(["exports"], function (_exports) {
  ...
  _exports.appLogin_authenticationMessage = _exports.appLogOut_logOutMessage = void 0; // export const sopUserAllSop_fieldToRetrieve='procedure|sop_id|brief_summary|sop_name|status|file_link';
