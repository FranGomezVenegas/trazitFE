define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.appLogin_authenticationMessage=_exports.appLogOut_logOutMessage=void 0;// export const sopUserAllSop_fieldToRetrieve='procedure|sop_id|brief_summary|sop_name|status|file_link';
...
//     }
const appLogOut_logOutMessage={closedSession:{message_en:"Session closed",message_es:"Sesi\xF3n cerrada"}};_exports.appLogOut_logOutMessage=appLogOut_logOutMessage;const appLogin_authenticationMessage={connectedSuccess_singleRole:{message_en:"Valid user, Starting session ... please wait",message_es:"Usuario v\xE1lido, iniciando sesi\xF3n ... por favor espere"},connectedSuccess:{message_en:"Valid user, please proceed selecting the role",message_es:"Usuario v\xE1lido, por favor escoja rol"},connectedFails:{message_en:"I guess there is no user with those credentials",message_es:"Me temo que el usuario o la contrase\xF1a no son correctos."}// export const appLogin_ribbonField=[{"label_en": "Draft", "label_es": "Provisional",}];
...
//   },   
// };
};_exports.appLogin_authenticationMessage=appLogin_authenticationMessage});