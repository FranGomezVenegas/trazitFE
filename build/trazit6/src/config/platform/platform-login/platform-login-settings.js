define(["exports"], function (_exports) {
  ...
  _exports.appLogOut_logOutMessage = _exports.appLogin_formFields = _exports.appLogin_ribbon = _exports.appLogin_authenticationMessage = _exports.appLogin_logoOnTop = void 0;
  const appLogin_logoOnTop = {
    display: !0,
    url: "./images/header/trazit-removebg.png",
  };
  _exports.appLogin_logoOnTop = appLogin_logoOnTop;
  ...
  const appLogin_ribbon = {
    displayRibbon: !1,
    field: [{ label_en: "Draft", label_es: "Provisional" }],
  };
  _exports.appLogin_ribbon = appLogin_ribbon;
  const appLogin_formFields = [
    {
      name: "title",
      label_en: "Trace it !!!",
  ...
  _exports.appLogin_formFields = appLogin_formFields;
  const appLogOut_logOutMessage = {
    closedSession: {
      message_en: "Session closed",
      message_es: "Sesi\xF3n cerrada",
    },
  };
  _exports.appLogOut_logOutMessage = appLogOut_logOutMessage;
});
