define([
  ...
  "../../03config/Programs/em-demo-a-progtab-calendar-settings.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  ...
  _emDemoAProgtabCalendarSettings
) {
  "use strict";
  class EmDemoAProgConfigcalendar extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        ...
        progConfigCalendarTableHeaderFields: {
          type: Object,
          value:
            _emDemoAProgtabCalendarSettings.programProgConfigCalendar_progConfigCalendarTableHeaderFields,
        },
