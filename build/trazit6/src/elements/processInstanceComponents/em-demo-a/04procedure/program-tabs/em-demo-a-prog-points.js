define(["../../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../../store.js","../../../../internalComponents/Grids/vaadingrid-lit-singleselect.js","../../03config/Programs/em-demo-a-progtab-points-settings.js","../../01moduleFunctionality/endpoints-frontend-env-monit.js","../../01moduleFunctionality/em-demo-a-webcomponent-env-monit.js","../../01moduleFunctionality/functions-env-monit-samples.js","../dialogs/em-demo-a-simple-modal-dialog.js","../../../../../platform-mixins/functions/fields-methods.js"],function(_polymerElement,_connectMixin,_store,_vaadingridLitSingleselect,_emDemoAProgtabPointsSettings,_endpointsFrontendEnvMonit,_emDemoAWebcomponentEnvMonit,_functionsEnvMonitSamples,_emDemoASimpleModalDialog,_fieldsMethods){"use strict";// EmDemoAapiEnvMonit FrontendEnvMonit
class EmDemoAProgPoints extends(0,_fieldsMethods.FieldsMethods)((0,_functionsEnvMonitSamples.FunctionsEnvMonitSamples)((0,_endpointsFrontendEnvMonit.FrontendEndpointsEnvMonitForPrograms)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(state.emDemoA!=void 0&&state.emDemoA.selectedProgram.name!=void 0){//this.selectedProgram=state.emDemoA.selectedProgram; 
this.activeProductionLots=state.emDemoA.activeProductionLots}}static get properties(){return{tableDefinition:{type:Object,value:_emDemoAProgtabPointsSettings.progTabPoints},selectedObject:{type:Object,notify:!0},selectedProgram:{type:Object},selectedSamplingPoint:{type:Array},systemShifts:{type:Object,value:_emDemoAProgtabPointsSettings.shifts},productionLotsList:{type:Array,value:[{keyName:"rutina",keyValue_en:"routine",keyValue_es:"rutina"}]},activeProductionLots:{type:Array,value:[]}}}static get template(){return _polymerElement.html`
...
// }
createProductionLotsList(){console.log("createProductionLotsList","this.productionLotsList",this.productionLotsList);var i;for(i=0;i<this.activeProductionLots.length;i++){var newElement=[{keyName:"",keyValue_en:"",keyValue_es:""}];newElement.keyName=this.activeProductionLots[i].lot_name;newElement.keyValue_en=this.activeProductionLots[i].lot_name;newElement.keyValue_es=this.activeProductionLots[i].lot_name;this.productionLotsList[i+1]=newElement;//{keyName:"M1", :"M1", keyValue_es:"M1"},
}//console.log(this.productionLotsList);     
}pointClicked(e){if(!e.detail){return}this.createProductionLotsList();//console.log(this.selectedSamplingPoint, 'init');
...
for(i=0;i<selectedSamplingPoint.card_info.length;i++){newElement[i+3]=selectedSamplingPoint.card_info[i]}this.selectedSamplingPoint=newElement;this.$.pointCard.open()}refreshWindow(){}ready(){super.ready()}}customElements.define("em-demo-a-prog-points",EmDemoAProgPoints);// import '../../../../internalComponents/cards/card-form.js';
