define([
  ...
  "../../03config/Browser/em-demo-a-browser-sample-settings.js",
  ...
  _tablefield_labels,
  _emDemoABrowserSampleSettings,
  _configProcess
) {
  "use strict";
  class emDemoABrSample extends (0, _tablefield_labels.tableFieldLabel)(
    ...
    static get properties() {
      return {
        ...
        personTemplate: {
          type: String,
          value: _configProcess.personal_smp_template,
        },
        selectedLanguage: String,
        selSample: { type: Object },
        browserFields: {
          type: Object,
          value: _emDemoABrowserSampleSettings.browserSampleFields,
        },
        windowContent: {
          type: Array,
          value: _emDemoABrowserSampleSettings.windowContent,
        },
      };
    }
    static get template() {
    ...
    isTheCurrentStage(st) {
      ...
      if (
        st.current_stage == this.selSample.sampleFieldToRetrieve.current_stage
      )
        return !0;
      return !1;
    }
    ...
    openTab() {
      ...
      _store.store.dispatch(
        (0, _tabs_actions.setCurrentTabSelObject)(
          this.selSample.sampleFieldToRetrieve.sample_id
        )
      );
    }
  }
