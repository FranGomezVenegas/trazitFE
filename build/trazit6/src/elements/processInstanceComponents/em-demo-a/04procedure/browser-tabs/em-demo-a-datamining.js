define([
  ...
  "../../../../../platform-mixins/functions/utility-methods.js",
  ...
  "../../03config/em-demo-a-datamining-settings.js",
  "../../01moduleFunctionality/functions-env-monit.js",
  "../../01moduleFunctionality/endpoints-frontend-env-monit-saved-queries.js",
  ...
  _emDemoADataminingSettings,
  _functionsEnvMonit,
  _endpointsFrontendEnvMonitSavedQueries,
  _emDemoAWebcomponentEnvMonit
) {
  "use strict"; //import {setSelectedBatch} from '../../02Redux/em-demo-a_actions';
  //'../03config/config-process.js';
  class emDemoADatamining extends (0,
  _endpointsFrontendEnvMonitSavedQueries.FrontendEndpointsEnvMonitSavedQueries)(
    (0, _utilityMethods.UtilityMethods)(
      (0, _fieldsMethods.FieldsMethods)(
        (0, _functionsEnvMonit.FunctionsEnvMonit)(
          (0,
          _endpointsFrontendEnvMonitBrowser.FrontendEndpointsEnvMonitBrowser)(
    ...
    static get properties() {
      return {
        queryOutputDefinition: {
          type: Object,
          value: _emDemoADataminingSettings.queryOutputDefinition,
        },
        queries: { type: Object, value: _emDemoADataminingSettings.queries },
        myQueries: { type: Object },
        defaultChartType: {
          type: String,
          value: _emDemoADataminingSettings.defaultChartType,
        },
        queriesList: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _emDemoADataminingSettings.datamining_querySelectionForm,
        },
        buttonForm: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _emDemoADataminingSettings.datamining_queryButtonForm,
        },
        selectedQuery: { type: Object, notify: !0 },
        dataminingQueryOutput: { type: Array, notify: !0 },
    ...
    stateChanged(state) {
      if (null != state.emDemoA) {
        ...
        this.getChartDefinition(); //this.getCurChartData();
    ...
    buttonFormClicked(e) {
      ...
      if ("RUNQUERY" == e.currentTarget.name.toUpperCase()) {
        this.runQuery();
        return;
      }
      if ("LOADQUERY" == e.currentTarget.name.toUpperCase()) {
        this.loadQuery();
        return;
      }
      if ("CREATE_SAVED_QUERY" == e.currentTarget.name.toUpperCase()) {
        //e.detail.buttonDefinition field
        var buttonDefinition = { buttonDefinition: e.currentTarget.field },
          mye = { detail: buttonDefinition }; //.buttonDefinition:e.currentTarget.field};
    ...
    runQuery() {
      ...
      if (this.selectedQuery.definition_json != void 0) {
        this.selectedQuery = this.selectedQuery.definition_json;
      }
      for (
        var urlparams = "", i = 0;
        i < this.selectedQuery.arguments.length;
        i++
      ) {
        if (
          this.selectedQuery.arguments[i].value != void 0 &&
          0 < this.selectedQuery.arguments[i].value.length
        ) {
    ...
    getChartDefinition() {
      ...
      var groupsArgData = "",
        groupsArgDataArr = [];
      if (
        this.selectedQuery == void 0 ||
        this.selectedQuery.arguments == void 0
      ) {
        return;
      }
      ...
      for (var i = 0; i < groupsArgDataArr.length; i++) {
        ...
        if (2 < groupsArgDataArr[i].length) {
          if (0 < groupsArgDataArr[i][2].length) {
            chartType = groupsArgDataArr[i][2];
          }
        }
        var chartTitleEn = curChartName;
        if (3 < groupsArgDataArr[i].length) {
          if (0 < groupsArgDataArr[i][3].length) {
            chartTitleEn = groupsArgDataArr[i][3];
          }
        }
        var chartTitleEs = curChartName;
        if (4 < groupsArgDataArr[i].length) {
          if (0 < groupsArgDataArr[i][4].length) {
      ...
      if (-1 < this.valuePosicInArray(this.selectedQuery.arguments, "")) {
        found = !0;
        alert("wooooeeee");
        return;
