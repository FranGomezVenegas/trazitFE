define([
  ...
  "../../../../store.js",
  "../../../internalComponents/grid-components/vaadingrid-singleselect.js",
  "../01moduleFunctionality/env-monit-elements-sample.js",
  "./shared-styles.js",
  ...
  _connectMixin,
  _store,
  _vaadingridSingleselect,
  _envMonitElementsSample,
  _sharedStyles,
  _frontendEnvMonitSample,
  _configProcess
) {
  "use strict";
  class emDemoASampleCustodian extends (0,
  _frontendEnvMonitSample.FrontendEnvMonitSample)(
    ...
    static get properties() {
      return {
        ...
        cocSampleHistoryFieldToDisplay: {
          type: Array,
          value: _configProcess.sampleCustodian_cocSampleHistoryFieldToDisplay,
        },
        cocSampleHistoryWhereFieldsName: {
          type: String,
          value: _configProcess.sampleCustodian_cocSampleHistoryWhereFieldsName,
        },
        cocSampleHistoryWhereFieldsValue: {
          type: String,
          value:
            _configProcess.sampleCustodian_cocSampleHistoryWhereFieldsValue,
        },
        buttonsCustodian: {
          type: Array,
          value: _configProcess.sampleCustodian_cocSampleHistoryButtons,
        },
        sampleFieldToDisplayCustodian: {
          type: Array,
          value: _configProcess.sampleCustodian_sampleFieldToDisplayCustodian,
        },
        samplesWhereFieldsNameCustodian: {
          type: String,
          value: _configProcess.sampleCustodian_samplesWhereFieldsNameCustodian,
        },
        samplesWhereFieldsValueCustodian: {
          type: String,
          value:
            _configProcess.sampleCustodian_samplesWhereFieldsValueCustodian,
        },
        buttonsCustodian: {
          type: Array,
          value: _configProcess.sampleCustodian_buttonsCustodian,
        },
        sampleFieldToDisplayCandidate: {
          type: Array,
          value: _configProcess.sampleCustodian_sampleFieldToDisplayCandidate,
        },
        samplesWhereFieldsNameCandidate: {
          type: String,
          value: _configProcess.sampleCustodian_samplesWhereFieldsNameCandidate,
        },
        samplesWhereFieldsValueCandidate: {
          type: String,
          value:
            _configProcess.sampleCustodian_samplesWhereFieldsValueCandidate,
        },
        buttonsCandidate: {
          type: Array,
          value: _configProcess.sampleCustodian_buttonsCandidate,
        },
    ...
    onFinalTokenFilled() {
      ...
      this.getSamplesForResultsCustodian({
        ...
        sampleFieldToRetrieve:
          _configProcess.sampleCustodian_sampleFieldToRetrieveCustodian, //this.sampleFieldToRetrieve
        samplesTabSortFields:
          _configProcess.sampleCustodian_sampleFieldToSortCustodian, //this.samplesTabSortFields,
      ...
      this.getSamplesForResultsCandidate({
        ...
        actionName: "SAMPLES_INPROGRESS_LIST",
        sampleFieldToRetrieve:
          _configProcess.sampleCustodian_sampleFieldToRetrieveCandidate, //this.sampleFieldToRetrieve
        samplesTabSortFields:
          _configProcess.sampleCustodian_sampleFieldToSortCandidate, //this.samplesTabSortFields,
    ...
    stateChanged(state) {
      ...
      this.schemaPrefix = _configProcess.schema_name;
    }
    static get template() {
