define([
  ...
  "../03config/Programs/em-demo-a-programmainview-settings.js",
  "../01moduleFunctionality/endpoints-frontend-env-monit.js",
  "../02Redux/em-demo-a_actions.js",
  "./program-tabs/em-demo-a-prog-home.js",
  "./program-tabs/em-demo-a-prog-limits.js",
  "./program-tabs/em-demo-a-prog-points.js",
  "./program-tabs/em-demo-a-prog-points-map.js",
  "./program-tabs/em-demo-a-prog-corrective-actions.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  ...
  _fieldsMethods,
  _tabsFunctions,
  _emDemoAProgrammainviewSettings,
  ...
  _emDemoAProgCorrectiveActions
) {
  "use strict"; // import './program-tabs/em-demo-a-prog-configcalendar.js'; -> aqui esta el fallo del polymer-legacy
  class emDemoAPrograms extends (0, _fieldsMethods.FieldsMethods)(
    (0, _tabsFunctions.TabsMethods)(
      (0, _endpointsFrontendEnvMonit.FrontendEndpointsEnvMonitForProductionLot)(
    ...
    programSelected(e) {
      if ("programsList" == e.detail.name) {
        ...
        _store.store.dispatch(
          (0, _emDemoA_actions.setSelectedProgram)(
            this.programs[e.detail.index]
          )
        );
    ...
    static get properties() {
      return {
        ...
        programsList: {
          ...
          bubble: !0,
          value:
            _emDemoAProgrammainviewSettings.programMain_programSelectionForm,
        },
        tabs: {
          type: Object,
          value: _emDemoAProgrammainviewSettings.em_programs_tabs,
        },
        currentSubTab: {
          type: String,
          value: _emDemoAProgrammainviewSettings.programHome_defaultTab,
        },
        tabsDefinition: {
          type: Object,
          value: _emDemoAProgrammainviewSettings.tabsDefinition,
        },
      };
    }
    static get template() {
