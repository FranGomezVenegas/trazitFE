define([
  ...
  "../../03config/ResultDeviation/em-demo-a-pending-decision-settings.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  ...
  _emDemoAPendingDecisionSettings
) {
  ...
  class emDemoAPendingDecision extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value:
            _emDemoAPendingDecisionSettings.pendingDecisionWindowDefinition,
        },
