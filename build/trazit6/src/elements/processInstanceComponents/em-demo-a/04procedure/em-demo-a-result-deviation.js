define([
  ...
  "../03config/ResultDeviation/em-demo-a-resultdeviationmainview-settings.js",
  "../01moduleFunctionality/endpoints-frontend-env-monit.js",
  "../02Redux/em-demo-a_actions.js",
  "./deviation-tabs/em-demo-a-pending-decision.js",
  "./deviation-tabs/em-demo-a-investigation.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  ...
  _fieldsMethods,
  _tabsFunctions,
  _emDemoAResultdeviationmainviewSettings,
  _endpointsFrontendEnvMonit,
  _emDemoA_actions,
  _emDemoAPendingDecision,
  _emDemoAInvestigation
) {
  "use strict";
  class emDemoAResultDeviation extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        ...
        programsList: {
          ...
          bubble: !0,
          value:
            _emDemoAResultdeviationmainviewSettings.programMain_programSelectionForm,
        },
        tabs: {
          type: Object,
          value: _emDemoAResultdeviationmainviewSettings.em_deviation_tabs,
        },
        currentSubTab: {
          type: String,
          value: _emDemoAResultdeviationmainviewSettings.programHome_defaultTab,
        },
        tabsDefinition: {
          type: Object,
          value: _emDemoAResultdeviationmainviewSettings.tabsDefinition,
        },
      };
    }
    static get template() {
