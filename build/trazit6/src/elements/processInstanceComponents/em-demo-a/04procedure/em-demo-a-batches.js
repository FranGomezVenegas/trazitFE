define([
  ...
  "../03config/em-demo-a-batches-settings.js",
  ...
  //FrontendEnvMonit
  class emDemoABatches extends (0, _fieldsMethods.FieldsMethods)(
    (0, _functionsEnvMonit.FunctionsEnvMonit)(
      (0, _endpointsFrontendEnvMonit.FrontendEndpointsEnvMonitForBatches)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value: _emDemoABatchesSettings.incubActiveBatches,
        },
        selectedBatchEmpty: {
          type: Object,
          value: _emDemoABatchesSettings.selectedBatchEmpty,
        },
    ...
    batchSelected(e) {
      ...
      if (!e.detail) {
        var noBatch = [];
        _store.store.dispatch((0, _emDemoA_actions.setSelectedBatch)(noBatch));
        return;
      } //console.log('batchSelected', 'e.detail.value', e.detail.value);
      this.selectedBatch = e.detail;
      this.selectedObject = this.selectedBatch;
      _store.store.dispatch((0, _emDemoA_actions.setSelectedBatch)(e.detail));
      return;
    }
    refreshWindow() {
