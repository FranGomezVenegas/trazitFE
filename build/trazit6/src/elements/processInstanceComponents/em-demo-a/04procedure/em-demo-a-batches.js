define(["../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../store.js","../../../../platform-mixins/functions/fields-methods.js","../../../internalComponents/Grids/vaadingrid-lit-singleselect.js","../01moduleFunctionality/endpoints-frontend-env-monit.js","../03config/em-demo-a-batches-settings.js","../01moduleFunctionality/functions-env-monit.js","../01moduleFunctionality/em-demo-a-webcomponent-env-monit.js","../02Redux/em-demo-a_actions.js"],function(_polymerElement,_connectMixin,_store,_fieldsMethods,_vaadingridLitSingleselect,_endpointsFrontendEnvMonit,_emDemoABatchesSettings,_functionsEnvMonit,_emDemoAWebcomponentEnvMonit,_emDemoA_actions){"use strict";// import '../../../internalComponents/grid-components/vaadingrid-singleselectrunaction.js'; borrado por refactoring
...
//FrontendEnvMonit
class emDemoABatches extends(0,_fieldsMethods.FieldsMethods)((0,_functionsEnvMonit.FunctionsEnvMonit)((0,_endpointsFrontendEnvMonit.FrontendEndpointsEnvMonitForBatches)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))){static get properties(){return{tableDefinition:{type:Object,value:_emDemoABatchesSettings.incubActiveBatches},selectedBatchEmpty:{type:Object,value:_emDemoABatchesSettings.selectedBatchEmpty},allActiveBatches:{type:Array,notify:!0},selectedObject:Object,callBackRefreshWindow:Object,selectedLanguage:{type:String}}}stateChanged(state){if(null!=state.emDemoA){this.allActiveBatches=state.emDemoA.allActiveBatches}this.selectedLanguage=state.app.user.appLanguage}static get template(){return _polymerElement.html`            
        ...
        `}selectedBatchLabel(selectedBatch){var selIncub=selectedBatch.incubation_incubator;if(""==selIncub){if("es"==this.selectedLanguage)selIncub="Por favor selecciona incubadora!";else selIncub="Please select incubator!"}if("es"==this.selectedLanguage){return"La tanda seleccionada es: "+selectedBatch.name+". Incubadora: "+selIncub+". N\xFAm. Muestras: "+selectedBatch.NUM_SAMPLES}return"The selected batch is: "+selectedBatch.name+". Incubator: "+selIncub+". #Samples: "+selectedBatch.NUM_SAMPLES}batchSelected(e){//console.log('batchSelected', e.detail);
if(!e.detail){var noBatch=[];_store.store.dispatch((0,_emDemoA_actions.setSelectedBatch)(noBatch));return}//console.log('batchSelected', 'e.detail.value', e.detail.value);
this.selectedBatch=e.detail;this.selectedObject=this.selectedBatch;_store.store.dispatch((0,_emDemoA_actions.setSelectedBatch)(e.detail));return}refreshWindow(){this.loadSamplingTable()}loadSamplingTable(){this.callBackRefreshWindow=this.refreshWindow.bind(this);this.getActiveBatches();this.getAllIncubators()}ready(){super.ready();this.loadSamplingTable()}}customElements.define("em-demo-a-batches",emDemoABatches);// import {PolymerElement, html} from '@polymer/polymer/polymer-element';
