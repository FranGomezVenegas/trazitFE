define([
  ...
  "../../../../../store.js",
  "../../03config/Dialogs/em-demo-a-dialogmodal-buttons-settings.js",
  "../../../../../platform-mixins/functions/fields-methods.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  _emDemoADialogmodalButtonsSettings,
  _fieldsMethods
) {
  "use strict";
  /**
   ...
   * @demo
   *
   */ class EmDemoADialogmodalButtons extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        ...
        cancelDialogButton: {
          type: String,
          value: _emDemoADialogmodalButtonsSettings.cancelDialogButton,
        },
        confirmDialogButton: {
          type: String,
          value: _emDemoADialogmodalButtonsSettings.confirmDialogButton,
        },
        closeDialogButton: {
          type: String,
          value: _emDemoADialogmodalButtonsSettings.closeDialogButton,
        },
