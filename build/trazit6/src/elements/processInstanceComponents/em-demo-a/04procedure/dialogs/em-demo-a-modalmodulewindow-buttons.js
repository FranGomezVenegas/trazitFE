define([
   ...
   * @demo
   *
   */ class EmDemoAModalmodulewindowButtons extends (0,
  _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        ...
        cancelDialogButton: {
          type: String,
          value: _configProcess.cancelDialogButton,
        },
        confirmDialogButton: {
          type: String,
          value: _configProcess.confirmDialogButton,
        },
        closeDialogButton: {
          type: String,
          value: _configProcess.closeDialogButton,
        },
