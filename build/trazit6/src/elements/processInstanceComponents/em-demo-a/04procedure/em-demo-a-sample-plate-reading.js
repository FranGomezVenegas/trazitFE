define([
  ...
  "../03config/em-demo-a-sample-plate-reading-settings.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  ...
  _emDemoASamplePlateReadingSettings
) {
  ...
  class emDemoASamplePlateReading extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value: _emDemoASamplePlateReadingSettings.samplePlateReading,
        },
