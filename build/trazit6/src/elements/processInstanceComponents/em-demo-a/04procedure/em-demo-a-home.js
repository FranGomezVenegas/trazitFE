define([
  ...
  "../03config/em-demo-a-home-settings.js",
  ...
  _store,
  _chartController,
  _emDemoAHomeSettings,
  _fieldsMethods,
  _endpointsFrontendEnvMonitSamples,
  _emDemoAKpi
) {
  "use strict";
  class EmDemoAHome extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        windowDefinition: {
          type: Object,
          value: _emDemoAHomeSettings.windowDefinition,
        },
