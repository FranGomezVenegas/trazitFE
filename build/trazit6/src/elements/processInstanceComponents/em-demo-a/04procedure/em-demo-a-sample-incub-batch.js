define(["../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../store.js","../../../../platform-mixins/functions/fields-methods.js","../../../internalComponents/Grids/vaadingrid-lit-singleselect.js","../../../internalComponents/Grids/vaadin-grid-expand.js","../01moduleFunctionality/endpoints-frontend-env-monit-samples.js","../01moduleFunctionality/functions-env-monit-samples.js","../01moduleFunctionality/em-demo-a-webcomponent-env-monit-samples.js","./em-demo-a-batches.js","../03config/em-demo-a-sample-incub-batch-settings.js"],function(_polymerElement,_connectMixin,_store,_fieldsMethods,_vaadingridLitSingleselect,_vaadinGridExpand,_endpointsFrontendEnvMonitSamples,_functionsEnvMonitSamples,_emDemoAWebcomponentEnvMonitSamples,_emDemoABatches,_emDemoASampleIncubBatchSettings){"use strict";// import '../../../internalComponents/grid-components/vaadingrid-singleselectrunaction.js'; borrado por refactoring
//'../03config/config-process.js';
class emDemoASampleIncubBatch extends(0,_fieldsMethods.FieldsMethods)((0,_functionsEnvMonitSamples.FunctionsEnvMonitSamples)((0,_endpointsFrontendEnvMonitSamples.FrontendEndpointsEnvMonitSamples)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))){static get properties(){return{sampleIncubBatchScreenSettings:{type:Object,value:_emDemoASampleIncubBatchSettings.sampleIncubBatchScreenSettings},incub1TableDefinition:{type:Object,value:_emDemoASampleIncubBatchSettings.sampleIncubBatchPendingIncub1},incub2TableDefinition:{type:Object,value:_emDemoASampleIncubBatchSettings.sampleIncubBatchPendingIncub2},samplesStagesReduxVariables:{type:String,value:_endpointsFrontendEnvMonitSamples.samplesStagesReduxVariables},allSamplesStageIncubation1:{type:Array,notify:!0},allSamplesStageIncubation2:{type:Array,notify:!0},selectedObject:Object,callBackRefreshWindow:Object,selectedLanguage:{type:String}}}static get template(){return _polymerElement.html`     
