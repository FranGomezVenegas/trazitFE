define([
  ...
  "../../../internalComponents/Grids/vaadin-grid-expand.js",
  ...
  "./em-demo-a-batches.js",
  "../03config/em-demo-a-sample-incub-batch-settings.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  ...
  _emDemoABatches,
  _emDemoASampleIncubBatchSettings
) {
  ...
  class emDemoASampleIncubBatch extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        sampleIncubBatchScreenSettings: {
          type: Object,
          value:
            _emDemoASampleIncubBatchSettings.sampleIncubBatchScreenSettings,
        },
        incub1TableDefinition: {
          type: Object,
          value: _emDemoASampleIncubBatchSettings.sampleIncubBatchPendingIncub1,
        },
        incub2TableDefinition: {
          type: Object,
          value: _emDemoASampleIncubBatchSettings.sampleIncubBatchPendingIncub2,
        },
...
-->
  ...
  customElements.define(
    "em-demo-a-sample-incub-batch",
    emDemoASampleIncubBatch
