define([
  ...
  "../03config/em-demo-a-person-plate-reading-settings.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  ...
  _emDemoAPersonPlateReadingSettings
) {
  ...
  class emDemoAPersonPlateReading extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value: _emDemoAPersonPlateReadingSettings.personPlateReading,
        },
        samplesStagesReduxVariables: {
          type: String,
          value: _endpointsFrontendEnvMonitSamples.samplesStagesReduxVariables,
        },
        allPersonSamplesStagePlateReading: { type: Array, notify: !0 },
    ...
    loadSamplingTable() {
      ...
      this.getAllSamplesStageSampling(
        ...
        this.samplesStagesReduxVariables.PERSON_PLATE_READING
      ); //     {
    ...
    stateChanged(state) {
      ...
      if (null != state.emDemoA) {
        this.allPersonSamplesStagePlateReading =
          state.emDemoA.allPersonSamplesStagePlateReading;
      }
    }
    ready() {
      super.ready();
  ...
  customElements.define(
    "em-demo-a-person-plate-reading",
    emDemoAPersonPlateReading
  );
});
