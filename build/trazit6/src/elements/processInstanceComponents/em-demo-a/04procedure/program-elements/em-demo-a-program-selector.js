define([
   ...
   * @demo
   *
   */ class EmDemoAProgramSelector extends (0,
  _endpointsFrontendEnvMonit.FrontendEndpointsEnvMonitForPrograms)(
    ...
    programSelected(e) {
      if ("programsList" == e.detail.name) {
        ...
        this.selectedProgram = this.programs[e.detail.index]; //store.dispatch(setSelectedProgram(this.programs[e.detail.index]));
