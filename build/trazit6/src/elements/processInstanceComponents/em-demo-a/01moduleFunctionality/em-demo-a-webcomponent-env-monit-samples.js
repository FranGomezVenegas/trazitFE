define([
  ...
  "../04procedure/dialogs/em-demo-a-list-modal-sample-audit.js",
  "../04procedure/dialogs/em-demo-a-list-modal-enterresults.js",
  ...
  _emDemoAListModalSampleAudit,
  _emDemoAListModalEnterresults,
   ...
   * @demo
   *
   */ class EmDemoAWebcomponentEnvMonitSamples extends (0,
    ...
    static get properties() {
      return {
        ...
        fieldsDialogAddComment: {
          ...
          notify: !0,
          bubble: !0,
          value: _emDemoADialogmodalSettings.dialogAddComment,
        },
        microorgListHeader: {
          type: Array,
          value: _emDemoADialogmodalSettings.dialogMicroorgListTableHeader,
        },
        microorgListRows: { type: Array },
        dialogMicroorgListAdhocMicroorg: {
          type: Array,
          value: _emDemoADialogmodalSettings.dialogMicroorgListAdhocMicroorg,
        },
      };
    }
    stateChanged(state) {
