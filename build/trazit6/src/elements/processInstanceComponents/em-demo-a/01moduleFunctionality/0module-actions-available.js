define([
...
], function (_exports, _apiConfig) {
  "use strict";
  Object.defineProperty(_exports, "__esModule", { value: !0 });
  _exports.EnvMonitModuleDefinition = void 0;
  const EnvMonitModuleDefinition = (superClass) =>
      ...
      moduleDefinition() {
        return {
          ...
          functionalAreas: [
            {
              name: "SAMPLES",
              apiUrlForActions: _apiConfig.ApiEnvMonitSampleUrl,
            },
            { name: "PROGRAMS", apiUrlForActions: _apiConfig.ApiEnvMonitUrl },
            {
              name: "PRODUCTION_LOTS",
              apiUrlForActions: _apiConfig.ApiEnvMonitProdLotUrl,
            },
            {
              name: "INCUB_BATCH",
              apiUrlForActions: _apiConfig.ApiEnvMonitUrl,
            },
            {
              name: "INCUBATOR",
              apiUrlForActions: _apiConfig.ApiEnvMonitIncubationUrl,
            },
            {
              name: "INVESTIGATION",
              apiUrlForActions: _apiConfig.ApiInvestigationUrl,
            },
            {
              name: "SAVED_QUERIES",
              apiUrlForActions: _apiConfig.ApiSavedQueriesUrl,
            },
          ],
        };
      }
        ...
        return [
          ...
          },
          {
            ...
            dialogInfo: {
              requiresDialog: !0,
              webComponentName: "myelements",
              dialogName: "investigationDecision",
            },
            apiParams: [
              {
                paramName: "investigationId",
  ...
  _exports.EnvMonitModuleDefinition = EnvMonitModuleDefinition;
});
