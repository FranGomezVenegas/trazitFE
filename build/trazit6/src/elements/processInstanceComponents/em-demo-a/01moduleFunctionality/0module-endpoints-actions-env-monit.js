define(["exports","require","../../../../config/platform/logic/api-config.js","../../../../store.js","../../../../platform-mixins/apis/api-settings.js","../../../platformComponents/Redux/actions/notifications_actions.js","../../../../platform-mixins/platform-functions/notification-obj.js","../../../platformComponents/Redux/actions/esign-actions.js","../../../platformComponents/Redux/actions/confirmuser-actions.js","../03config/config-process.js","../../../../platform-mixins/store/token-mixin.js","../../../../platform-mixins/store/user-confirmation-mixin.js","../../../../platform-mixins/functions/toast-methods.js","./0module-actions-available.js"],function(_exports,_require,_apiConfig,_store,_apiSettings,_notifications_actions,_notificationObj,_esignActions,_confirmuserActions,_configProcess,_tokenMixin,_userConfirmationMixin,_toastMethods,_moduleActionsAvailable){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.EndpointsActionsEnvMonitModule=void 0;_require=babelHelpers.interopRequireWildcard(_require);//incubationMode
/**
 * @mixinFunction
 * @polymer
 */const EndpointsActionsEnvMonitModule=superClass=>class extends(0,_userConfirmationMixin.userConfirmationMixin)((0,_moduleActionsAvailable.EnvMonitModuleDefinition)((0,_apiSettings.ApiSettings)((0,_toastMethods.ToastMethods)((0,_tokenMixin.tokenMixin)(superClass))))){moduleActionTrigger(buttonDefinition,backEndData,moduleAreaName){var moduleArea=this.getFunctionalArea(moduleAreaName);if(moduleArea==void 0){this.toastErrorMessage(this.moduleAreaNotRecognized(moduleAreaName));console.log("module area not recognized");return}//    console.log('moduleActionTrigger', 'buttonDefinition', buttonDefinition, 'backEndData', backEndData);
...
this.getGivenSampleAnalysisList(datas);this.$.givenSampleAnalysisList.open();break;case"TESTASSIGNMENT":console.log("env-monit-elements-sample > TestAssignment");new Promise((res,rej)=>_require.default(["../04-procedure/dialogs/em-demo-a-list-modal-coc-users.js"],res,rej));this.cocUsersListFieldToDisplay=sampleCustodian_cocUsersListFieldToDisplay;var actionName="TESTASSIGNMENT",paramsUrl="actionName="+actionName+"&fieldToRetrieve="+this.cocUsersListFieldToDisplay;datas.actionName=actionName;datas.fieldToRetrieve=sampleCustodian_cocUsersListFieldToRetrieve;datas.paramsUrl=paramsUrl;//datas.callBackFunction=this.openAddSampleAnalysisDialog.bind(this);
this.getGivenCocUsersList(datas);//console.log('ChangeOfCustodyHistory >> this.cocUsersList', this.cocUsersList, 'this.cocUsersListFieldToDisplay', this.cocUsersListFieldToDisplay);
this.$.chainOfCustodyStartChange.open();break;case"ADDMICROORGANISM":new Promise((res,rej)=>_require.default(["../04-procedure/dialogs/em-demo-a-list-modal-microorganism.js"],res,rej));this.microorganismListToDisplay=this.microorganismListToDisplay;var actionName="GET_MICROORGANISM_LIST",paramsUrl="actionName="+actionName+"&fieldToRetrieve="+this.microorganismListToDisplay;datas.actionName=actionName;datas.fieldToRetrieve=this.microorganismListToDisplay;datas.paramsUrl=paramsUrl;//datas.callBackFunction=this.openAddSampleAnalysisDialog.bind(this);
...
break;case"SAMPLE_AUDIT":new Promise((res,rej)=>_require.default(["../04-procedure/dialogs/em-demo-a-list-modal-sample-auditOrig.js"],res,rej));this.sampleAudit_fieldsToRetrieve=sampleAudit_fieldsToRetrieve;var actionName="GET_SAMPLE_AUDIT",paramsUrl="actionName="+actionName+"&sampleAuditFieldToRetrieve="+this.sampleAudit_fieldsToRetrieve;datas.actionName=actionName;datas.sampleAuditFieldToRetrieve=this.sampleAudit_fieldsToRetrieve;datas.paramsUrl=paramsUrl;//datas.callBackFunction=this.openAddSampleAnalysisDialog.bind(this);
...
this.sampleAPIEndpointCall(datas,button,moduleArea,callBackFunction,callBackFunctionError,refreshFunction)}sampleAPIEndpointCall(data,button,moduleArea,callBackFunction,callBackFunctionError,refreshFunction){var endpoints_returningError=this.endpoints_returningError(),apiUrl=_apiConfig.backendUrl+moduleArea.apiUrlForActions+"?"+data.paramsUrl;apiUrl=apiUrl+"&finalToken="+this.getFinalToken()+"&schemaPrefix="+_configProcess.schema_name;//console.log('process-us>api-sample>sampleAPIEndpointCall', data.schemaPrefix, data.actionName, apiUrl, data.paramsUrl);    
if(button&&button.esign_required){var ePhrase=this.getEsignPhrase();apiUrl=apiUrl+"&esignPhraseToCheck="+ePhrase}if(button&&button.confirmuser_required){var userPhrase=this.getUserPhrase(),userPwPhrase=this.getUserPwPhrase();apiUrl=apiUrl+"&userToCheck="+userPhrase;apiUrl=apiUrl+"&passwordToCheck="+userPwPhrase}axios.get(apiUrl).then(response=>{console.log("em-demo-a > api-env-monit.js > sampleAPIEndpointCall","response.data",response.data);var notifObj=(0,_notificationObj.diagnosticToNotification)(response.data,data);_store.store.dispatch((0,_notifications_actions.addNotification)(notifObj));if(200==response.status){//console.log('callBackFunction');
this.toastSuccessMessage(response.data);if(callBackFunction){callBackFunction()}if(refreshFunction){refreshFunction()}return}this.toastErrorMessage(response.data);if(callBackFunctionError){callBackFunctionError()}if(refreshFunction){refreshFunction()}return}).catch(function(error){this.toastErrorMessageWithApiResponse(endpoints_returningError.response_error,error);console.log(error.message);if(data.callBackFunctionError){data.callBackFunctionError()}}).then(function(){})}moduleActionRequiresTriggerFunction(buttonName,buttonDefinition,selectedObject,moduleArea,actionDefinition,callBackFunction,callBackFunctionError,refreshWindowMethod){this.REDUX_GET_INCUBBATCH(buttonName,buttonDefinition,selectedObject,moduleArea,actionDefinition,callBackFunction,callBackFunctionError,refreshWindowMethod)}REDUX_GET_INCUBBATCH(buttonName,buttonDefinition,selectedObject,moduleArea,actionDefinition,callBackFunction,callBackFunctionError,refreshWindowMethod){var state=_store.store.getState(),selectedBatch=state.emDemoA.selectedBatch;selectedObject.batchName=selectedBatch.name;selectedObject.batchtemplateId=selectedBatch.incub_batch_config_id;selectedObject.batchtemplateVersion=selectedBatch.incub_batch_config_version;this.moduleActionTriggerAPI(buttonName,buttonDefinition,selectedObject,moduleArea,actionDefinition,callBackFunction,callBackFunctionError,refreshWindowMethod)}};_exports.EndpointsActionsEnvMonitModule=EndpointsActionsEnvMonitModule});