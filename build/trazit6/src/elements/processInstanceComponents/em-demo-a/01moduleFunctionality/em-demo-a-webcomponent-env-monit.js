define([
  ...
  "../04procedure/dialogs/em-demo-a-simple-modal-dialog.js",
  "../03config/Dialogs/em-demo-a-dialogmodal-settings.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
   ...
   * @demo
   *
   */ class EmDemoAWebcomponentEnvMonit extends (0,
    ...
    static get properties() {
      return {
        ...
        dialogProductionLotNew: {
          ...
          notify: !0,
          bubble: !0,
          value: _emDemoADialogmodalSettings.dialogProductionLotNew,
        },
        dialogProductionLotActivate: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _emDemoADialogmodalSettings.dialogProductionLotActivate,
        },
        dialogincubBatchNew: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _emDemoADialogmodalSettings.dialogincubBatchNew,
        },
        dialogincubAddTmpReading: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _emDemoADialogmodalSettings.dialogincubAddTmpReading,
        },
        activeIncubatorsListHeader: {
          type: Array,
          value: _emDemoADialogmodalSettings.dialogIncubatorsListTableHeader,
        },
        activeIncubatorsListRows: { type: Array },
        openInvestigationsListHeader: {
          type: Array,
          value:
            _emDemoADialogmodalSettings.dialogInvestigationsListTableHeader,
        },
        ...
        dialogInvestDecision: {
          ...
          notify: !0,
          bubble: !0,
          value: _emDemoADialogmodalSettings.dialogInvestDecision,
        },
      };
    }
    stateChanged(state) {
