define(["exports"], function (_exports) {
  ...
  _exports.iconsMethods = void 0;
  const iconsMethods = (superClass) =>
    class extends superClass {
      getIconPath(field, item) {
        ...
        if ("spec_eval" == field.name) {
          return this.resultSpecEval(field, item);
        }
        return "";
      }
      resultSpecEval(field, item) {
        console.log("resultSpecEval", "item", item, "field", field);
        return "../03config/icons/result/spec_eval/" + field.spec_eval + "gif"; //if (field.spec_eval=="OUT_SPEC_MAX"){}
      }
    };
