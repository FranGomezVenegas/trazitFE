   ...
   */ const FrontendEndpointsEnvMonitBrowser = (superClass) =>
    class extends (0, _apiSettings.ApiSettings)(
        ...
        axios
          ...
          .then((response) => {
            if (200 == response.status) {
              //console.log(response.data);
              _store.store.dispatch(
                (0, _emDemoA_actions.getBrowserIncubatorData)(response.data)
              );
              if (data && data.callBackFunction) {
                data.callBackFunction();
              }
        ...
        axios
          ...
          .then((response) => {
            if (200 == response.status) {
              //console.log(response.data);
              _store.store.dispatch(
                (0, _emDemoA_actions.getBrowserBatchData)(response.data)
              );
              if (data && data.callBackFunction) {
                data.callBackFunction();
              }
        ...
        axios
          ...
          .then((response) => {
            if (200 == response.status) {
              //console.log(response.data);
              _store.store.dispatch(
                (0, _emDemoA_actions.getBrowserProdLotData)(response.data)
              );
              if (data && data.callBackFunction) {
                data.callBackFunction();
              }
      ...
      getDataMiningQueryOutput(data, url) {
        var apiUrl =
          _apiConfig.backendUrl + _apiConfig.ApiEnvMonitStatsUrl + "?" + url; //console.log('getGivenSampleAnalysisResultEntry', apiUrl, data);
        if (!this.getFinalToken()) {
          return;
        }
        if (!_configProcess.schema_name) {
        ...
        axios
          ...
          .then((response) => {
            if (200 == response.status) {
              //console.log(response.data);
              _store.store.dispatch(
                (0, _emDemoA_actions.setDataMiningQueryOutput)(response.data)
              );
              if (data && data.callBackFunction) {
                data.callBackFunction();
              }
