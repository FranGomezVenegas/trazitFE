...
{name:"addSampleAnalysis",label_en:"Add Analysis",label_es:"A\xF1adir An\xE1lisis",type:"zicon-button",icon_name:"icons:add-box",icon_color:"aqua",confirmuser_required:!1,esign_required:!1,read_only:!1},{name:"givenSampleEnterResult",label_en:"Enter Result",label_es:"Entrar Resultado",type:"icon-button",icon_name:"icons:receipt",read_only:!1}]};_exports.samplePlateReading=samplePlateReading;const documentContainerEmDemoASamplePlateReadingStyle=document.createElement("em-demo-a-sample-plate-reading-style");documentContainerEmDemoASamplePlateReadingStyle.setAttribute("style","display: none;");documentContainerEmDemoASamplePlateReadingStyle.innerHTML=`
  ...
  </dom-module>`;document.head.appendChild(documentContainerEmDemoASamplePlateReadingStyle)});