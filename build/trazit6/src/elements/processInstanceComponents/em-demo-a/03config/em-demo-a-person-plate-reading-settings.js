define(["exports", "./config-process.js"], function (_exports, _configProcess) {
  ...
  _exports.personPlateReading = void 0;
  const personPlateReading = {
    ...
    samplesWhereFieldsValue:
      "PlateReading|" + _configProcess.personal_smp_template,
    addSampleAnalysis: !0,
  ...
  _exports.personPlateReading = personPlateReading;
