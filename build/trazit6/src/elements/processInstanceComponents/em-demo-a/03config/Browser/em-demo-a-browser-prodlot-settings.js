define(["exports", "../config-process.js"], function (
  ...
  _exports.browserProdLotFields = _exports.windowContent = void 0;
  const windowContent = {
    fields: [
      {
        name: "lotName",
        label_en: "Production Lot",
        label_es: "Lote de Producci\xF3n",
        type: "text",
        password: "false",
        value: "lote4",
        read_only: !1,
