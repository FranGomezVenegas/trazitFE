define(["exports", "../config-process.js"], function (
  ...
  _exports.browserHome_defaultTab = _exports.em_browser_tabs = void 0;
  const em_browser_tabs = [
    {
      ...
      name: "datamining",
      tabName: _configProcess.schema_name + "-datamining",
      tabIndex: 1,
    },
    {
      procedure: _configProcess.schema_name,
      ...
      tabLabel_es: "Muestra",
      name: "sample",
      tabName: _configProcess.schema_name + "-br-sample",
      tabIndex: 1,
    },
    {
      procedure: _configProcess.schema_name,
      ...
      name: "incubator",
      tabName: _configProcess.schema_name + "-br-incubator",
      tabIndex: 1,
    },
    {
      procedure: _configProcess.schema_name,
      ...
      tabLabel_es: "Tanda",
      name: "batch",
      tabName: _configProcess.schema_name + "-br-batch",
      tabIndex: 1,
    },
    {
      procedure: _configProcess.schema_name,
      ...
      name: "prodlot",
      tabName: _configProcess.schema_name + "-br-prodlot",
      tabIndex: 1,
    },
  ];
  _exports.em_browser_tabs = em_browser_tabs;
  const browserHome_defaultTab = "datamining";
  _exports.browserHome_defaultTab = browserHome_defaultTab;
