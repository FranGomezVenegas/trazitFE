define(["exports"], function (_exports) {
  ...
  _exports.sampleIncubation_incubBatch_newBatchFormFields = _exports.selectedBatchEmpty = _exports.incubActiveBatches = void 0; // export const programHome_sampleSummaryGaugeOptions={"width": 400, "height": 120, "redFrom": 90, "redTo": 100, "yellowFrom":75,
  //                                                     "yellowTo": 90, "minorTicks": 5};
  // export const programHome_sampleSummaryPieOptions={"title": "Samples Progress"};
  const incubActiveBatches = {
    fieldToDisplay: [
      {
        name: "name",
        label_en: "Name",
    ...
    buttons: [
      ...
      },
      {
        ...
        label_es: "Borrar Tanda",
        type: "button",
        icon_name: "icons:assignment-return",
        requires_selected_object: !0,
        read_only: !1,
      },
      {
      ...
      },
      {
        ...
        label_en: "Start Incubation",
        label_es: "Empezar incubaci\xF3n",
        type: "button",
        icon_name: "icons:assignment-return",
        read_only: !1,
      },
      {
        ...
        label_es: "Terminar incubaci\xF3n",
        type: "button",
        icon_name: "icons:assignment-return",
        read_only: !1,
      },
  ...
  _exports.incubActiveBatches = incubActiveBatches;
  const selectedBatchEmpty = {
    label_en: "No Batch selected",
    label_es: "Seleccione una tanda",
    icon_name: "vaadin:chevron-circle-up",
  };
  _exports.selectedBatchEmpty = selectedBatchEmpty;
  const sampleIncubation_incubBatch_newBatchFormFields = [
    {
  ...
  _exports.sampleIncubation_incubBatch_newBatchFormFields = sampleIncubation_incubBatch_newBatchFormFields;
  const documentContainerEmDemoABatchesStyle = document.createElement(
    "em-demo-a-batches-style"
  );
