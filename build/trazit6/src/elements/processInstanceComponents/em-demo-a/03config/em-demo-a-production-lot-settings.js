define(["exports", "./config-process.js"], function (_exports, _configProcess) {
  ...
  const productionLot = {
    ...
    sampleFieldToDisplay: [
      ...
      },
      {
        ...
        width: "20%",
        sort: !0,
        filter: !1, //, {name: 'created_by', label_en:'Created By', label_es: 'Creador', width:'5%', sort:false, filter:true}
  ...
  _exports.productionLot = productionLot;
  const documentContainerEmDemoAProductionLotStyle = document.createElement(
    "em-demo-a-production-lot-style"
  );
  documentContainerEmDemoAProductionLotStyle.setAttribute(
    "style",
    "display: none;"
  );
