define(["exports"], function (_exports) {
  ...
  const documentContainerEmDemoAProgtabCorrectiveActionsStyle = document.createElement(
    "em-demo-a-progtab-points-style"
  );
  documentContainerEmDemoAProgtabCorrectiveActionsStyle.setAttribute(
    "style",
    "display: none;"
  );
  ...
  document.head.appendChild(
    documentContainerEmDemoAProgtabCorrectiveActionsStyle
  );
});
