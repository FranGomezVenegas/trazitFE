define(["exports", "../config-process.js"], function (
  ...
  _exports.programMain_programSelectionForm = _exports.tabsDefinition = _exports.em_programs_tabs = _exports.shifts = _exports.programHome_defaultTab = void 0;
  const programHome_defaultTab = _configProcess.schema_name + "-home";
  ...
  const em_programs_tabs = [
    {
      ...
      tabLabel_en: "Home",
      tabLabel_es: "Inicio",
      tabName: _configProcess.schema_name + "-home",
      tabIndex: 1,
    },
    {
      procedure: _configProcess.schema_name,
      ...
      tabName: _configProcess.schema_name + "-config-calendar",
      tabIndex: 1,
    },
    {
      procedure: _configProcess.schema_name,
      ...
      tabName: _configProcess.schema_name + "-limits",
      tabIndex: 1,
    },
    {
      procedure: _configProcess.schema_name,
      ...
      tabName: _configProcess.schema_name + "-sampling-points",
      tabIndex: 0,
    },
    {
      procedure: _configProcess.schema_name,
      ...
      tabName: _configProcess.schema_name + "-sampling-points-map",
      tabIndex: 0,
    },
    {
      procedure: _configProcess.schema_name,
      ...
      tabName: _configProcess.schema_name + "-corrective-actions",
      tabIndex: 0,
    },
  ];
  _exports.em_programs_tabs = em_programs_tabs;
