define(["exports","./em-demo-a-programmainview-settings.js"],function(_exports,_emDemoAProgrammainviewSettings){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.programProgConfigCalendar_progConfigCalendarTableHeaderFields=void 0;//import {personal_smp_template} from './config-process';
const programProgConfigCalendar_progConfigCalendarTableHeaderFields=[{name:"date",label_en:"Date",label_es:"Fecha",sort:!1,filter:!0,is_icon:!0,width:"20%"},{name:"area",label_en:"Area",label_es:"Area",sort:!1,filter:!0,is_icon:!0,width:"20%"},{name:"location_name",label_en:"Location",label_es:"Ubicaci\xF3n",sort:!1,filter:!0,width:"20%"//, {name: 'spec_code', label_en:'Spec', label_es: 'Especificación', sort:false, filter:true, width:"20%"}
},{name:"spec_variation_name",label_en:"Variation",label_es:"Variaci\xF3n",sort:!1,filter:!0,width:"20%"},{name:"spec_analysis_variation",label_en:"Analysis Variation",label_es:"An\xE1lisis de Variaci\xF3n",sort:!1,filter:!0,width:"20%"}];_exports.programProgConfigCalendar_progConfigCalendarTableHeaderFields=programProgConfigCalendar_progConfigCalendarTableHeaderFields;// export const progTabPoints={
...
//     ]    
//   };
const documentContainerEmDemoAProgtabCalendarStyle=document.createElement("em-demo-a-progtab-calendar-style");documentContainerEmDemoAProgtabCalendarStyle.setAttribute("style","display: none;");documentContainerEmDemoAProgtabCalendarStyle.innerHTML=`
  ...
  </dom-module>`;document.head.appendChild(documentContainerEmDemoAProgtabCalendarStyle)});