define(["exports", "./config-process.js"], function (_exports, _configProcess) {
  ...
  _exports.personSampling = void 0;
  const personSampling = {
  ...
  _exports.personSampling = personSampling;
  const documentContainerEmDemoAPersonSamplingStyle = document.createElement(
    "em-demo-a-person-sampling-style"
  );
  documentContainerEmDemoAPersonSamplingStyle.setAttribute(
    "style",
    "display: none;"
  );
