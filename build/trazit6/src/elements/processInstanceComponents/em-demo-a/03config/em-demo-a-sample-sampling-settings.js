define(["exports", "./config-process.js"], function (_exports, _configProcess) {
  ...
  _exports.sampleSampling = void 0;
  const sampleSampling = {
    ...
    samplesWhereFieldsValue: "Sampling|" + _configProcess.personal_smp_template,
  ...
  _exports.sampleSampling = sampleSampling;
  const documentContainerEmDemoASampleSamplingStyle = document.createElement(
    "em-demo-a-sample-sampling-style"
  );
  documentContainerEmDemoASampleSamplingStyle.setAttribute(
    "style",
    "display: none;"
  );
  documentContainerEmDemoASampleSamplingStyle.innerHTML = `
  ...
  document.head.appendChild(documentContainerEmDemoASampleSamplingStyle);
});
