define(["exports"], function (_exports) {
  ...
  _exports.closeDialogButton = _exports.confirmDialogButton = _exports.cancelDialogButton = _exports.dialog_buttons = _exports.dialogMicroorgListAdhocMicroorg = _exports.dialogMicroorgListTableHeader = _exports.dialogInvestigationsListTableHeader = _exports.dialogIncubatorsListTableHeader = _exports.dialogInvestDecision = _exports.dialogincubAddTmpReading = _exports.dialogincubBatchNew = _exports.dialogProductionLotActivate = _exports.dialogProductionLotNew = _exports.dialogAddComment = void 0;
  ...
  const dialogProductionLotNew = [
    {
      name: "migroorganism_freetext",
      label_en: "New Production Lot Name",
      label_es: "Nombre para nuevo lote de producci\xF3n",
      type: "text",
      password: "false",
      value: "",
      read_only: !1,
  ...
  _exports.dialogProductionLotNew = dialogProductionLotNew;
  const dialogProductionLotActivate = [
    {
      name: "migroorganism_freetext",
      label_en: "Production Lot Name to reactivate",
      label_es: "Nombre para el lote de producci\xF3n a reactivar",
      type: "text",
      password: "false",
      value: "",
      read_only: !1,
  ...
  _exports.dialogProductionLotActivate = dialogProductionLotActivate;
  const dialogincubBatchNew = [
    {
      name: "migroorganism_freetext",
  ...
  _exports.dialogincubBatchNew = dialogincubBatchNew;
  const dialogincubAddTmpReading = [
    {
  ...
  _exports.dialogincubAddTmpReading = dialogincubAddTmpReading;
  const dialogInvestDecision = [
    {
  ...
  _exports.dialogInvestDecision = dialogInvestDecision;
  const dialogIncubatorsListTableHeader = [
    {
      name: "name",
      label_en: "Name",
      label_es: "Nombre",
  ...
  _exports.dialogIncubatorsListTableHeader = dialogIncubatorsListTableHeader;
  const dialogInvestigationsListTableHeader = [
    { name: "id", label_en: "Id", label_es: "Id", sort: !0, filter: !1 },
    {
      name: "created_on",
      label_en: "Creation",
  ...
  _exports.dialogInvestigationsListTableHeader = dialogInvestigationsListTableHeader;
  const dialogMicroorgListTableHeader = [
    {
      name: "name",
      label_en: "Name",
      label_es: "Nombre",
  ...
  _exports.dialogMicroorgListTableHeader = dialogMicroorgListTableHeader;
  const dialogMicroorgListAdhocMicroorg = [
    {
      name: "adhoc_name",
  ...
  _exports.dialogMicroorgListAdhocMicroorg = dialogMicroorgListAdhocMicroorg;
