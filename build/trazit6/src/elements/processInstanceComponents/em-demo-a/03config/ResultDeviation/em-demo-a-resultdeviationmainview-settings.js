define(["exports","../config-process.js"],function(_exports,_configProcess){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.programMain_programSelectionForm=_exports.tabsDefinition=_exports.em_deviation_tabs=_exports.shifts=_exports.programHome_defaultTab=void 0;const programHome_defaultTab=_configProcess.schema_name+"-pending-decision";_exports.programHome_defaultTab=programHome_defaultTab;const shifts=[{keyName:"M1",keyValue_en:"M1",keyValue_es:"M1"},{keyName:"M2",keyValue_en:"M2",keyValue_es:"M2"}];_exports.shifts=shifts;const em_deviation_tabs=[{procedure:_configProcess.schema_name,tabConfirmUserRequired:!1,tabEsignRequired:!1,tabLabel_en:"Pending Decision",tabLabel_es:"Decisi\xF3n pendiente",tabName:_configProcess.schema_name+"-pending-decision",tabIndex:1},{procedure:_configProcess.schema_name,tabConfirmUserRequired:!1,tabEsignRequired:!1,tabLabel_en:"Investigations",tabLabel_es:"Investigaciones",tabName:_configProcess.schema_name+"-investigation",tabIndex:1}];_exports.em_deviation_tabs=em_deviation_tabs;const tabsDefinition={configCalendar:{displayCalendar:!0,displayTable:!0}};_exports.tabsDefinition=tabsDefinition;const programMain_programSelectionForm=[{name:"programsList",label_en:"Programs",label_es:"Programas",type:"list",value:"",read_only:!1,items:[{keyName:"",keyValue_en:"",keyValue_es:""}]}];// export const incubActiveBatches={
//   fieldToDisplay:[
...
//     }, 
//   ];
_exports.programMain_programSelectionForm=programMain_programSelectionForm;const documentContainerEmDemoAProgrammainviewStyle=document.createElement("em-demo-a-programmainview-style");documentContainerEmDemoAProgrammainviewStyle.setAttribute("style","display: none;");documentContainerEmDemoAProgrammainviewStyle.innerHTML=`
  ...
  </dom-module>`;document.head.appendChild(documentContainerEmDemoAProgrammainviewStyle)});