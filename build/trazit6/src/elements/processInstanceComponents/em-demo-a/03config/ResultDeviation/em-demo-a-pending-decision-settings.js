define(["exports", "../config-process.js"], function (
  ...
  _exports.pendingDecisionWindowDefinition = void 0;
  const pendingDecisionWindowDefinition = {
    fieldToDisplay: [
      ,
      {
        name: "result_id",
  ...
  _exports.pendingDecisionWindowDefinition = pendingDecisionWindowDefinition;
