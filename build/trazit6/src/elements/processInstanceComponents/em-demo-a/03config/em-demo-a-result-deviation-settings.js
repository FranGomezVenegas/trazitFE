define(["exports", "./config-process.js"], function (_exports, _configProcess) {
  ...
  _exports.sampleMicroorganism = void 0;
  const sampleMicroorganism = {
    ...
    tableTitle: {
      ...
      label: {
        ...
        label_es:
          "Muestras pendientes de la identificaci\xF3n de microorganismos",
      },
    },
    displayButtons: !0,
    buttons: [
  ...
  _exports.sampleMicroorganism = sampleMicroorganism;
  const documentContainerEmDemoASampleMicroorganism = document.createElement(
    "em-demo-a-sample-microorganism-style"
  );
