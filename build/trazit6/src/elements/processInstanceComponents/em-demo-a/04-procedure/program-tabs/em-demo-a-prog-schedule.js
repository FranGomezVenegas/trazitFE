define(["../../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../../store.js","../../../../internalComponents/Grids/vaadingrid-lit-singleselect.js","../../03config/Programs/em-demo-a-progtab-points-settings.js","../../01moduleFunctionality/endpoints-frontend-env-monit.js","../../01moduleFunctionality/em-demo-a-webcomponent-env-monit.js","../../01moduleFunctionality/functions-env-monit-samples.js","../dialogs/em-demo-a-simple-modal-dialog.js"],function(_polymerElement,_connectMixin,_store,_vaadingridLitSingleselect,_emDemoAProgtabPointsSettings,_endpointsFrontendEnvMonit,_emDemoAWebcomponentEnvMonit,_functionsEnvMonitSamples,_emDemoASimpleModalDialog){"use strict";//FieldsMethods EmDemoAapiEnvMonit FrontendEnvMonit
class EmDemoAProgSchedule extends(0,_functionsEnvMonitSamples.FunctionsEnvMonitSamples)((0,_endpointsFrontendEnvMonit.FrontendEndpointsEnvMonitForPrograms)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement))){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(state.emDemoA!=void 0&&state.emDemoA.selectedProgram.name!=void 0){//this.selectedProgram=state.emDemoA.selectedProgram; 
...
for(i=0;i<selectedSamplingPoint.card_info.length;i++){newElement[i+3]=selectedSamplingPoint.card_info[i]}this.selectedSamplingPoint=newElement;this.$.pointCard.open()}refreshWindow(){}ready(){super.ready()}}customElements.define("em-demo-a-prog-schedule",EmDemoAProgSchedule);// import '../../../../internalComponents/cards/card-form.js';
