...
class EmDemoAProgPoints extends(0,_functionsEnvMonitSamples.FunctionsEnvMonitSamples)((0,_endpointsFrontendEnvMonit.FrontendEndpointsEnvMonitForPrograms)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement))){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(state.emDemoA!=void 0&&state.emDemoA.selectedProgram.name!=void 0){//this.selectedProgram=state.emDemoA.selectedProgram; 
