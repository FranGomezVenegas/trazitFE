define(["../../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../../store.js","../../01moduleFunctionality/endpoints-frontend-env-monit-browser.js","../../03config/tablefield_labels.js","../../01moduleFunctionality/em-demo-a-webcomponent-env-monit.js","../../../../../platform-mixins/functions/fields-methods.js","../../03config/Browser/em-demo-a-browser-prodlot-settings.js","../../../../internalComponents/Charts/chart-controller.js"],function(_polymerElement,_connectMixin,_store,_endpointsFrontendEnvMonitBrowser,_tablefield_labels,_emDemoAWebcomponentEnvMonit,_fieldsMethods,_emDemoABrowserProdlotSettings,_chartController){"use strict";class emDemoABrProdlot extends(0,_tablefield_labels.tableFieldLabel)((0,_endpointsFrontendEnvMonitBrowser.FrontendEndpointsEnvMonitBrowser)((0,_fieldsMethods.FieldsMethods)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(null!=state.emDemoA){if(state.emDemoA.browserSelectedProdLot){this.selProdLot=state.emDemoA.browserSelectedProdLot;//console.log('this.selProdLot', this.selProdLot);
}}}static get properties(){return{windowContent:{type:Array,notify:!0,value:_emDemoABrowserProdlotSettings.windowContent},browserProdLotFields:{type:Object,notify:!0,value:_emDemoABrowserProdlotSettings.browserProdLotFields},displayChart:Boolean,selectedLanguage:String,selProdLot:{type:Object,notify:!0},selCharts:{type:Array},selProdLotLastNtempReadings:{type:Array}}}static get template(){return _polymerElement.html`
