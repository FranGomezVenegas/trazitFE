...
class emDemoABatches extends(0,_fieldsMethods.FieldsMethods)((0,_functionsEnvMonit.FunctionsEnvMonit)((0,_endpointsFrontendEnvMonit.FrontendEndpointsEnvMonitForBatches)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))){static get properties(){return{tableDefinition:{type:Object,value:_emDemoABatchesSettings.incubActiveBatches},selectedBatchEmpty:{type:Object,value:_emDemoABatchesSettings.selectedBatchEmpty},allActiveBatches:{type:Array,notify:!0},selectedObject:Object,callBackRefreshWindow:Object}}stateChanged(state){if(null!=state.emDemoA){this.allActiveBatches=state.emDemoA.allActiveBatches}}static get template(){return _polymerElement.html`            
            ...
            <div class="main">
                ...
                <vaadingrid-lit-singleselect id="emdemoa-samplesampling" headerfields="{{tableDefinition.fieldToDisplay}}" 
                    rowcontainer="{{allActiveBatches}}" selected-object="{{selectedObject}}" on-selected-object-changed="batchSelected">
        ...
        `}batchSelected(e){//console.log('batchSelected', e.detail);
...
this.selectedBatch=e.detail;_store.store.dispatch((0,_emDemoA_actions.setSelectedBatch)(e.detail));return}refreshWindow(){this.loadSamplingTable()}loadSamplingTable(){this.callBackRefreshWindow=this.refreshWindow.bind(this);this.getActiveBatches();this.getAllIncubators()}ready(){super.ready();this.loadSamplingTable()}}customElements.define("em-demo-a-batches",emDemoABatches);// import {PolymerElement, html} from '@polymer/polymer/polymer-element';
