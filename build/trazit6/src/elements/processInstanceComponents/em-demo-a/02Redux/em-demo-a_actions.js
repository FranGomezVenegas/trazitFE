define(["exports", "../03config/config-process.js"], function (
  ...
  _exports.getInvestigationResultsPendingDecision = getInvestigationResultsPendingDecision;
  _exports.getAllSavedQueries = getAllSavedQueries;
  ...
  _exports.setDataMiningQueryOutput = setDataMiningQueryOutput;
  _exports.setAllSavedQueries = setAllSavedQueries;
  ...
  const INVESTIGATION_RESULTS_PENDING_DECISION =
    "INVESTIGATION_RESULTS_PENDING_DECISION" + schemaName;
  _exports.INVESTIGATION_RESULTS_PENDING_DECISION = INVESTIGATION_RESULTS_PENDING_DECISION;
  ...
  const DATAMINING_QUERY_OUTPUT = "DATAMINING_QUERY_OUTPUT" + schemaName;
  _exports.DATAMINING_QUERY_OUTPUT = DATAMINING_QUERY_OUTPUT;
  const ALL_SAVED_QUERIES = "ALL_SAVED_QUERIES" + schemaName;
  _exports.ALL_SAVED_QUERIES = ALL_SAVED_QUERIES;
  ...
  function getInvestigationResultsPendingDecision(data) {
    //console.log('proc-deploy_actions.getAllProgramsUnreceivedSamples', data);
    return { type: INVESTIGATION_RESULTS_PENDING_DECISION, DATA: data };
  }
  function getAllSavedQueries(data) {
    //console.log('em-demo-a_actions.getAllSavedQueries', data);
    return { type: ALL_SAVED_QUERIES, DATA: data };
  }
  ...
  function getMicroorganismList(data) {
    //console.log('em-demo-a_actions.getMicroorganismList', data);
  ...
  function setDataMiningQueryOutput(data) {
    //console.log('em-demo-a_actions.getBrowserProdLotData', data);
    return { type: DATAMINING_QUERY_OUTPUT, DATA: data };
  }
  function setAllSavedQueries(data) {
    //console.log('em-demo-a_actions.getBrowserProdLotData', data);
    return { type: ALL_SAVED_QUERIES, DATA: data };
  }
