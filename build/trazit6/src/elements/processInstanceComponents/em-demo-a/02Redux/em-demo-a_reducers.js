...
return _objectSpread({},state,{selectedBatch:action.DATA});case _emDemoA_actions.SELECTED_PROGRAMS_CORRECTIVE_ACTION_LIST://console.log('em-demo-a_reducers.SELECTED_PROGRAMS_CORRECTIVE_ACTION_LIST', action);
return _objectSpread({},state,{selectedProgramCorrectiveActions:action.DATA});case _emDemoA_actions.ACTIVE_PRODUCTION_LOTS:return _objectSpread({},state,{activeProductionLots:action.DATA});case _emDemoA_actions.OPEN_INVESTIGATIONS:return _objectSpread({},state,{openInvestigations:action.DATA});case _emDemoA_actions.INVESTIGATION_RESULTS_PENDING_DECISION:return _objectSpread({},state,{investigationResultsPendingDecision:action.DATA});case _emDemoA_actions.ALL_SAVED_QUERIES:return _objectSpread({},state,{allSavedQueries:action.DATA});case _emDemoA_actions.ALL_PROGRAMS_UNRECEIVED_SAMPLES://console.log('em-demo-a_reducers.programs', action);
...
return _objectSpread({},state,{sampleStatsLastNresults:action.DATA});case _emDemoA_actions.DATAMINING_QUERY_OUTPUT://    console.log('process-us_reducers.COC_SAMPLE_HISTORY', action);
return _objectSpread({},state,{dataminingQueryOutput:action.DATA});case _emDemoA_actions.KPIS://    console.log('process-us_reducers.COC_SAMPLE_HISTORY', action);
