define([
  ...
  "../03config/Programs/proc-deploy-programmainview-settings.js",
  "../01moduleFunctionality/endpoints-frontend-env-monit.js",
  "../02Redux/proc-deploy_actions.js",
  "./program-tabs/proc-deploy-prog-limits.js",
  "./program-tabs/proc-deploy-prog-points.js",
  "./program-tabs/proc-deploy-prog-points-map.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  ...
  _fieldsMethods,
  _tabsFunctions,
  _procDeployProgrammainviewSettings,
  _endpointsFrontendEnvMonit,
  _procDeploy_actions,
  _procDeployProgLimits,
  _procDeployProgPoints,
  _procDeployProgPointsMap
) {
  "use strict"; //import './program-tabs/proc-deploy-prog-home.js';
  ...
  class procDeployPrograms extends (0, _fieldsMethods.FieldsMethods)(
    ...
    programSelected(e) {
      if ("programsList" == e.detail.name) {
        ...
        _store.store.dispatch(
          (0, _procDeploy_actions.setSelectedProgram)(
    ...
    static get properties() {
      return {
        ...
        programsList: {
          ...
          bubble: !0,
          value:
            _procDeployProgrammainviewSettings.programMain_programSelectionForm,
        },
        tabs: {
          type: Object,
          value: _procDeployProgrammainviewSettings.em_programs_tabs,
        },
        currentSubTab: {
          type: String,
          value: _procDeployProgrammainviewSettings.programHome_defaultTab,
        },
        tabsDefinition: {
          type: Object,
          value: _procDeployProgrammainviewSettings.tabsDefinition,
        },
      };
    }
    static get template() {
