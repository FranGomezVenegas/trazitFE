...
class procDeploySampleReviewtestingfq extends(0,_fieldsMethods.FieldsMethods)((0,_functionsEnvMonitSamples.FunctionsEnvMonitSamples)((0,_endpointsFrontendEnvMonitSamples.FrontendEndpointsEnvMonitSamples)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))){static get properties(){return{tableDefinition:{type:Object,value:_procDeploySampleReviewtestingfqSettings.windowSettings},samplesAnalysisPendingRevisionFQ:{type:Array,notify:!0},selectedObject:Object,callBackRefreshWindow:Object,selectedLanguage:{type:String},samplesStagesReduxVariables:{type:String,value:_endpointsFrontendEnvMonitSamples.samplesStagesReduxVariables}}}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(null!=state.procDeploy){this.samplesAnalysisPendingRevisionFQ=state.procDeploy.samplesAnalysisPendingRevisionFQ}}static get template(){return _polymerElement.html`            
            ...
            <div class="main">
                ...
                <vaadingrid-lit-singleselect class="grid" id="ProcDeploy-samplesampling" headerfields="{{tableDefinition.sampleFieldToDisplay}}" 
                    rowcontainer="{{samplesAnalysisPendingRevisionFQ}}" selected-object="{{selectedObject}}">
                </vaadingrid-lit-singleselect>
            </div>  
        `}refreshWindow(){this.loadSamplingTable()}loadSamplingTable(){this.callBackRefreshWindow=this.refreshWindow.bind(this);this.getAllSamplesStageSampling(this.tableDefinition,this.samplesStagesReduxVariables.SAMPLEANALYSIS_PENDINGREVISION_FQ)}ready(){super.ready();this.loadSamplingTable()}}customElements.define("proc-deploy-sample-reviewtestingfq",procDeploySampleReviewtestingfq);// import {LitElement, html} from 'lit-element';
