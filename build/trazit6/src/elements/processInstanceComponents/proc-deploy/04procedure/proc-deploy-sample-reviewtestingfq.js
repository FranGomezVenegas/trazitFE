define([
  ...
  "../03config/proc-deploy-sample-reviewtestingfq-settings.js",
  ...
  _fieldsMethods,
  _procDeploySampleReviewtestingfqSettings,
  ...
  class procDeploySampleReviewtestingfq extends (0,
  _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value: _procDeploySampleReviewtestingfqSettings.windowSettings,
        },
