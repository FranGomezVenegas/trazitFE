define(["../../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../../node_modules/@polymer/paper-button/paper-button.js","./proc-deploy-dialogmodal-buttons.js","../../03config/Dialogs/proc-deploy-dialogmodal-settings.js","../../01moduleFunctionality/functions-env-monit-samples.js"],function(_polymerElement,_paperButton,_procDeployDialogmodalButtons,_procDeployDialogmodalSettings,_functionsEnvMonitSamples){"use strict";/**
 ...
 * @demo
 * 
 */class ProcDeploySimpleModalDialog extends(0,_functionsEnvMonitSamples.FunctionsEnvMonitSamples)(_polymerElement.PolymerElement){static get properties(){return{displayCancelButton:{type:Boolean,notify:!0},displayConfirmButton:{type:Boolean,notify:!0},displayCloseButton:{type:Boolean,notify:!0},formElements:{type:Array},listRows:Array,listHeader:Array,simpleModalSelectedObject:{type:Object,notify:!0},focusInField:{type:String},selectedObject:{type:Object},callBackFunction:{type:Object},callBackFunctionError:{type:Object},allowMultiSelect:{type:Boolean}}}static get template(){return _polymerElement.html`        
        <style include="proc-deploy-dialogmodal-style"></style>       
        <div class="modal-content bgimg">
            <proc-deploy-dialogmodal-buttons display-close-button={{displayCloseButton}} display-cancel-button={{displayCancelButton}} display-confirm-button={{displayConfirmButton}}
...
}}customElements.define("proc-deploy-simple-modal-dialog",ProcDeploySimpleModalDialog)});