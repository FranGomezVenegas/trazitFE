define([
  ...
  "../../../../../store.js",
  "../../03config/Dialogs/proc-deploy-dialogmodal-buttons-settings.js",
  "../../../../../platform-mixins/functions/fields-methods.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  _procDeployDialogmodalButtonsSettings,
  _fieldsMethods
) {
  "use strict";
  /**
   ...
   * @demo
   *
   */ class ProcDeployDialogmodalButtons extends (0,
  _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        ...
        cancelDialogButton: {
          type: String,
          value: _procDeployDialogmodalButtonsSettings.cancelDialogButton,
        },
        confirmDialogButton: {
          type: String,
          value: _procDeployDialogmodalButtonsSettings.confirmDialogButton,
        },
        closeDialogButton: {
          type: String,
          value: _procDeployDialogmodalButtonsSettings.closeDialogButton,
        },
