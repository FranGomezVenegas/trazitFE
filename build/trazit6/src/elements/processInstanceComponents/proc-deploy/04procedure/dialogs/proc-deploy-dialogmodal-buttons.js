define(["../../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../../store.js","../../03config/Dialogs/proc-deploy-dialogmodal-buttons-settings.js","../../../../../platform-mixins/functions/fields-methods.js"],function(_polymerElement,_connectMixin,_store,_procDeployDialogmodalButtonsSettings,_fieldsMethods){"use strict";/**
 ...
 * @demo
 * 
 */class ProcDeployDialogmodalButtons extends(0,_fieldsMethods.FieldsMethods)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)){static get properties(){return{displayCancelButton:{type:Boolean,value:!1,notify:!0},displayConfirmButton:{type:Boolean,value:!1,notify:!0},displayCloseButton:{type:Boolean,value:!1,notify:!0},cancelDialogButton:{type:String,value:_procDeployDialogmodalButtonsSettings.cancelDialogButton},confirmDialogButton:{type:String,value:_procDeployDialogmodalButtonsSettings.confirmDialogButton},closeDialogButton:{type:String,value:_procDeployDialogmodalButtonsSettings.closeDialogButton},selectedLanguage:{type:String},value:{type:Object}}}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage}static get template(){return _polymerElement.html`
