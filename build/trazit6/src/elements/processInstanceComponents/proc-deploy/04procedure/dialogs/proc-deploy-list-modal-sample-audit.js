define([
  ...
  "../../03config/Dialogs/proc-deploy-list-modal-sample-audit-settings.js",
  ...
  _procDeployListModalSampleAuditSettings,
   ...
   * @demo
   *
   */ class ProcDeployListModalSampleAudit extends (0,
  _functionsEnvMonitSamples.FunctionsEnvMonitSamples)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value: _procDeployListModalSampleAuditSettings.sampleAudit,
        },
        listRows: Array,
        listHeader: Array,
        sampleId: Number,
