define([
  ...
  "../03config/proc-deploy-sample-reviewsample-settings.js",
  ...
  _fieldsMethods,
  _procDeploySampleReviewsampleSettings,
  ...
  class procDeploySampleReviewsample extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value: _procDeploySampleReviewsampleSettings.windowSettings,
        },
