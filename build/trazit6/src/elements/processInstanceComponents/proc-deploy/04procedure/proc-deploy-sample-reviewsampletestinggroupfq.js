define([
  ...
  "../03config/proc-deploy-sample-reviewsampletestinggroupfq-settings.js",
  "../01moduleFunctionality/endpoints-frontend-env-monit-samples.js",
  "../01moduleFunctionality/functions-env-monit-samples.js",
  "../01moduleFunctionality/proc-deploy-webcomponent-env-monit-samples.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  ...
  _fieldsMethods,
  _procDeploySampleReviewsampletestinggroupfqSettings,
  _endpointsFrontendEnvMonitSamples,
  _functionsEnvMonitSamples,
  _procDeployWebcomponentEnvMonitSamples
) {
  ...
  class procDeploySampleReviewsampletestinggroupfq extends (0,
  _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value:
            _procDeploySampleReviewsampletestinggroupfqSettings.windowSettings,
        },
        samplePendingRevisionTheTestingGroupFQ: { type: Array, notify: !0 },
    ...
    stateChanged(state) {
      ...
      if (null != state.procDeploy) {
        this.samplePendingRevisionTheTestingGroupFQ =
          state.procDeploy.samplePendingRevisionTheTestingGroupFQ;
      }
    }
    static get template() {
    ...
    loadSamplingTable() {
      ...
      this.getAllSamplesStageSampling(
        ...
        this.samplesStagesReduxVariables.SAMPLES_PENDINGREVISION_TESTINGGROUPFQ
      );
    }
    ready() {
      super.ready();
  ...
  customElements.define(
    "proc-deploy-sample-reviewsampletestinggroupfq",
    procDeploySampleReviewsampletestinggroupfq
