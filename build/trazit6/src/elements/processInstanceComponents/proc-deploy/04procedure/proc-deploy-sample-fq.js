define([
  ...
  "../03config/proc-deploy-sample-fq-settings.js",
  ...
  class procDeploySampleFq extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value: _procDeploySampleFqSettings.windowSettings,
        },
