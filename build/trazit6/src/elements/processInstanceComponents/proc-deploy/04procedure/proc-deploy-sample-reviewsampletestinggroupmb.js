...
class procDeploySampleReviewsampletestinggroupmb extends(0,_fieldsMethods.FieldsMethods)((0,_functionsEnvMonitSamples.FunctionsEnvMonitSamples)((0,_endpointsFrontendEnvMonitSamples.FrontendEndpointsEnvMonitSamples)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))){static get properties(){return{tableDefinition:{type:Object,value:_procDeploySampleReviewsampletestinggroupmbSettings.windowSettings},samplePendingRevisionTheTestingGroupMB:{type:Array,notify:!0},selectedObject:Object,callBackRefreshWindow:Object,selectedLanguage:{type:String},samplesStagesReduxVariables:{type:String,value:_endpointsFrontendEnvMonitSamples.samplesStagesReduxVariables}}}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(null!=state.procDeploy){this.samplePendingRevisionTheTestingGroupMB=state.procDeploy.samplePendingRevisionTheTestingGroupMB}}static get template(){return _polymerElement.html`            
