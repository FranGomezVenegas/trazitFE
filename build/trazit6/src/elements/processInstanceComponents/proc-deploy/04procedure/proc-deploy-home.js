define([
  ...
  "../03config/proc-deploy-home-settings.js",
  ...
  _store,
  _chartController,
  _procDeployHomeSettings,
  _fieldsMethods,
  _endpointsFrontendEnvMonitSamples
) {
  "use strict"; //import './proc-deploy-kpi';
  class procDeployHome extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        windowDefinition: {
          type: Object,
          value: _procDeployHomeSettings.windowDefinition,
        },
