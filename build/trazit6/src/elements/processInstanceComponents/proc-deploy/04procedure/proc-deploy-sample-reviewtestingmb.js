define([
  ...
  "../03config/proc-deploy-sample-reviewtestingmb-settings.js",
  ...
  _fieldsMethods,
  _procDeploySampleReviewtestingmbSettings,
  ...
  class procDeploySampleReviewtestingmb extends (0,
  _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value: _procDeploySampleReviewtestingmbSettings.windowSettings,
        },
        samplesAnalysisPendingRevisionMB: { type: Array, notify: !0 },
    ...
    stateChanged(state) {
      ...
      if (null != state.procDeploy) {
        this.samplesAnalysisPendingRevisionMB =
          state.procDeploy.samplesAnalysisPendingRevisionMB;
      }
    }
    static get template() {
    ...
    loadSamplingTable() {
      ...
      this.getAllSamplesStageSampling(
        ...
        this.samplesStagesReduxVariables.SAMPLEANALYSIS_PENDINGREVISION_MB
      );
    }
    ready() {
      super.ready();
  ...
  customElements.define(
    "proc-deploy-sample-reviewtestingmb",
    procDeploySampleReviewtestingmb
