define([
  ...
  "../../../../../store.js",
  "./proc-deploy-prog-points.js",
], function (_polymerElement, _connectMixin, _store, _procDeployProgPoints) {
  "use strict";
  class procDeployProgPointsMap extends (0, _connectMixin.connect)(
    _store.store
