define([
  ...
  "../../03config/Programs/proc-deploy-progtab-points-settings.js",
  "../../01moduleFunctionality/endpoints-frontend-env-monit.js",
  "../../01moduleFunctionality/proc-deploy-webcomponent-env-monit.js",
  "../../01moduleFunctionality/functions-env-monit-samples.js",
  "../dialogs/proc-deploy-simple-modal-dialog.js",
  ...
  _procDeployProgtabPointsSettings,
  _endpointsFrontendEnvMonit,
  _procDeployWebcomponentEnvMonit,
  _functionsEnvMonitSamples,
  _procDeploySimpleModalDialog,
  _fieldsMethods
) {
  "use strict"; // procDeployapiEnvMonit FrontendEnvMonit
  class procDeployProgPoints extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        tableDefinition: {
          type: Object,
          value: _procDeployProgtabPointsSettings.progTabPoints,
        },
        ...
        systemShifts: {
          type: Object,
          value: _procDeployProgtabPointsSettings.shifts,
        },
        productionLotsList: {
          type: Array,
          value: [
