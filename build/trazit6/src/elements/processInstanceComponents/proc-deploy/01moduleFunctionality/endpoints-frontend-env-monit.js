          ...
          .then((response) => {
            if (200 == response.status) {
              ...
              _store.store.dispatch(
                (0, _procDeploy_actions.getPrograms)(response.data)
              );
        ...
        axios
          ...
          .then((response) => {
            if (200 == response.status) {
              //console.log(response.data);
              _store.store.dispatch(
                (0, _procDeploy_actions.selectedProgramCorrectiveActionList)(
                  response.data
                )
              );
              if (data && data.callBackFunction) {
        ...
        axios
          ...
          .then((response) => {
            if (200 == response.status) {
              //console.log(response.data);
              _store.store.dispatch(
                (0, _procDeploy_actions.getActiveBatches)(response.data)
              );
              if (data && data.callBackFunction) {
                data.callBackFunction();
              }
        ...
        axios
          ...
          .then((response) => {
            if (200 == response.status) {
              //console.log(response.data);
              _store.store.dispatch(
                (0, _procDeploy_actions.getAllIncubators)(response.data)
              );
              if (data && data.callBackFunction) {
                data.callBackFunction();
              }
        ...
        axios
          ...
          .then((response) => {
            if (200 == response.status) {
              //console.log(response.data);
              _store.store.dispatch(
                (0, _procDeploy_actions.getActiveProductionLots)(response.data)
              );
              if (data && data.callBackFunction) {
                data.callBackFunction();
              }
        ...
        axios
          ...
          .then((response) => {
            if (200 == response.status) {
              //console.log(response.data);
              _store.store.dispatch(
                (0, _procDeploy_actions.getOpenInvestigations)(response.data)
              );
              if (data && data.callBackFunction) {
                data.callBackFunction();
              }
