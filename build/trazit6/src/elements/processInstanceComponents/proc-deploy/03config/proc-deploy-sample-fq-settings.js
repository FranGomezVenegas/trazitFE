define(["exports", "./config-process.js"], function (_exports, _configProcess) {
  ...
  const windowSettings = {
    ...
    samplesWhereFieldsValue:
      "RECEIVED-INCOMPLETE-COMPLETE*String|" +
      _configProcess.personal_smp_template,
    ...
    addSampleAnalysisResult: "true", //addSampleAnalysisResultFieldToRetrieve:'method_name|testing_group',
