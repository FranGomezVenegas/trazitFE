define(["exports"], function (_exports) {
  ...
  _exports.closeDialogButton = _exports.confirmDialogButton = _exports.cancelDialogButton = _exports.dialog_buttons = _exports.dialogMicroorgListAdhocMicroorg = _exports.dialogMicroorgListTableHeader = _exports.dialogIncubatorsListTableHeader = _exports.dialogincubAddTmpReading = _exports.dialogincubBatchNew = _exports.dialogProductionLotActivate = _exports.dialogProductionLotNew = _exports.dialogAddComment = void 0;
  ...
  const documentContainerprocDeployDialogModalStyle = document.createElement(
    "proc-deploy-dialogmodal-style"
  );
  documentContainerprocDeployDialogModalStyle.setAttribute(
    "style",
    "display: none;"
  );
