define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.sampleAudit=void 0;const sampleAudit={fieldToRetrieve:"",//samplesWhereFieldsName:'current_stage|sample_config_code in*',
...
label_en:"Sign",label_es:"Firmar",type:"button",read_only:!1,confirmuser_required:!1,esign_required:!0}]};_exports.sampleAudit=sampleAudit;const documentContainerprocDeployDialogSampleAuditSettings=document.createElement("proc-deploy-dialog-sample-audit-settings");documentContainerprocDeployDialogSampleAuditSettings.setAttribute("style","display: none;");documentContainerprocDeployDialogSampleAuditSettings.innerHTML=`
  ...
  </dom-module>`;document.head.appendChild(documentContainerprocDeployDialogSampleAuditSettings)});