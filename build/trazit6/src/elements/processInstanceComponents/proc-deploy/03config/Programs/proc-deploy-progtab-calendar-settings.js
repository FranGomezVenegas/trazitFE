define(["exports", "./proc-deploy-programmainview-settings.js"], function (
  _exports,
  _procDeployProgrammainviewSettings
) {
  "use strict";
  Object.defineProperty(_exports, "__esModule", { value: !0 });
  _exports.programProgConfigCalendar_progConfigCalendarTableHeaderFields = void 0; //import {personal_smp_template} from './config-process';
  const programProgConfigCalendar_progConfigCalendarTableHeaderFields = [
    ...
    },
    {
      ...
      sort: !1,
      filter: !0,
      width: "20%", //, {name: 'spec_code', label_en:'Spec', label_es: 'Especificación', sort:false, filter:true, width:"20%"}
    },
    {
    ...
    },
    {
      ...
      label_es: "An\xE1lisis de Variaci\xF3n",
      sort: !1,
      filter: !0,
      width: "20%",
    },
  ];
  _exports.programProgConfigCalendar_progConfigCalendarTableHeaderFields = programProgConfigCalendar_progConfigCalendarTableHeaderFields; // export const progTabPoints={
  ...
  //     ]
  //   };
  const documentContainerprocDeployProgtabCalendarStyle = document.createElement(
    "proc-deploy-progtab-calendar-style"
  );
  documentContainerprocDeployProgtabCalendarStyle.setAttribute(
    "style",
    "display: none;"
  );
  documentContainerprocDeployProgtabCalendarStyle.innerHTML = `
  ...
  document.head.appendChild(documentContainerprocDeployProgtabCalendarStyle);
});
