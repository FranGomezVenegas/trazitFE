define(["exports"], function (_exports) {
  ...
  _exports.programLimitsTab_sectionsTitle = void 0;
  const programLimitsTab_sectionsTitle = {
    analysis: { label_en: "Analysis", label_es: "An\xE1lisis" },
    variations: { label_en: "Variations", label_es: "Variaciones" },
    limits: { label_en: "Limits", label_es: "L\xEDmites" },
  ...
  //     ]
  //   };
  _exports.programLimitsTab_sectionsTitle = programLimitsTab_sectionsTitle;
  const documentContainerprocDeployProgtabLimitsStyle = document.createElement(
    "proc-deploy-progtab-limits-style"
  );
  documentContainerprocDeployProgtabLimitsStyle.setAttribute(
    "style",
    "display: none;"
  );
