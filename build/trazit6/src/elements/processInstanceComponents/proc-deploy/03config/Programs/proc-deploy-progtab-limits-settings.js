define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.programLimitsTab_sectionsTitle=void 0;const programLimitsTab_sectionsTitle={analysis:{label_en:"Analysis",label_es:"An\xE1lisis"},variations:{label_en:"Variations",label_es:"Variaciones"},limits:{label_en:"Limits",label_es:"L\xEDmites"}};// export const windowDefinition={
...
//     ]    
//   };
_exports.programLimitsTab_sectionsTitle=programLimitsTab_sectionsTitle;const documentContainerprocDeployProgtabLimitsStyle=document.createElement("proc-deploy-progtab-limits-style");documentContainerprocDeployProgtabLimitsStyle.setAttribute("style","display: none;");documentContainerprocDeployProgtabLimitsStyle.innerHTML=`
  ...
  </dom-module>`;document.head.appendChild(documentContainerprocDeployProgtabLimitsStyle)});