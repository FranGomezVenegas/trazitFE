define(["exports"], function (_exports) {
  ...
  _exports.progTabPoints = _exports.shifts = void 0; //import {personal_smp_template} from './config-process';
  const shifts = [
