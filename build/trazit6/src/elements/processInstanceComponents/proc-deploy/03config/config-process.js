define(["exports"], function (_exports) {
  ...
  _exports.shifts = _exports.prodLotActiveOnCreate = _exports.personal_smp_template = _exports.schema_name = void 0;
  ...
  const schema_name = "proc-deploy";
  _exports.schema_name = schema_name;
  const personal_smp_template = "prog_pers_template";
  _exports.personal_smp_template = personal_smp_template;
  const prodLotActiveOnCreate = "true";
  _exports.prodLotActiveOnCreate = prodLotActiveOnCreate;
  const shifts = [
