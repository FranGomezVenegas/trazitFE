...
//     ]    
//   };
_exports.windowDefinition=windowDefinition;const documentContainerGenomaInstancia1ProjtabStudyFamilyStyle=document.createElement("genoma-instancia1-projtab-study-family-style");documentContainerGenomaInstancia1ProjtabStudyFamilyStyle.setAttribute("style","display: none;");documentContainerGenomaInstancia1ProjtabStudyFamilyStyle.innerHTML=`
  <dom-module id="genoma-instancia1-projtab-study-family-style">
    <template>
    <style>
      p.tableTitle{
        margin-top: 0px;
  ...
  </dom-module>`;document.head.appendChild(documentContainerGenomaInstancia1ProjtabStudyFamilyStyle)});