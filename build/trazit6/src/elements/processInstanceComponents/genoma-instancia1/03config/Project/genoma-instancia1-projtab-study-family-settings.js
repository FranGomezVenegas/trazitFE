define([
  "exports",
  "./genoma-instancia1-projectmainview-settings.js",
], function (_exports, _genomaInstancia1ProjectmainviewSettings) {
  "use strict";
  ...
  const windowDefinition = {
    elementTable1: _genomaInstancia1ProjectmainviewSettings.elementTableFamily,
    elementTable2:
      _genomaInstancia1ProjectmainviewSettings.elementTableIndividual,
    elementTable3: _genomaInstancia1ProjectmainviewSettings.elementTableSample,
    elementTable4:
      _genomaInstancia1ProjectmainviewSettings.elementTableSampleVariable,
    zcharts: [
      {
        display_chart: !0,
        chart_type: "pie",
  ...
  const documentContainerGenomaInstancia1ProjtabStudyFamilyStyle = document.createElement(
    "genoma-instancia1-projtab-study-family-style"
  );
  documentContainerGenomaInstancia1ProjtabStudyFamilyStyle.setAttribute(
    "style",
    "display: none;"
  );
  documentContainerGenomaInstancia1ProjtabStudyFamilyStyle.innerHTML = `
  ...
  document.head.appendChild(
    documentContainerGenomaInstancia1ProjtabStudyFamilyStyle
  );
});
