define(["exports"], function (_exports) {
  ...
  const windowDefinition = {
    tableTitle: {
      display: !0,
      label: {
        label_en: "All Study variables and values",
        label_es: "Todas las variables y valores del estudio",
      },
    },
  ...
  const documentContainerGenomaInstancia1ProjtabStudyVariablevaluesStyle = document.createElement(
    "genoma-instancia1-projtab-study-variablevalues-style"
  );
  documentContainerGenomaInstancia1ProjtabStudyVariablevaluesStyle.setAttribute(
    "style",
    "display: none;"
  );
  documentContainerGenomaInstancia1ProjtabStudyVariablevaluesStyle.innerHTML = `
  ...
  document.head.appendChild(
    documentContainerGenomaInstancia1ProjtabStudyVariablevaluesStyle
  );
});
