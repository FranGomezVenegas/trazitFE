...
//     ]    
//   };
_exports.windowDefinition=windowDefinition;const documentContainerGenomaInstancia1ProjtabStudyIndividualsStyle=document.createElement("genoma-instancia1-projtab-study-individuals-style");documentContainerGenomaInstancia1ProjtabStudyIndividualsStyle.setAttribute("style","display: none;");documentContainerGenomaInstancia1ProjtabStudyIndividualsStyle.innerHTML=`
  <dom-module id="genoma-instancia1-projtab-study-individuals-style">
    <template>
    <style>
      p.tableTitle{
        margin-top: 0px;
  ...
  </dom-module>`;document.head.appendChild(documentContainerGenomaInstancia1ProjtabStudyIndividualsStyle)});