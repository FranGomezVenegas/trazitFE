define([
  ...
  const windowDefinition = {
    ...
    elementTable2: _genomaInstancia1ProjectmainviewSettings.elementTableSample,
    elementTable3:
  ...
  const documentContainerGenomaInstancia1ProjtabStudyIndividualsStyle = document.createElement(
    "genoma-instancia1-projtab-study-individuals-style"
  );
  documentContainerGenomaInstancia1ProjtabStudyIndividualsStyle.setAttribute(
    "style",
    "display: none;"
  );
  documentContainerGenomaInstancia1ProjtabStudyIndividualsStyle.innerHTML = `
