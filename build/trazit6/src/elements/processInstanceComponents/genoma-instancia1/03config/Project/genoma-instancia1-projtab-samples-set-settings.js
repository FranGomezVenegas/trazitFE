...
//     ]    
//   };
_exports.windowDefinition=windowDefinition;const documentContainerGenomaInstancia1ProjtabHomeStyle=document.createElement("genoma-instancia1-projtab-samples-set-style");documentContainerGenomaInstancia1ProjtabHomeStyle.setAttribute("style","display: none;");documentContainerGenomaInstancia1ProjtabHomeStyle.innerHTML=`
  <dom-module id="genoma-instancia1-projtab-samples-set-style">
    <template>
    <style>
      p.tableTitle{
        margin-top: 0px;
