...
//   },
// ],
};_exports.windowDefinition=windowDefinition;const documentContainerGenomaInstancia1HomeStyle=document.createElement("genoma-instancia1-home-style");documentContainerGenomaInstancia1HomeStyle.setAttribute("style","display: none;");documentContainerGenomaInstancia1HomeStyle.innerHTML=`
  ...
  </dom-module>`;document.head.appendChild(documentContainerGenomaInstancia1HomeStyle)});