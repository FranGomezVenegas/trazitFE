define([
  ...
  "../../../../store.js",
  "./0module-functions-genoma.js",
  "../03config/Project/genoma-instancia1-projectmainview-settings.js",
  "../04procedure/dialogs/genoma-instancia1-simple-modal-dialog.js",
  "../04procedure/dialogs/genoma-instancia1-enter-variable-value-dialog.js",
  ...
  _genomaInstancia1SimpleModalDialog,
  _genomaInstancia1EnterVariableValueDialog,
  _genomaInstancia1DialogmodalSettings
) {
  "use strict"; //, elementTableIndividual, elementTableSample, elementTableSampleVariable
   ...
   * @demo
   *
   */ class GenomaInstancia1WebcomponentProject extends (0,
  _moduleFunctionsGenoma.ModuleFunctionsGenoma)(
    ...
    static get properties() {
      return {
        ...
        dialogStudyNew: {
          ...
          notify: !0,
          bubble: !0,
          value: _genomaInstancia1DialogmodalSettings.dialogStudyNew,
        },
        dialogStudyUpdate: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _genomaInstancia1DialogmodalSettings.dialogStudyUpdate,
        },
        dialogStudyIndividualNew: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _genomaInstancia1DialogmodalSettings.dialogStudyIndividualNew,
        },
        dialogStudyIndividualUpdate: {
          ...
          bubble: !0,
          value:
            _genomaInstancia1DialogmodalSettings.dialogStudyIndividualUpdate,
        },
        dialogStudyFamilyNew: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _genomaInstancia1DialogmodalSettings.dialogStudyFamilyNew,
        },
        dialogStudyFamilyUpdate: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _genomaInstancia1DialogmodalSettings.dialogStudyFamilyUpdate,
        },
        dialogStudySamplesSetNew: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _genomaInstancia1DialogmodalSettings.dialogStudySamplesSetNew,
        },
        dialogStudySamplesSetUpdate: {
          ...
          bubble: !0,
          value:
            _genomaInstancia1DialogmodalSettings.dialogStudySamplesSetUpdate,
        },
        ...
        dialogStudyFamilyList: {
          ...
          notify: !0,
          bubble: !0,
          value: _genomaInstancia1ProjectmainviewSettings.elementTableFamily,
        },
        dialogStudyFamilyIndividualList: {
          ...
          bubble: !0,
          value:
            _genomaInstancia1ProjectmainviewSettings.elementTableFamilyIndividual,
        },
        dialogStudyIndividualList: {
          ...
          bubble: !0,
          value:
            _genomaInstancia1ProjectmainviewSettings.elementTableIndividual,
        },
        dialogStudySamplesSetList: {
          ...
          bubble: !0,
          value:
            _genomaInstancia1ProjectmainviewSettings.elementTableSamplesSet,
        },
        dialogStudySamplesList: {
          type: Array,
          notify: !0,
          bubble: !0,
          value: _genomaInstancia1ProjectmainviewSettings.elementTableSample,
        },
        dialogConfigVariablesSetList: {
          ...
          bubble: !0,
          value:
            _genomaInstancia1ProjectmainviewSettings.elementTableConfigVariablesSet,
        },
      };
    }
    stateChanged(state) {
    ...
    openDialog(dialogName, actionName) {
      ...
      if (
        "STUDY_FAMILY_ADD_INDIVIDUAL" == dialogName ||
        "STUDY_FAMILY_REMOVE_INDIVIDUAL" == dialogName
      ) {
        if (this.selectedObject.individual_id != void 0) {
      ...
      if (
        "STUDY_SAMPLES_SET_ADD_SAMPLE" == dialogName ||
        "STUDY_SAMPLES_SET_REMOVE_SAMPLE" == dialogName
      ) {
        if (this.selectedObject.sample_id != void 0) {
      ...
      var elem = this.shadowRoot.getElementById(dialogName); // if ( (actionName=='STUDY_FAMILY_REMOVE_INDIVIDUAL') ){
