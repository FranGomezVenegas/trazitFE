define([
  ...
  _exports.GenomaModuleDefinition = void 0;
  const GenomaModuleDefinition = (superClass) =>
      ...
      moduleDefinition() {
        return {
          ...
          functionalAreas: [
            {
              name: "PROJECTS",
              apiUrlForActions: _apiConfig.ApiGenomaProjectUrl,
              actionsFunction: this.genomaModuleProjectActions.bind(this),
            },
            {
              name: "STUDIES",
              apiUrlForActions: _apiConfig.ApiGenomaStudyUrl,
            ...
            },
            {
              ...
              apiUrlForActions: _apiConfig.ApiGenomaStudyObjectsVariablesUrl,
              actionsFunction: this.genomaModuleStudyActions.bind(this),
            },
          ],
        };
        ...
        return [
          //STUDY
          {
            ...
            apiParams: [
              ...
              { paramName: "studyName", dataArrName: "name", isMandatory: !0 },
              {
                paramName: "fieldsNames",
          ...
          }, //STUDY_FAMILY
          {
            ...
            apiParams: [
              { paramName: "studyName", dataArrName: "study", isMandatory: !0 },
              {
          ...
          },
          {
            ...
            apiParams: [
              { paramName: "studyName", dataArrName: "study", isMandatory: !0 },
              { paramName: "familyName", dataArrName: "name", isMandatory: !0 },
            ],
          },
          {
          ...
          }, //Variable Values
          {
            ...
            apiParams: [
              ...
              { paramName: "ownerId", dataArrName: "ownerId", isMandatory: !0 },
            ],
          },
          {
        ...
        return [
          {
            ...
            apiParams: [],
            apiurl: _apiConfig.backendUrl + _apiConfig.frontEndGenomaProjectUrl,
  ...
  _exports.GenomaModuleDefinition = GenomaModuleDefinition;
});
