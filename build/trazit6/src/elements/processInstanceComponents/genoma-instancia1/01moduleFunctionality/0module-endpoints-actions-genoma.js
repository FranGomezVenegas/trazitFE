define([
  ...
  _exports.EndpointsActionsGenomaModule = void 0; //incubationMode
  /**
   * @mixinFunction
   * @polymer
   */ const EndpointsActionsGenomaModule = (superClass) =>
    class extends (0, _userConfirmationMixin.userConfirmationMixin)(
      (0, _moduleBackendfunctionalityAvailable.GenomaModuleDefinition)(
      ...
      moduleAPIEndpointCall(
        ...
        apiUrl =
          ...
          this.getFinalToken() +
          "&schemaPrefix=" +
          _configProcess.schema_name; //console.log('process-us>api-sample>moduleAPIEndpointCall', data.schemaPrefix, data.actionName, apiUrl, data.paramsUrl);
  ...
  _exports.EndpointsActionsGenomaModule = EndpointsActionsGenomaModule;
});
