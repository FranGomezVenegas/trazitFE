define(["../../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../../store.js","../../../../internalComponents/Grids/vaadingrid-lit-singleselect.js","../../../../internalComponents/Charts/chart-controller.js","../../03config/Project/genoma-instancia1-projtab-samples-set-settings.js","../../../../../platform-mixins/functions/fields-methods.js","../../01moduleFunctionality/0module-functions-genoma.js","../../../../internalComponents/Elements/table-with-buttons.js","../../../../platformComponents/Tabs/SOP/MyPendingSOPs/my-pending-sops-style.js","../../../../platformComponents/Tabs/SOP/pdf-link.js"],function(_polymerElement,_connectMixin,_store,_vaadingridLitSingleselect,_chartController,_genomaInstancia1ProjtabSamplesSetSettings,_fieldsMethods,_moduleFunctionsGenoma,_tableWithButtons,_myPendingSopsStyle,_pdfLink){"use strict";class GenomaInstancia1ProjStudyFiles extends(0,_fieldsMethods.FieldsMethods)((0,_moduleFunctionsGenoma.ModuleFunctionsGenoma)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement))){stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;if(null!=state.genomaInstancia1){this.selectedStudy=state.genomaInstancia1.selectedStudy}}static get properties(){return{windowDefinition:{type:Object,value:_genomaInstancia1ProjtabSamplesSetSettings.windowDefinition},selectedLanguage:{type:String},selectedProject:{type:Object},sopMyPendingSops_cardContent:{type:Object,value:{display_pdf_link:!0,display_certification_status_icon:!1,sopFieldsToDisplay:["owner_table","owner_id","doc_name","brief_summary"]}},displayButtons:!0,buttons:{type:Array,value:[{name:"SOP_MARK_AS_COMPLETED",label_en:"Mark Completed",label_es:"Marcar Completado",type:"icon-button",icon_name:"icons:restore-page",icon_color:"aqua",esign_required:!1,read_only:!1}]}}}static get template(){return _polymerElement.html`        
        <!-- <style include="genoma-instancia1-projtab-samples-set-style"></style>     -->    
        <style include="my-pending-sops-style"></style>
        {{selectedStudy.study_objects_files.length}} files ...
            ...
            {{sopMyPendingSops_cardContent.display_pdf_link}}
