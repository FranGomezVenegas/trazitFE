 ...
 * @demo
 * 
 */class GenomaInstancia1SimpleModalDialog extends(0,_moduleFunctionsGenoma.ModuleFunctionsGenoma)(_polymerElement.PolymerElement){static get properties(){return{displayCancelButton:{type:Boolean,notify:!0},displayConfirmButton:{type:Boolean,notify:!0},displayCloseButton:{type:Boolean,notify:!0},formElements:{type:Array},listRows:Array,listHeader:Array,simpleModalSelectedObject:{type:Object,notify:!0},focusInField:{type:String},selectedObject:{type:Object},selectedStudy:{type:Object},callBackFunction:{type:Object},callBackFunctionError:{type:Object},allowMultiSelect:{type:Boolean}}}static get template(){return _polymerElement.html`        
