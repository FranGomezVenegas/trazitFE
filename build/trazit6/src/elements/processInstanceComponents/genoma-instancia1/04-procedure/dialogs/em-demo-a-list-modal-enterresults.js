define(["../../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../../store.js","../../../../../../node_modules/@polymer/iron-collapse/iron-collapse.js","./em-demo-a-dialogmodal-buttons.js","../../03config/Dialogs/em-demo-a-list-modal-enterresults-settings","../../01moduleFunctionality/endpoints-frontend-env-monit-samples","../../01moduleFunctionality/functions-env-monit-samples","../../../../../platform-mixins/functions/fields-methods.js","../../../../internalComponents/form-fields/field-icon-button.js","../../01moduleFunctionality/functions-icons.js","../../03config/config-icons"],function(_polymerElement,_connectMixin,_store,_ironCollapse,_emDemoADialogmodalButtons,_emDemoAListModalEnterresultsSettings,_endpointsFrontendEnvMonitSamples,_functionsEnvMonitSamples,_fieldsMethods,_fieldIconButton,_functionsIcons,_configIcons){"use strict";/**
 ...
 * @demo
 * 
 */class EmDemoAListModalEnterResults extends(0,_configIcons.SampleIcons)((0,_functionsIcons.iconsMethods)((0,_fieldsMethods.FieldsMethods)((0,_functionsEnvMonitSamples.FunctionsEnvMonitSamples)((0,_endpointsFrontendEnvMonitSamples.FrontendEndpointsEnvMonitSamples)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))))){static get properties(){return{opened:{type:Boolean,value:!0,reflectToAttribute:!0},horizontal:{type:Boolean},displayCancelButton:{type:Boolean,notify:!0},displayConfirmButton:{type:Boolean,notify:!0},displayCloseButton:{type:Boolean,notify:!0},tableDefinition:{type:Object,value:_emDemoAListModalEnterresultsSettings.enterResult},resultCheckerMessages:{type:Object,value:_emDemoAListModalEnterresultsSettings.resultCheckerMessages},listRows:Array,listHeader:Array,sampleId:Number,selectedObject:{type:Object,notify:!0},selectedLanguage:{type:String},detailOpenStatus:{type:Boolean,value:!1}}}toggle(){this.$.collapse.toggle()}getSpecRule(item){return item.spec_eval_detail}getItemValue(flddetail,item){if("locking_reason"==flddetail.name){if("en"==this.selectedLanguage){return item.locking_reason.message_en}if("es"==this.selectedLanguage){return item.locking_reason.message_es}}if("spec_rule"==flddetail.name){return this.getSpecRule(item)}return item[flddetail.name]}static get template(){return _polymerElement.html`        
