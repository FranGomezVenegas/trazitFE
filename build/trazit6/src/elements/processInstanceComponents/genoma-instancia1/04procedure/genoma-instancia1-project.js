...
this.currentTab=curTab;return}static get properties(){return{selectedLanguage:String,selectedStudy:{type:Object},projects:Object,selectedProject:Object,filtersList:{type:Array,notify:!0,bubble:!0,value:_genomaInstancia1ProjectmainviewSettings.projectMain_projectSelectionForm},tabs:{type:Object,value:_genomaInstancia1ProjectmainviewSettings.window_tabs},currentSubTab:{type:String,value:_genomaInstancia1ProjectmainviewSettings.home_defaultTab},tabsDefinition:{type:Object,value:_genomaInstancia1ProjectmainviewSettings.tabsDefinition}}}static get template(){return _polymerElement.html`
        <style include="gemoma-instancia1-projectmainview-style"></style>
        <genoma-instancia1-webcomponent-project id="myElementsProject"></genoma-instancia1-webcomponent-project>
        <div class="wrapper">
        ...
        `}refreshWindow(){this.getProjects();this.getConfigVariablesAndVariablesSet()}ready(){super.ready();this.getProjects();this.getConfigVariablesAndVariablesSet()}}customElements.define("genoma-instancia1-project",GenomaInstancia1Project)});