define([
  ...
  "../../03config/Dialogs/em-demo-a-list-modal-enterresults-settings",
  ...
  _emDemoAListModalEnterresultsSettings,
   ...
   * @demo
   *
   */ class EmDemoAListModalEnterResults extends (0, _configIcons.SampleIcons)(
    ...
    static get properties() {
      return {
        ...
        tableDefinition: {
          type: Object,
          value: _emDemoAListModalEnterresultsSettings.enterResult,
        },
        resultCheckerMessages: {
          type: Object,
          value: _emDemoAListModalEnterresultsSettings.resultCheckerMessages,
        },
        listRows: Array,
        listHeader: Array,
        sampleId: Number,
