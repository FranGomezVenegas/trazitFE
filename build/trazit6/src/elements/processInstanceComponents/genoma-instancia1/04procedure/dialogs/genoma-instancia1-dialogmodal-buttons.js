define([
  ...
  "../../../../../store.js",
  "../../03config/Dialogs/genoma-instancia1-dialogmodal-buttons-settings.js",
  "../../../../../platform-mixins/functions/fields-methods.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  _genomaInstancia1DialogmodalButtonsSettings,
  _fieldsMethods
) {
  "use strict";
  /**
   ...
   * @demo
   *
   */ class GenomaInstancia1DialogmodalButtons extends (0,
  _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        ...
        cancelDialogButton: {
          type: String,
          value: _genomaInstancia1DialogmodalButtonsSettings.cancelDialogButton,
        },
        confirmDialogButton: {
          type: String,
          value:
            _genomaInstancia1DialogmodalButtonsSettings.confirmDialogButton,
        },
        closeDialogButton: {
          type: String,
          value: _genomaInstancia1DialogmodalButtonsSettings.closeDialogButton,
        },
