define([
  ...
  "../../../process-us/03config/config-process.js",
  "../../03config/config-icons",
   ...
   * @demo
   *
   */ class emDemoAListModalCocSamplehistory extends (0,
  _configIcons.SampleIcons)(
    (0, _connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)
  ) {
    static get properties() {
      return {
        dialogButtons: { type: Array, value: _appConfig.dialog_buttons },
        listRows: {
          type: Array,
          value: [
    ...
    fieldButtonClicked(e) {
      ...
      if (null == this.selectedObject) {
        ...
        switch (this.selectedLanguage) {
          ...
          default:
            message = "Please select one object first.";
      ...
      datas.tabInfo = tabInfo; //        datas.sampleResults_analysisListFieldsToRetrieve=sampleResults_analysisListFieldsToRetrieve;
    ...
    tableListRowsEmpty(content) {
      console.log("tableListRowsEmpty", content.length, 0 == content.length);
      if (0 == content.length) {
        return !0;
      }
      return !1;
  ...
  customElements.define(
    "em-demo-a-list-modal-coc-samplehistory",
    emDemoAListModalCocSamplehistory
  );
});
