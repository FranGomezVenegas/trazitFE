define([
  ...
  "../../03config/Project/genoma-instancia1-projtab-study-samples-settings.js",
   ...
   * @demo
   *
   */ class GenomaInstancia1ProjStudySamples extends (0,
  _moduleEndpointsActionsGenoma.EndpointsActionsGenomaModule)(
    ...
    static get properties() {
      return {
        windowDefinition: {
          type: Object,
          value: _genomaInstancia1ProjtabStudySamplesSettings.windowDefinition,
        },
     ...
     */ constructor() {
      ...
      this.windowDefinition =
        _genomaInstancia1ProjtabStudySamplesSettings.windowDefinition;
    }
    /**
