define([
  ...
  "../../03config/Project/genoma-instancia1-projtab-study-variablevalues-settings.js",
  ...
  _chartController,
  _genomaInstancia1ProjtabStudyVariablevaluesSettings,
  _fieldsMethods,
   ...
   * @demo
   *
   */ class GenomaInstancia1ProjStudyVariablevalues extends (0,
    ...
    static get properties() {
      return {
        windowDefinition: {
          type: Object,
          value:
            _genomaInstancia1ProjtabStudyVariablevaluesSettings.windowDefinition,
        },
