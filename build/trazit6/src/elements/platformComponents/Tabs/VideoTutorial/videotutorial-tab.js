define([
  ...
  "../../../../store.js",
  "../SOP/MySOPs/my-sops-style.js",
  "../../../../platform-mixins/functions/fields-methods.js",
  "./videotutorial-tab-style.js",
  "../../../../platform-mixins/platform-functions/frontend-videotutorials.js",
], function (
  _require,
  _polymerElement,
  _connectMixin,
  ...
  _mySopsStyle,
  _fieldsMethods,
  _videotutorialTabStyle,
  _frontendVideotutorials
) {
  "use strict";
  ...
  class VideotutorialTab extends (0, _fieldsMethods.FieldsMethods)(
    (0, _frontendVideotutorials.FrontendVideoTutorials)(
    ...
    static get properties() {
      return {
        ...
        filterArea: { type: Array, value: _videotutorialTabStyle.filterArea },
      };
    }
    filterForVideos() {
      const itemsByFilter = [];
