define([
  ...
  "../../../../store.js",
  "./incident-management-settings.js",
  "./incident-management-style.js",
  "../../../internalComponents/form-fields/field-controller.js",
  "../../../../platform-mixins/platform-functions/frontend-incidents.js",
  "../../../../platform-mixins/platform-functions/frontend-incidents-elements.js",
  "../../../../platform-mixins/apis/api-incidents.js",
  "../../../../platform-mixins/platform-functions/tabs-functions.js",
  "../../../internalComponents/Dialogs/DialogSimple/simple-modal-dialog.js",
  ...
  _incidentManagementStyle,
  _fieldController,
  _frontendIncidents,
  _frontendIncidentsElements,
  _apiIncidents,
  _tabsFunctions,
  _simpleModalDialog,
  _vaadingridLitSingleselect
) {
  "use strict"; // import '../../../internalComponents/grid-components/vaadingrid-singleselect.js'; // Necesario pero no cargado aún
  /**
   ...
   * @demo
   *
   */ class IncidentManagement extends (0, _tabsFunctions.TabsMethods)(
    (0, _apiIncidents.ApiIncidents)(
      (0, _frontendIncidents.FrontendIncidents)(
    ...
    static get properties() {
      return {
        formFields: {
          ...
          notify: !0,
          bubble: !0,
          value: _incidentManagementSettings.appNewIncident_formFields,
        },
        ...
        userOpenIncidentsieldToDisplay: {
          type: Array,
          value:
            _incidentManagementSettings.incidents_userOpenIncidentsFieldToDisplay,
        },
        userOpenIncidentsuttons: {
          type: Array,
          value: _incidentManagementSettings.incidents_userOpenIncidentsButtons,
        },
    ...
    keyPressed() {}
    incidentSelected(e) {
      this.selectedObject = e.detail; //console.log('incidentSelected', 'this.selectedObject', this.selectedObject);
      this.getSelectedUserIncidentDetail({
        incidentId: this.selectedObject.id,
      });
      return;
    }
