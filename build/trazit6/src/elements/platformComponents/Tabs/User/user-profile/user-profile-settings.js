define(["exports"], function (_exports) {
  ...
  _exports.saveOpenTabsForm = _exports.changeUserEsignForm = _exports.changeUserPasswordForm = void 0;
  ...
  _exports.changeUserPasswordForm = changeUserPasswordForm;
  const changeUserEsignForm = [
    {
      name: "Esign",
      label_en: "New Esign",
  ...
  _exports.changeUserEsignForm = changeUserEsignForm;
  const saveOpenTabsForm = [
    {
  ...
  _exports.saveOpenTabsForm = saveOpenTabsForm;
});
