define([
  ...
  "./platform-header-style.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  _platformHeaderSettings,
  _plaftormConfig,
  _app_actions,
  _notifications_actions,
  _tabs_actions,
  _platformHeaderStyle
) {
  "use strict";
  class PlatformHeader extends (0, _connectMixin.connect)(_store.store)(
    ...
    static get properties() {
      return {
        ...
        platformHeaderFields: {
          type: Object,
          value: _platformHeaderSettings.platformHeaderFields,
        },
        platformHeader_personFieldsName: {
          type: Object,
          value: _platformHeaderSettings.platformHeader_personFieldsName,
        },
        appLogOut_logOutMessage: {
          type: Object,
          value: _plaftormConfig.appLogOut_logOutMessage,
        },
      };
    }
    static get template() {
    ...
    platformHeaderRightClicked(e) {
      if (e.detail.avatarDefinition.tab) {
        _store.store.dispatch(
          (0, _tabs_actions.addSystemTab)(e.detail.avatarDefinition.tab)
        );
        _store.store.dispatch(
          (0, _tabs_actions.setCurrentTab)(e.detail.avatarDefinition.tab)
        );
      } else {
        this.doLogout();
      }
