define([
  ...
  "./notifications-pane-settings.js",
  "./notifications-pane-style.js",
], function (
  _polymerElement,
  _connectMixin,
  _store,
  ...
  _notificationsPaneStyle
) {
  "use strict";
  class NotificationsPane extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get properties() {
      return {
        ...
        paneTitle: {
          type: Object,
          value: _notificationsPaneSettings.notificationsPaneTitle,
        },
        titleValue: String,
        titleIcon: String,
