define([
  ...
  "../../../../../store.js",
  "./sop-icon-and-badge-settings.js",
  "../../../Tabs/tabs-settings.js",
  "./sop-icon-and-badge-style.js",
  ...
  _connectMixin,
  _store,
  _sopIconAndBadgeSettings,
  _tabsSettings,
  _sopIconAndBadgeStyle,
  _paperBadge,
  _tabs_actions
) {
  "use strict";
   ...
   * @demo
   *
   */ class SopIconAndBadge extends (0, _connectMixin.connect)(_store.store)(
    ...
    static get properties() {
      return {
        iconName: {
          type: String,
          value: _sopIconAndBadgeSettings.sopPaneIconAndBadge_icons.iconGreen,
        },
        showPendingSOP: Boolean,
        sopPaneIconAndBadge_icons: {
          type: Object,
          value: _sopIconAndBadgeSettings.sopPaneIconAndBadge_icons,
        },
      };
    }
    static get template() {
