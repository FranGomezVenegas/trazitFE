define(["require","../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../node_modules/pwa-helpers/connect-mixin.js","../../../store.js","../../../config/platform/platform-login/platform-login-settings.js","../../../config/platform/platform-login/platform-login-style.js","../../../platform-mixins/apis/api-authentication.js","../Redux/actions/app_actions.js","../../internalComponents/others/language-selector.js","../../internalComponents/Dialogs/DialogVideoPlayer/dialog-videoplayer.js"],function(_require,_polymerElement,_connectMixin,_store,_platformLoginSettings,_platformLoginStyle,_apiAuthentication,_app_actions,_languageSelector,_dialogVideoplayer){"use strict";_require=babelHelpers.interopRequireWildcard(_require);//import './../../internalComponents/others/language-selectortwoflags.js';
new Promise((res,rej)=>_require.default(["../../../../node_modules/@polymer/paper-dialog/paper-dialog.js"],res,rej));//import '@thuoe/mp4-video-player';
/**
...
static get properties(){return{loggedIn:{type:Boolean,observer:"notLoggedIn",notify:!0},appLogin_logoOnTop:{type:String,value:_platformLoginSettings.appLogin_logoOnTop},formFields:{type:Array,notify:!0,bubble:!0,value:_platformLoginSettings.appLogin_formFields},loading:{type:Boolean,value:!1},appLogin_ribbon:{type:Object,value:_platformLoginSettings.appLogin_ribbon},axiosMessage:{type:String,value:_platformLoginSettings.appLogin_authenticationMessage},userRoles:Array,selectedLanguage:String,rolesList:{type:Array,value:[]},//videoUrl:{type: String, value:'http://51.75.202.142:8888/myvideos/LP.mp4'},
