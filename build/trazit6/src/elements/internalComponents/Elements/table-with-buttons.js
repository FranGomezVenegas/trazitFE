define([
  ...
  "../../processInstanceComponents/genoma-instancia1/01moduleFunctionality/genoma-instancia1-webcomponent-project.js",
  "../../processInstanceComponents/genoma-instancia1/03config/Project/genoma-instancia1-projtab-study-samples-settings.js",
  "./table-with-buttons-style.js",
], function (
  _litElement,
  _fieldsMethods,
  _genomaInstancia1WebcomponentProject,
  _genomaInstancia1ProjtabStudySamplesSettings,
  _tableWithButtonsStyle
) {
  "use strict";
  /**
   ...
   * @demo
   *
   */ class TableWithButtons extends (0, _fieldsMethods.FieldsMethods)(
    ...
    static get styles() {
      return [
        //super.styles,
        _tableWithButtonsStyle.tableWithButtonsStyle,
        _litElement.css``,
      ];
    }
    /**
...
selObj ${this.selected_object} -->
            ...
            <div style="display:flex; padding:2px;">
                ...
                ${
                  this.element_definition.tableTitle.display
                    ? _litElement.html`
                    <p class="tableTitle"> ${this.labelValue(
            ...
            ${
              this.tableHidden
                ...
                <vaadingrid-lit-singleselect id="genoma-instancia1-proj-samplessetgrid" .headerfields="${
                  this.element_definition.tableHdrFlds
                }" 
                    .rowcontainer="${this.table_data}" .selected_object="${
            ...
            `
                : _litElement.html` 
            ${
              this.element_definition.tableSectionWhenHidden != void 0 &&
                  ...
                  this.selected_object
                    ...
                    <div class="selectedobjectwhentblhiddenDiv" style="display:flex;">
                        ${this.element_definition.tableSectionWhenHidden.selectedObjectData.map(
                          (currentfield) => _litElement.html`
                            <p class="selectedobjectwhentblhiddenFld">${this.selectedObjectFldValue(
                              this.selected_object,
                              currentfield
                            )}</p>
                        `
