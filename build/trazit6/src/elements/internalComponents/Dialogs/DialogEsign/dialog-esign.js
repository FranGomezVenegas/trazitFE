define(["../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../node_modules/@polymer/paper-button/paper-button.js","../../../../../node_modules/@polymer/polymer/lib/elements/dom-if.js","../../../../store.js","../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../platform-mixins/apis/api-authentication.js","../close-dialog-on-esc-pressed-mixin.js","../../../platformComponents/Redux/actions/esign-actions.js","./dialog-esign-style.js","../dialogmodal-buttons-settings.js","./dialog-esign-settings.js","../../../../platform-mixins/functions/fields-methods.js","../dialogmodal-buttons.js"],function(_polymerElement,_paperButton,_domIf,_store,_connectMixin,_apiAuthentication,_closeDialogOnEscPressedMixin,_esignActions,_dialogEsignStyle,_dialogmodalButtonsSettings,_dialogEsignSettings,_fieldsMethods,_dialogmodalButtons){"use strict";let acceptedHandler=null,canceledHandler=null;class EsignDialog extends(0,_fieldsMethods.FieldsMethods)((0,_closeDialogOnEscPressedMixin.CloseOnEscPressed)((0,_apiAuthentication.AuthenticationApi)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))){static get properties(){return{dialogButtons:{type:Array,value:_dialogmodalButtonsSettings.dialog_buttons},//finalToken: String,
...
validationNotCorrectMessage:{type:Object,value:_dialogEsignSettings.platformEsign_notCorrectMessage},selectedLanguage:{type:String},platformEsign_windowTitle:{type:Object,value:_dialogEsignSettings.platformEsign_windowTitle}}}changeAttemptsPhrase(){if("en"==this.selectedLanguage){this.attemptsPhrase="*** Attempts:"+this.numAttempts+" of "+this.maximumFailures}if("es"==this.selectedLanguage){this.attemptsPhrase="*** Intentos:"+this.numAttempts+" de "+this.maximumFailures}return}changeClass(opened){if(opened){return""}return"closed"}static get template(){return _polymerElement.html`
...
if(this.numAttempts+1<=this.maximumFailures-1){_store.store.dispatch((0,_esignActions.esignFailure)());return}var message="";switch(this.selectedLanguage){case"es":message=this.validationNotCorrectMessage.attempts_consumed.message_es;break;//message=response.data.message_es; break;            
...
}this.dispatchEvent(new CustomEvent("toast-error",{bubbles:!0,composed:!0,detail:message}));if(canceledHandler){canceledHandler()}_store.store.dispatch((0,_esignActions.resetAndCloseEsignDialog)());return}esignCorrect(){if(acceptedHandler){var data=[];data.phrase=this.$.esign.value;_store.store.dispatch((0,_esignActions.esignSuccess)(data));acceptedHandler();_store.store.dispatch((0,_esignActions.closeEsignDialog)())}}dialogConfirmed(){//var paramsUrl='finalToken='+this.finalToken+'&esignPhraseToCheck='+this.$.esign.value;    
...
}this.dispatchEvent(new CustomEvent("toast-error",{bubbles:!0,composed:!0,detail:message}));if(canceledHandler){canceledHandler()}_store.store.dispatch((0,_esignActions.closeEsignDialog)())}stateChanged(state){//    console.log('esign-dialog.js >> stateChanged >> opened=', state.esignDialog);
