define([
  ...
  "../../../../node_modules/dile-spinner/dile-spinner-modal.js",
], function (_litElement, _store, _connectMixin, _dileSpinnerModal) {
  "use strict";
  class LpLoading extends (0, _connectMixin.connect)(_store.store)(
