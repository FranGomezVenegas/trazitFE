define([
  ...
  "../platform-functions/tabs-functions.js",
  "../../elements/platformComponents/Redux/actions/app_actions.js",
  "../../elements/platformComponents/Redux/actions/session_actions.js",
  "./api-platform-procedurelist.js",
  "./api-usersession.js",
  "./api-and-frontend-sopuser.js",
  "./api-settings.js",
  ...
  _exports.AuthenticationApi = void 0; //import {ApiMessage} from '../app-functions/apiMessage';
  //import { addNotification  } from '../../../app/Redux/actions/notifications_actions';
  /**
   * @mixinFunction
   * @polymer
   */ const AuthenticationApi = (superClass) =>
    class extends (0, _apiSettings.ApiSettings)(
      (0, _tokenMixin.tokenMixin)(
        (0, _apiAndFrontendSopuser.ApiAndFrontendSopUser)(
          (0, _apiUsersession.UserSession)(
            (0, _apiPlatformProcedurelist.ProcedureList)(
              (0, _loginMixin.loginMixin)(
                (0, _userSessionMixin.userSessionMixin)(
      ...
      ajaxAuthenticate(data) {
        var apiUrl = _apiConfig.backendUrl + _apiConfig.appAuthenticateApiUrl,
          ...
          .then((response) => {
            if (200 == response.status) {
              ...
              _store.store.dispatch(
                (0, _app_actions.setPartialToken)(finalTokenData)
              );
              this.ajaxUserRoles();
              return;
            }
      ...
      ajaxUserRoles(data) {
        var actionName = "getuserrole",
          apiUrl = _apiConfig.backendUrl + _apiConfig.appAuthenticateApiUrl,
        ...
        axios
          ...
          .then((response) => {
            if (200 == response.status) {
              ...
              _store.store.dispatch(
                (0, _session_actions.addSession)(addSessionData)
              );
              _store.store.dispatch(
                (0, _app_actions.updateFinalToken)(finalToken)
              );
              _store.store.dispatch((0, _app_actions.doLogin)(data.userName));
              _store.store.dispatch(
                (0, _app_actions.setUserTabsOnLogin)(userTabsOnLogin)
              );
              ...
              _store.store.dispatch((0, _app_actions.stopLoading)());
              if (data.callBackFunction) {
                data.callBackFunction();
              }
