define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.FieldsMethods=void 0;/**
 * @mixinFunction
 * @polymer
...
}disable(){this.shadowRoot.getElementById(this.field.name).removeAttribute("enabled");this.shadowRoot.getElementById(this.field.name).disabled=!0}};_exports.FieldsMethods=FieldsMethods});