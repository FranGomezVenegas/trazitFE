...
*/(0,_polymerFn.Polymer)({/** @override */_template:_htmlTag.html`
  ...
  `,is:"paper-badge",/** @private */hostAttributes:{role:"status",tabindex:0},behaviors:[_ironResizableBehavior.IronResizableBehavior],listeners:{"iron-resize":"updatePosition"},properties:{/**
     ...
     */icon:{type:String,value:""},_boundNotifyResize:{type:Function,value:function(){return this.notifyResize.bind(this)}},_boundUpdateTarget:{type:Function,value:function(){return this._updateTarget.bind(this)}}},/** @override */attached:function(){// Polymer 2.x does not have this.offsetParent defined by attached
requestAnimationFrame(this._boundUpdateTarget)},/** @override */attributeChanged:function(name){if("hidden"===name){this.updatePosition()}},_forChanged:function(){// The first time the property is set is before the badge is attached,
