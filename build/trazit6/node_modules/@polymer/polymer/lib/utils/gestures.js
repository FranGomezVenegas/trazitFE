 ...
 */function PASSIVE_TOUCH(eventName){return{passive:!1};if(isMouseEvent(eventName)||"touchend"===eventName){return}if(HAS_NATIVE_TA&&supportsPassive&&_settings.passiveTouchGestures){return{passive:!0}}else{return}}// Check for touch-only devices
