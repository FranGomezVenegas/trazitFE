define(["exports","../../symbol-observable/es/index.js"],function(_exports,_index){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.applyMiddleware=applyMiddleware;_exports.bindActionCreators=bindActionCreators;_exports.combineReducers=combineReducers;_exports.compose=compose;_exports.createStore=createStore;_exports.__DO_NOT_USE__ActionTypes=void 0;_index=babelHelpers.interopRequireDefault(_index);/**
...
dispatch({type:ActionTypes.REPLACE})}/**
   ...
   */function observable(){var _ref,outerSubscribe=subscribe;return _ref={/**
       ...
       */subscribe:function subscribe(observer){if("object"!==typeof observer||null===observer){throw new TypeError("Expected the observer to be an object.")}function observeState(){if(observer.next){observer.next(getState())}}observeState();var unsubscribe=outerSubscribe(observeState);return{unsubscribe:unsubscribe}}},_ref[_index.default]=function(){return this},_ref}// When a store is created, an "INIT" action is dispatched so that every
// reducer returns their initial state. This effectively populates
// the initial state tree.
dispatch({type:ActionTypes.INIT});return _ref2={dispatch:dispatch,subscribe:subscribe,getState:getState,replaceReducer:replaceReducer},_ref2[_index.default]=observable,_ref2}/**
