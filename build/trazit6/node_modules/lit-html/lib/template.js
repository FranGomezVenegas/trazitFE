 ...
 *    * (") then any non-("), or
 *    * (') then any non-(')
 */_exports.createMarker=createMarker;const lastAttributeNameRegex=// eslint-disable-next-line no-control-regex
