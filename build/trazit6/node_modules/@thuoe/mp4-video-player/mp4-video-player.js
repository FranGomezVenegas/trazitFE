define(["../../@polymer/iron-icon/iron-icon.js","../../@polymer/polymer/polymer-element.js","../../player-icons/player-icons.js","./player-styles.js"],function(_ironIcon,_polymerElement,_playerIcons,_playerStyles){"use strict";_playerStyles=babelHelpers.interopRequireDefault(_playerStyles);/**
 * `mp4-video-player`
 ...
 */class MP4VideoPlayer extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      ${_playerStyles.default}
