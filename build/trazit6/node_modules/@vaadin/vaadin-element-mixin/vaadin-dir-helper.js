 ...
 */class DirHelper{/**
  ...
  */static getNormalizedScrollLeft(scrollType,direction,element){const{scrollLeft}=element;if("rtl"!==direction||!scrollType){return scrollLeft}switch(scrollType){case"negative":return element.scrollWidth-element.clientWidth+scrollLeft;case"reverse":return element.scrollWidth-element.clientWidth-scrollLeft;}return scrollLeft}/**
   ...
   */static setNormalizedScrollLeft(scrollType,direction,element,scrollLeft){if("rtl"!==direction||!scrollType){element.scrollLeft=scrollLeft;return}switch(scrollType){case"negative":element.scrollLeft=element.clientWidth-element.scrollWidth+scrollLeft;break;case"reverse":element.scrollLeft=element.scrollWidth-element.clientWidth-scrollLeft;break;default:element.scrollLeft=scrollLeft;break;}}}_exports.DirHelper=DirHelper});