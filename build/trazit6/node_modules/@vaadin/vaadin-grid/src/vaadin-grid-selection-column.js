define(["exports","../../../@polymer/polymer/polymer-legacy.js","./vaadin-grid-column.js","../node_modules/@vaadin/vaadin-checkbox/vaadin-checkbox.js","../../../@polymer/polymer/lib/utils/html-tag.js"],function(_exports,_polymerLegacy,_vaadinGridColumn,_vaadinCheckbox,_htmlTag){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.GridSelectionColumnElement=void 0;/**
@license
 ...
 */class GridSelectionColumnElement extends _vaadinGridColumn.GridColumnElement{static get template(){return _htmlTag.html`
    <template class="header" id="defaultHeaderTemplate">
      <vaadin-checkbox class="vaadin-grid-select-all-checkbox" aria-label="Select All" hidden on-checked-changed="_onSelectAllCheckedChanged" checked="[[_isChecked(selectAll, _indeterminate)]]" indeterminate="[[_indeterminate]]"></vaadin-checkbox>
    </template>
    <template id="defaultBodyTemplate">
      <vaadin-checkbox aria-label="Select Row" checked="{{selected}}" on-checked-changed="_onSelectRowCheckedChanged"></vaadin-checkbox>
    </template>
`}static get is(){return"vaadin-grid-selection-column"}static get properties(){return{/**
       ...
       */_previousActiveItem:Object,_selectAllHidden:Boolean,customAllowMultiSelect:Boolean}}static get observers(){return["_onSelectAllChanged(selectAll)"]}_pathOrHeaderChanged(path,header,headerCell,footerCell,cells,renderer,headerRenderer,bodyTemplate,headerTemplate){// As a special case, allow overriding the default header / body templates
...
return i==b.length}_onSelectAllCheckedChanged(e){this.selectAll=this._indeterminate||e.target.checked}_onSelectRowCheckedChanged(e){//console.log('_onSelectRowCheckedChanged', this.customAllowMultiSelect);
if(this.allowMultiSelect==void 0||this.allowMultiSelect!=void 0&&!1==this.allowMultiSelect){this._grid.selectedItems=[];this._grid.selectItem(e.detail)}}// iOS needs indeterminated + checked at the same time
