 ...
 */const ColumnReorderingMixin=superClass=>class ColumnReorderingMixin extends(0,_gestureEventListeners.GestureEventListeners)(superClass){static get properties(){return{/**
       ...
       */columnReorderingAllowed:{type:Boolean,value:!1},_orderBaseScope:{type:Number,value:1e7}}}static get observers(){return["_updateOrders(_columnTree, _columnTree.*)"]}ready(){super.ready();(0,_gestures.addListener)(this,"track",this._onTrackEvent);this._reorderGhost=this.shadowRoot.querySelector("[part=\"reorder-ghost\"]");this.addEventListener("touchstart",this._onTouchStart.bind(this),{passive:!1});this.addEventListener("touchmove",this._onTouchMove.bind(this),{passive:!1});this.addEventListener("touchend",this._onTouchEnd.bind(this),{passive:!1});this.addEventListener("contextmenu",this._onContextMenu.bind(this),{passive:!1})}_onContextMenu(e){if(this.hasAttribute("reordering")){e.preventDefault()}}_onTouchStart(e){// Touch event, delay activation by 100ms
