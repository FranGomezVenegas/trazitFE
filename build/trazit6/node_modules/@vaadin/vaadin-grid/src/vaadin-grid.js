...
this._update()}}/**
   ...
   */notifyResize(){super.notifyResize()}_heightByRowsChanged(value,oldValue){if(value||oldValue){this.notifyResize()}}__forceReflow(){this._debouncerForceReflow=_debounce.Debouncer.debounce(this._debouncerForceReflow,_async.animationFrame,()=>{this.$.scroller.style.overflow="hidden";setTimeout(()=>this.$.scroller.style.overflow="")})}}_exports.GridElement=GridElement;customElements.define(GridElement.is,GridElement)});