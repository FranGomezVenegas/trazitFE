  ...
  static get template() {
    return html`
      ...
      <paper-dialog
        ...
        id="newIncidentDialog"
      >
        <simple-modal-dialog
          id="newIncidentDialog2"
          action-name=""
          display-close-button
          form-fields="{{formFields}}"
          field-button-clicked="{{fieldButtonClickedForIncidents}}"
          on-dialog-button-clicked="fieldButtonClickedForIncidents"
        >
        </simple-modal-dialog>
      </paper-dialog>
  ...
  actionTriggerNext() {
    ...
    switch (buttonName.toUpperCase()) {
      ...
      case "CLOSE_INCIDENT":
        ...
        import(
          "../../elements/internalComponents/Dialogs/DialogSimple/simple-modal-dialog"
        );
