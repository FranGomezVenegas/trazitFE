...
getMyPendingSops(finalToken){
    ...
    var paramsUrl='actionName='+actionName+'&finalToken='+finalToken+'&sopFieldsToRetrieve='+sopUserPendingSop.fieldToRetrieve;
    var datas = [];
    datas.finalToken=finalToken; datas.actionName=actionName; datas.paramsUrl=paramsUrl;
...
var paramsUrl='actionName='+actionName+'&finalToken='+finalToken+'&sopFieldsToRetrieve='+sopUserAllSop.fieldToRetrieve;
var datas = [];
datas.finalToken=finalToken; datas.actionName=actionName; datas.paramsUrl=paramsUrl;
this.frontEndSopUserAPI(datas);      
}      
