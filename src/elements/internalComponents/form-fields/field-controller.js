...
class FieldController extends PolymerElement {
  ...
  resetIAms() {
    this.set("iAm.boolean", false);
    this.set("iAm.date", false);
    this.set("iAm.list", false);
    this.set("iAm.text", false);
    this.set("iAm.textArea", false);
    this.set("iAm.logoCircle", false);
    this.set("iAm.avatar", false);
    this.set("iAm.googleFonts", false);
    this.set("iAm.treeList", false);
    this.set("iAm.iconButton", false);
    this.set("iAm.button", false);
    this.set("iAm.buttonGroup", false);
    this.set("iAm.integer", false);
    this.set("iAm.badge", false);
  }
  static get template() {
    return html`
<!--      {{field.name}} -->
