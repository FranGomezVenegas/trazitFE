...
<!--                color: darkred;
    ...
    styleDefinition(){
        ...
        var color = !this.field.icon_color ? 'color: darkred;': 'color:'+this.field.text_color+';'; 
        var bkGroundColor = !this.field.icon_color ? 'background-color: #fd5e60;;': 'background-color:'+this.field.background_color+';'; 
