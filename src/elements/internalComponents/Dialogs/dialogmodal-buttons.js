...
import {cancelDialogButton, confirmDialogButton, closeDialogButton} from './dialogmodal-buttons-settings';
 ...
 * 
 */
class DialogmodalButtons extends FieldsMethods(connect(store)(PolymerElement))  {
