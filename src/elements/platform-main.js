...
class LabplanetMain extends connect(store)(LitElement) {
  ...
  importPlatformComponents() {
    ...
    import(
      "../elements/platformComponents/MainView/Headers/platform-headertwo"
    );
    import(
      "../elements/platformComponents/MainView/LeftPanes/platform-leftpane-fix"
    );
    import(
      "../elements/platformComponents/MainView/Centers/platform-center-tabs"
    );
    ...
    import("@polymer/paper-dialog/paper-dialog"); // import('@vaadin/vaadin-checkbox/vaadin-checkbox');
