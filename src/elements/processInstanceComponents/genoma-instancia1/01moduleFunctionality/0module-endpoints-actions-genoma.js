  ...
  class extends userConfirmationMixin(
      ...
      if (actionDefinition.dialogInfo.requiresDialog) {
        ...
        if (elem) {
          ...
          message.message_en =
            ...
            actionDefinition.dialogInfo.webComponentName;
          message.message_es =
            "No encontrado ningún WebComponent llamado " +
            actionDefinition.dialogInfo.webComponentName;
    ...
    buildParamsUrlForAction(actionName, actionDefinition, selectedRow) {
      ...
      for (i = 0; i < actionDefinition.apiParams.length; i++) {
        if (
          actionDefinition.apiParams[i].paramName != undefined &&
          ...
          if (actionDefinition.apiParams[i].defaultValue != undefined) {
            ...
            if (
              actionDefinition.apiParams[i].isMandatory == undefined ||
              actionDefinition.apiParams[i].isMandatory == true
            ) {
              message_en =
                ...
                actionName;
              message_es =
                "No encontrado valor para el parámetro " +
                actionDefinition.apiParams[i].paramName +
                " que es declarado como obligatorio para la acción " +
                actionName;
    ...
    moduleActionTriggerAPI(
      ...
      if (paramsUrlObj.diagnostic == false) {
        ...
        msgErr.message_es =
          "Error al crear la llamada a la API para la acción " +
          actionName +
          ". Error: " +
