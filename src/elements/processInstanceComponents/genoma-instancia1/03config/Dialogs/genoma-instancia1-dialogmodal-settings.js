...
export const dialogEnterVariableValueText = [
  {
...
export const dialogEnterVariableValueInteger = [
  {
...
export const dialogStudyUpdate = [
  {
    name: "stydy_field_new",
    label_en: "New Study Name",
    label_es: "Nombre para nuevo Estudio",
...
export const dialogStudyIndividualNew = [
  {
    name: "stydy_field_new",
...
export const dialogStudyIndividualUpdate = [
  {
    name: "stydy_field_new",
...
export const dialogStudyFamilyNew = [
  {
    name: "stydy_field_new",
...
export const dialogStudyFamilyUpdate = [
  {
    name: "stydy_field_new",
...
export const dialogStudySamplesSetNew = [
  {
    name: "stydy_field_new",
    label_en: "New Study Samples Set Name",
    label_es: "Nombre para nueva Agrupación Muestras",
    type: "text",
    password: "false",
    value: "",
    read_only: false,
...
export const dialogStudySamplesSetUpdate = [
  {
    name: "stydy_field_new",
    label_en: "Study Samples Set Name",
    label_es: "Nombre Agrupación Muestras",
    type: "text",
    password: "false",
    value: "",
    read_only: true,
