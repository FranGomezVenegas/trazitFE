...
export const windowDefinition={
  windowTitle:{label_en:'Home page for the study ', label_es:'Página de inicio para el estudio'},
  ...
  buttons:[          
    {
      ...
      "label_en": "Update Study", "label_es": "Crear Estudio",
      "type": "icon-button",
...
const documentContainerGenomaInstancia1ProjtabHomeStyle = document.createElement('genoma-instancia1-projtab-home-style');
