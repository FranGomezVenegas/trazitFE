...
import {elementTableSamplesSet, elementTableSample, elementTableSampleVariable} from './genoma-instancia1-projectmainview-settings';
...
const documentContainerGenomaInstancia1ProjtabHomeStyle = document.createElement('genoma-instancia1-projtab-samples-set-style');
documentContainerGenomaInstancia1ProjtabHomeStyle.setAttribute('style', 'display: none;');
