 ...
 * 
 */
class EmDemoAModalmodulewindowButtons extends FieldsMethods(connect(store)(PolymerElement))  {
...
customElements.define('em-demo-a-modalmodulewindow-buttons', EmDemoAModalmodulewindowButtons);