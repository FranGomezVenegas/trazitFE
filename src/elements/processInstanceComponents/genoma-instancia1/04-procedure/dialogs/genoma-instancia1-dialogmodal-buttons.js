...
import {cancelDialogButton, confirmDialogButton, closeDialogButton} from '../../03config/Dialogs/genoma-instancia1-dialogmodal-buttons-settings';
 ...
 * 
 */
class GenomaInstancia1DialogmodalButtons extends FieldsMethods(connect(store)(PolymerElement))  {
...
customElements.define('genoma-instancia1-dialogmodal-buttons', GenomaInstancia1DialogmodalButtons);