 ...
 * 
 */
class GenomaInstancia1ProjStudyIndividuals extends EndpointsActionsGenomaModule(FrontendEndpointsModuleGenoma(FieldsMethods(ModuleFunctionsGenoma(connect(store)(LitElement))))) {
...
customElements.define('genoma-instancia1-proj-study-individuals', GenomaInstancia1ProjStudyIndividuals);