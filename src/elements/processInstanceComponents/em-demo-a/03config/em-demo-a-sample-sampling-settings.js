...
export const sampleSampling={
    ...
    tableTitle:{
      display: true,
      label:{label_en:'Samples Pending Sampling Date', label_es:'Muestras pendientes de la fecha de muestreo'}
    },
    displayButtons: true,
    buttons:[
        {
...
const documentContainerEmDemoASampleSamplingStyle = document.createElement('em-demo-a-sample-sampling-style');
documentContainerEmDemoASampleSamplingStyle.setAttribute('style', 'display: none;');
