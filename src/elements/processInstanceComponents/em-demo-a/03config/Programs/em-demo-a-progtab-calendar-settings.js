...
const documentContainerEmDemoAProgtabCalendarStyle = document.createElement('em-demo-a-progtab-calendar-style');
documentContainerEmDemoAProgtabCalendarStyle.setAttribute('style', 'display: none;');
