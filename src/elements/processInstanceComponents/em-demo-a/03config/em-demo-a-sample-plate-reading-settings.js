...
export const samplePlateReading={
    ...
    tableTitle:{
      display: true,
      label:{label_en:'Samples Pending Plate Reading', label_es:'Muestras pendientes de la lectura de placa'}
    },
    displayButtons: true,
    buttons:[          
      {
...
const documentContainerEmDemoASamplePlateReadingStyle = document.createElement('em-demo-a-sample-plate-reading-style');
documentContainerEmDemoASamplePlateReadingStyle.setAttribute('style', 'display: none;');
