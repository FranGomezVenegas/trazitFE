...
const documentContainerEmDemoADialogSampleAuditSettings = document.createElement('em-demo-a-dialog-sample-audit-settings');
documentContainerEmDemoADialogSampleAuditSettings.setAttribute('style', 'display: none;');
