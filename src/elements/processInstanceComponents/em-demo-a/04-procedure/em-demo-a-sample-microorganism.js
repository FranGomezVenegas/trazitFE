...
class emDemoASampleMicroorganism extends FieldsMethods(FunctionsEnvMonitSamples(FrontendEndpointsEnvMonitSamples(connect(store)(PolymerElement)))) {
    ...
    loadSamplingTable(){
        ...
        //this.getAllSamplesStageMicroorganism(this.tableDefinition);
        //     {
