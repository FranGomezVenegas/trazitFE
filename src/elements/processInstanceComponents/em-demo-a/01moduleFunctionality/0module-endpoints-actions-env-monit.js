...
export const EndpointsActionsEnvMonitModule = (superClass) => class extends userConfirmationMixin(EnvMonitModuleDefinition(ApiSettings(ToastMethods(tokenMixin(superClass))))) {
    ...
    //    console.log('moduleActionTriggerNext', 'buttonDefinition', buttonDefinition, 'backEndData', backEndData);
        ...
        case this.sampleActions.SAMPLINGCOMMENTADD.actionName:    
            //this.$.addComment.actionName='SAMPLINGCOMMENTADD'; Revisar si es necesario.
            var elem=this.shadowRoot.getElementById("myElementsSample");
            elem.buttonDefinition=buttonDefinition;
            elem.selectedObject=backEndData.selectedObject;
            elem.callBackFunction=backEndData.callBackFunction;
            elem.callBackFunctionError=backEndData.callBackFunctionError;
            if (elem){elem.openDialog("addComment", "SAMPLINGCOMMENTADD");}
            break;
        ...
        case 'ADDSAMPLEANALYSIS':
            ...
            var paramsUrl='actionName='+actionName
    ...
    //console.log('ChangeOfCustodyHistory >> this.cocUsersList', this.cocUsersList, 'this.cocUsersListFieldToDisplay', this.cocUsersListFieldToDisplay);
        ...
        case 'CHANGEOFCUSTODYHISTORY':
            ...
            var paramsUrl='actionName='+actionName+'&fieldToRetrieve='+this.analysisListToDisplay;
            datas.actionName=actionName;           
    ...
    //console.log('ChangeOfCustodyHistory >> this.cocSampleHistory', this.cocSampleHistory, 'this.cocSampleHistoryFieldToDisplay', this.cocSampleHistoryFieldToDisplay);
        ...
        case 'TESTASSIGNMENT':
            ...
            var paramsUrl='actionName='+actionName+'&fieldToRetrieve='+this.cocUsersListFieldToDisplay;
            datas.actionName=actionName;        
            datas.fieldToRetrieve=sampleCustodian_cocUsersListFieldToRetrieve; datas.paramsUrl=paramsUrl;
            //datas.callBackFunction=this.openAddSampleAnalysisDialog.bind(this);
            this.getGivenCocUsersList(datas);
    //console.log('ChangeOfCustodyHistory >> this.cocUsersList', this.cocUsersList, 'this.cocUsersListFieldToDisplay', this.cocUsersListFieldToDisplay);
        ...
        case 'ADDMICROORGANISM': 
            ...
            var paramsUrl='actionName='+actionName+'&fieldToRetrieve='+this.microorganismListToDisplay;
            datas.actionName=actionName;           
            ...
            break; 
        case 'SAMPLE_AUDIT': 
            import('../04-procedure/dialogs/em-demo-a-list-modal-sample-auditOrig.js');
            this.sampleAudit_fieldsToRetrieve=sampleAudit_fieldsToRetrieve;
            var actionName='GET_SAMPLE_AUDIT';
            var paramsUrl='actionName='+actionName+'&sampleAuditFieldToRetrieve='+this.sampleAudit_fieldsToRetrieve;
            datas.actionName=actionName;           
        ...
        case 'EM_BATCH_INCUB_REMOVE_SMP': 
            var paramsUrl='actionName='+actionName+'&batchName='+this.selectedBatch.name+'&batchtemplateId='+this.selectedBatch.incub_batch_config_id+'&batchtemplateVersion='+this.selectedBatch.incub_batch_config_version;
            datas.actionName=actionName; datas.paramsUrl=paramsUrl; datas.selectedBatch=this.selectedBatch;
            this.moduleActionTriggerAPI(actionName, buttonDefinition, datas, backEndData.callBackFunction, backEndData.callBackFunctionError, this.refreshWindowMethod);  
            break;    
        default:
            console.log('Action '+buttonName+' is not declared in env-monit-elements.sample.js >> moduleActionTriggerNext');
            break;
        }
        return;            
    }    
...
//         }                    
    ...
    sampleAPIEndpointCall(data, button, moduleArea, callBackFunction, callBackFunctionError, refreshFunction) {
        ...
        axios.get(apiUrl)        
        .then( response => {
            console.log('em-demo-a > api-env-monit.js > sampleAPIEndpointCall', 'response.data', response.data);
    ...
    REDUX_GET_INCUBBATCH(buttonName, buttonDefinition, selectedObject, moduleArea, actionDefinition, callBackFunction, callBackFunctionError, refreshWindowMethod){
        ...
        var selectedBatch=state.emDemoA.selectedBatch;   
