...
import {progTabPoints, shifts} from '../../03config/Programs/em-demo-a-progtab-points-settings';
...
class EmDemoAProgSchedule extends (FunctionsEnvMonitSamples(FrontendEndpointsEnvMonitForPrograms(connect(store)(PolymerElement)))) {
    stateChanged(state) {
