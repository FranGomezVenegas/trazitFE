...
import {em_deviation_tabs, programMain_programSelectionForm, programHome_defaultTab,
    tabsDefinition} from '../03config/ResultDeviation/em-demo-a-resultdeviationmainview-settings';
...
class emDemoAResultDeviation extends FieldsMethods(TabsMethods(FrontendEndpointsEnvMonitForProductionLot(FrontendEndpointsEnvMonitForPrograms(connect(store)(PolymerElement))))) {
    stateChanged(state) {
