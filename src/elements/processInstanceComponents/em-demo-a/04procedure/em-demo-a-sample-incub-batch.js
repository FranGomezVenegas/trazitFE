...
-->
    ...
    loadWindowTables(){
        ...
        this.getAllSamplesStageSampling(this.incub1TableDefinition,this.samplesStagesReduxVariables.PENDING_INCUBATION1);
        this.getAllSamplesStageSampling(this.incub2TableDefinition,this.samplesStagesReduxVariables.PENDING_INCUBATION2);
        var elem=this.shadowRoot.getElementById("batches");
        if (elem){elem.refreshWindow();}
