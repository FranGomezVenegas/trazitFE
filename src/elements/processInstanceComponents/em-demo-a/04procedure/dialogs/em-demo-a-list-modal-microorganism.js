...
class emDemoAListModalMicroorganism extends EmDemoAapiEnvMonit(
  ...
  static get properties() {
    return {
      ...
      listHeader: {
        type: Array,
        value: microorganismList_fieldsToDisplay,
      },
      displayFreeText: {
        type: Boolean,
        value: microorganism_allowAddNotOnTheList,
      },
      adhocFormFields: {
        type: Array,
        value: microorganism_allowAddNotOnTheList_formFields,
      },
    ...
    return html`
      ...
      <div class="modal-content bgimg">
        ...
        <template is="dom-if" if="{{displayFreeText}}">
          <template
            is="dom-repeat"
            items="{{adhocFormFields}}"
            as="currentfield"
          >
            <field-controller
              on-keydown="keyPressedAdhoc"
              on-field-button-clicked="actionOnSel"
  ...
  actionOnSel(e) {
    ...
    if (e.detail.buttonName == "buttonNewMicroorganism") {
      this.addMicroorganism(e);
    }
    if (e.detail.buttonName == "buttonNewAdhocMicroorganism") {
