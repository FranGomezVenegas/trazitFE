...
import '../../03config/Dialogs/em-demo-a-list-modal-sample-audit-settings';
 ...
 * 
 */
class EmDemoAListModalSampleAudit extends FunctionsEnvMonitSamples(FrontendEndpointsEnvMonitSamples(connect(store)(PolymerElement))) {
