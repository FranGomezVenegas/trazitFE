...
export const windowSettings={
    ...
    sampleFieldToDisplay:[ ''
      , {name: 'test_id', label_en:'Test ID', label_es: 'ID Ensayo', sort:false, filter:true, width:'20%'}
    ...
    tableTitle:{
      display: true,
      label:{label_en:'Samples Pending Chemical Testing', label_es:'Muestras pendientes de testeo fisico-químico'}
    },
    displayButtons: true,
    buttons:[
        {
