...
const documentContainerprocDeployDialogEnterResultsSettings = document.createElement('proc-deploy-dialog-enterresults-settings');
documentContainerprocDeployDialogEnterResultsSettings.setAttribute('style', 'display: none;');
...
document.head.appendChild(documentContainerprocDeployDialogEnterResultsSettings);