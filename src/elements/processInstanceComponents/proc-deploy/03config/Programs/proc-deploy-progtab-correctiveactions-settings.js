...
const documentContainerprocDeployProgtabCorrectiveActionsStyle = document.createElement('proc-deploy-progtab-correctiveactions-style');
documentContainerprocDeployProgtabCorrectiveActionsStyle.setAttribute('style', 'display: none;');
...
document.head.appendChild(documentContainerprocDeployProgtabCorrectiveActionsStyle);