...
export const programProgConfigCalendar_progConfigCalendarTableHeaderFields=[
  {name: 'date', label_en:'Date', label_es: 'Fecha', sort:false, filter:true, is_icon:true, width:"20%"}
...
import {shifts} from './proc-deploy-programmainview-settings';
...
const documentContainerprocDeployProgtabCalendarStyle = document.createElement('proc-deploy-progtab-calendar-style');
documentContainerprocDeployProgtabCalendarStyle.setAttribute('style', 'display: none;');
