...
const documentContainerprocDeployProgrammainviewStyle = document.createElement('proc-deploy-programmainview-style');
documentContainerprocDeployProgrammainviewStyle.setAttribute('style', 'display: none;');
