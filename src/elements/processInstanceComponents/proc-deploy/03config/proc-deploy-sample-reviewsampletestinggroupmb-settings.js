...
export const windowSettings={
  ...
  // samplesWhereFieldsName:'status in-|sample_config_code not in*',
    ...
    sampleFieldToDisplay:[ ''
      ...
      , {name: 'testing_group', label_en:'testing_group', label_es: 'testing_group', sort:false, filter:true, width:'30%'}
...
const documentContainerProcDeploySampleSamplingStyle = document.createElement('proc-deploy-sample-reviewsampletestinggroupmb-style');
