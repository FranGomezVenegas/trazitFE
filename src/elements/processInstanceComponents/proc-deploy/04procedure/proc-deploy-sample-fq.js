...
import '../03config/proc-deploy-sample-fq-settings';
import {windowSettings} from '../03config/proc-deploy-sample-fq-settings'; //'../03config/config-process.js';
...
class procDeploySampleFq extends FieldsMethods(FunctionsEnvMonitSamples(FrontendEndpointsEnvMonitSamples(connect(store)(PolymerElement)))) {
    static get properties() {
        return {
            tableDefinition: {type: Object, value:windowSettings},
            samplesInProgressFQ: {type: Array, notify:true},
    ...
    loadSamplingTable(){
        ...
        this.getAllSamplesStageSampling(this.tableDefinition,this.samplesStagesReduxVariables.SAMPLES_IN_PROGRESS_FQ);
    } 
    ready() {
        super.ready();
        this.loadSamplingTable();
...
customElements.define('proc-deploy-sample-fq', procDeploySampleFq);
...
// import {sampleSampling} from './proc-deploy-sample-fq-settings'; //'../03config/config-process.js';
// import {FieldsMethods} from '../../../../platform-mixins/functions/fields-methods';
// /**
//  * `proc-deploy-sample-fq` Description
//  *
//  * @customElement
//  * @polymer
//  * @demo
