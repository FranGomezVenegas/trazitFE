...
import {windowDefinition, moduleKPIs} from '../03config/proc-deploy-kpi-settings';
...
class procDeployKpi extends FieldsMethods(FrontendEndpointsEnvMonitKpis(connect(store)(PolymerElement))) {
    stateChanged(state) {
