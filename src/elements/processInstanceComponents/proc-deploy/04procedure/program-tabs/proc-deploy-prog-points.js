...
import {progTabPoints, shifts} from '../../03config/Programs/proc-deploy-progtab-points-settings';
...
class procDeployProgPoints extends FieldsMethods(FunctionsEnvMonitSamples(FrontendEndpointsEnvMonitForPrograms(connect(store)(PolymerElement)))) {
    stateChanged(state) {
