...
import {cancelDialogButton, confirmDialogButton, closeDialogButton} from '../../03config/Dialogs/proc-deploy-dialogmodal-buttons-settings';
 ...
 * 
 */
class ProcDeployDialogmodalButtons extends FieldsMethods(connect(store)(PolymerElement))  {
...
customElements.define('proc-deploy-dialogmodal-buttons', ProcDeployDialogmodalButtons);