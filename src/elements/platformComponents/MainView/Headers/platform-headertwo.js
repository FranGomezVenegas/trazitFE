...
import {SOP_pendingSOPTab, SOP_userMySOPTab} from '../../../../elements/platformComponents/Tabs/tabs-settings';
          ...
          ${this.procedureList.procedures ? html`
            ...
            <li><a>
              ...
              ${item.definition!=undefined ? html`
                ${item.definition.map(item2 => html`
                <li><a .procedure="${item}" class="${item2.branch_level}" .procevent="${item2}" @click="${this.procedureTab}"> <!--(item, item2)-->
